...
// Diese Conceptmap verknüpft die Codes der Messmethode des Körpergewichts mit deutschen Bezeichnungen
...
const BodyWeightMethodSnomedGerman: ConceptMap = [
    {
        ...
        target: "https://fhir.kbv.de/CodeSystem/KBV_CS_Base_Body_Weight_Method_Snomed_German",
        element: [
            {
                code: "363808001",
