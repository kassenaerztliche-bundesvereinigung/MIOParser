...
import BodyWeightLoincVS from "../../../../Definitions/KBVBase/1.1.3/ValueSet/BodyWeightLoinc";
import BodyWeightMethodSnomedVS from "../../../../Definitions/KBVBase/1.1.3/ValueSet/BodyWeightMethodSnomed";
import BodyWeightSnomedVS from "../../../../Definitions/KBVBase/1.1.3/ValueSet/BodyWeightSnomed";
import BodyWeightUnitVS from "../../../../Definitions/KBVBase/1.1.3/ValueSet/BodyWeightUnit";
...
export const ObservationBodyWeightCodeCodeLoincDisplayAnzeigenameCodeLoincContent: t.Type<ObservationBodyWeightCodeCodeLoincDisplayAnzeigenameCodeLoincContent> =
    t.recursion(
...
export const ObservationBodyWeightCodeCodeLoincDisplayAnzeigenameCodeLoinc: t.Type<ObservationBodyWeightCodeCodeLoincDisplayAnzeigenameCodeLoinc> =
    t.recursion("ObservationBodyWeightCodeCodeLoincDisplayAnzeigenameCodeLoinc", () =>
        t.intersection([
            t.type({
                url: Literal(
                    "https://fhir.kbv.de/StructureDefinition/KBV_EX_Base_Terminology_German"
            ...
            t.partial({
                ...
                extension: ReqArray<
                    t.UnionC<
                        [
                            t.Type<Extension>,
                            t.Type<ObservationBodyWeightCodeCodeLoincDisplayAnzeigenameCodeLoincContent>
                        ]
                    >,
                    t.Any
                >(
...
export const ObservationBodyWeightCodeCodeLoincDisplay: t.Type<ObservationBodyWeightCodeCodeLoincDisplay> =
    t.recursion("ObservationBodyWeightCodeCodeLoincDisplay", () =>
        t.partial({
            id: SCALARString,
            extension: ReqArray<
                t.UnionC<
                    [
                        t.Type<Extension>,
                        t.Type<ObservationBodyWeightCodeCodeLoincDisplayAnzeigenameCodeLoinc>
                    ]
                >,
                t.Any
            >(
...
export const ObservationBodyWeightCodeCodeLoinc: t.Type<ObservationBodyWeightCodeCodeLoinc> =
    t.recursion("ObservationBodyWeightCodeCodeLoinc", () =>
        t.intersection([
            t.type({
