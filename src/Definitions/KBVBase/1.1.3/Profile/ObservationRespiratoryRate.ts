...
export const ObservationRespiratoryRateMethodCodingDisplayAnzeigenameMethodSnomedContent: t.Type<ObservationRespiratoryRateMethodCodingDisplayAnzeigenameMethodSnomedContent> =
    t.recursion(
...
export const ObservationRespiratoryRateMethodCodingDisplayAnzeigenameMethodSnomed: t.Type<ObservationRespiratoryRateMethodCodingDisplayAnzeigenameMethodSnomed> =
    t.recursion(
                ...
                t.partial({
                    ...
                    extension: ReqArray<
                        t.UnionC<
                            [
                                t.Type<Extension>,
                                t.Type<ObservationRespiratoryRateMethodCodingDisplayAnzeigenameMethodSnomedContent>
                            ]
                        >,
                        t.Any
                    >(
    ...
    t.recursion("ObservationRespiratoryRateCodeCodeSnomed", () =>
        t.intersection([
            t.type({
                ...
                code: Literal("86290005"),
                display: Literal("Respiratory rate (observable entity)")
            }),
            t.partial({
                id: SCALARString,
                _display: ObservationRespiratoryRateCodeCodeSnomedDisplay,
...
export const ObservationRespiratoryRateMethodCodingDisplay: t.Type<ObservationRespiratoryRateMethodCodingDisplay> =
    t.recursion("ObservationRespiratoryRateMethodCodingDisplay", () =>
        t.partial({
            id: SCALARString,
            extension: ReqArray<
                t.UnionC<
                    [
                        t.Type<Extension>,
                        t.Type<ObservationRespiratoryRateMethodCodingDisplayAnzeigenameMethodSnomed>
                    ]
                >,
                t.Any
            >(
...
export const ObservationRespiratoryRateMethodCoding: t.Type<ObservationRespiratoryRateMethodCoding> =
    t.recursion("ObservationRespiratoryRateMethodCoding", () =>
        t.intersection([
            t.type({
                system: Literal("http://snomed.info/sct"),
                version: Literal(
...
export const ObservationRespiratoryRateMethod: t.Type<ObservationRespiratoryRateMethod> =
    t.recursion("ObservationRespiratoryRateMethod", () =>
        t.intersection([
            t.type({
