...
export const PatientVersichertenIdGKVTypeCoding: t.Type<PatientVersichertenIdGKVTypeCoding> = t.recursion(
...
export const PatientVersichertennummerpkvTypeCoding: t.Type<PatientVersichertennummerpkvTypeCoding> = t.recursion(
