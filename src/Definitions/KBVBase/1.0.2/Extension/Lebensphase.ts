...
export const LebensphaseValueCodeableConceptCodingDisplaySnomedCTGermanDisplayContent: t.Type<LebensphaseValueCodeableConceptCodingDisplaySnomedCTGermanDisplayContent> =
    t.recursion(
...
export const LebensphaseValueCodeableConceptCodingDisplaySnomedCTGermanDisplay: t.Type<LebensphaseValueCodeableConceptCodingDisplaySnomedCTGermanDisplay> =
    t.recursion("LebensphaseValueCodeableConceptCodingDisplaySnomedCTGermanDisplay", () =>
        t.intersection([
            t.type({
                url: Literal(
            ...
            t.partial({
                ...
                extension: ReqArray<
                    t.UnionC<
                        [
                            t.Type<Extension>,
                            t.Type<LebensphaseValueCodeableConceptCodingDisplaySnomedCTGermanDisplayContent>
                        ]
                    >,
                    t.Any
                >(
...
export const LebensphaseValueCodeableConceptCodingDisplay: t.Type<LebensphaseValueCodeableConceptCodingDisplay> =
    t.recursion("LebensphaseValueCodeableConceptCodingDisplay", () =>
        t.partial({
            id: SCALARString,
            extension: ReqArray<
                t.UnionC<
                    [
                        t.Type<Extension>,
                        t.Type<LebensphaseValueCodeableConceptCodingDisplaySnomedCTGermanDisplay>
                    ]
                >,
                t.Any
            >(
...
export const LebensphaseValueCodeableConceptCoding: t.Type<LebensphaseValueCodeableConceptCoding> =
    t.recursion("LebensphaseValueCodeableConceptCoding", () =>
        t.intersection([
            t.type({
...
export const LebensphaseValueCodeableConcept: t.Type<LebensphaseValueCodeableConcept> =
    t.recursion("LebensphaseValueCodeableConcept", () =>
        t.intersection([
            t.type({
