...
export const PractitionerQualificationPractitionerspecialityCodeCoding: t.Type<PractitionerQualificationPractitionerspecialityCodeCoding> = t.recursion(
...
export const PractitionerQualificationPractitionerspecialityCode: t.Type<PractitionerQualificationPractitionerspecialityCode> = t.recursion(
...
export const PractitionerQualificationPractitionerspeciality: t.Type<PractitionerQualificationPractitionerspeciality> = t.recursion(
    ...
    t.intersection([
        ...
        t.partial({
            ...
            >(
                ...
                [
                    {
                        codec: PractitionerQualification,
                        occurrence: ["0", "*"],
                        sliceBy: { path: "" }
                    },
                    {
