...
import ApgarScoreIdentifierLoincVS from "../../../../Definitions/KBVBase/1.2.1/ValueSet/ApgarScoreIdentifierLoinc";
import ApgarScoreIdentifierSnomedVS from "../../../../Definitions/KBVBase/1.2.1/ValueSet/ApgarScoreIdentifierSnomed";
import ApgarScoreValueVS from "../../../../Definitions/KBVBase/1.2.1/ValueSet/ApgarScoreValue";
...
export interface ObservationApgarScoreCodeCodeSnomedDisplayAnzeigenameCodeSnomed {
    extension: Array<
        Extension | ObservationApgarScoreCodeCodeSnomedDisplayAnzeigenameCodeSnomedContent
    >;
...
export interface ObservationApgarScoreCodeCodeLoincDisplayAnzeigenameCodeLoinc {
    extension: Array<
        Extension | ObservationApgarScoreCodeCodeLoincDisplayAnzeigenameCodeLoincContent
    >;
    url: "https://fhir.kbv.de/StructureDefinition/KBV_EX_Base_Terminology_German";
    id?: string;
}
...
export interface ObservationApgarScoreCodeCodeSnomedDisplay {
    extension: Array<
        Extension | ObservationApgarScoreCodeCodeSnomedDisplayAnzeigenameCodeSnomed
    >;
    id?: string;
    value?: string;
}
