...
import HeartRateSnomedVS from "../../../../Definitions/KBVBase/1.2.1/ValueSet/HeartRateSnomed";
...
export interface ObservationHeartRateCodeLoincDisplayAnzeigenameCodeLoinc {
    extension: Array<
        Extension | ObservationHeartRateCodeLoincDisplayAnzeigenameCodeLoincContent
    >;
...
export interface ObservationHeartRateCodeCodeSnomedDisplayAnzeigenameCodeSnomed {
    extension: Array<
        Extension | ObservationHeartRateCodeCodeSnomedDisplayAnzeigenameCodeSnomedContent
    >;
    url: "https://fhir.kbv.de/StructureDefinition/KBV_EX_Base_Terminology_German";
    id?: string;
}
...
export interface ObservationHeartRateCodeLoincDisplay {
    extension: Array<
        Extension | ObservationHeartRateCodeLoincDisplayAnzeigenameCodeLoinc
    >;
    id?: string;
    value?: string;
}
...
export interface ObservationHeartRateCodeCodeSnomedDisplay {
    extension: Array<
        Extension | ObservationHeartRateCodeCodeSnomedDisplayAnzeigenameCodeSnomed
    >;
    id?: string;
    value?: string;
}
