...
import Identifierpid from "../../../../Definitions/HL7DE/0.9.12/Profile/Identifierpid";
 ...
 */
export interface PatientVersichertennummerpkvAssignerReferenceIdentifierTypeXXType {
...
export const PatientVersichertennummerpkvAssignerReferenceIdentifierTypeXXType: t.Type<PatientVersichertennummerpkvAssignerReferenceIdentifierTypeXXType> =
    t.recursion("PatientVersichertennummerpkvAssignerReferenceIdentifierTypeXXType", () =>
        t.intersection([
            t.type({
...
export const PatientVersichertenIdGKVTypeGKVType: t.Type<PatientVersichertenIdGKVTypeGKVType> =
    t.recursion("PatientVersichertenIdGKVTypeGKVType", () =>
        t.intersection([
            t.type({
...
export const PatientVersichertennummerpkvTypePKVType: t.Type<PatientVersichertennummerpkvTypePKVType> =
    t.recursion("PatientVersichertennummerpkvTypePKVType", () =>
        t.intersection([
            t.type({
                system: Literal("http://fhir.de/CodeSystem/identifier-type-de-basis"),
                code: Literal("PKV")
 ...
 */
export interface PatientVersichertennummerpkvAssignerReferenceIdentifierType {
    coding: Array<PatientVersichertennummerpkvAssignerReferenceIdentifierTypeXXType>;
    id?: string;
    text?: string;
}

export const PatientVersichertennummerpkvAssignerReferenceIdentifierType: t.Type<PatientVersichertennummerpkvAssignerReferenceIdentifierType> =
    t.recursion("PatientVersichertennummerpkvAssignerReferenceIdentifierType", () =>
        t.intersection([
            t.type({
                coding: MinArray(
                    1,
                    PatientVersichertennummerpkvAssignerReferenceIdentifierTypeXXType
                )
            }),
            t.partial({
                id: SCALARString,
...
export const PatientGeburtsnameFamilyNamenszusatz: t.Type<PatientGeburtsnameFamilyNamenszusatz> =
    t.recursion("PatientGeburtsnameFamilyNamenszusatz", () =>
        t.intersection([
            t.type({
                url: Literal("http://fhir.de/StructureDefinition/humanname-namenszusatz")
            }),
...
export const PatientGeburtsnameFamilyNachname: t.Type<PatientGeburtsnameFamilyNachname> =
    t.recursion("PatientGeburtsnameFamilyNachname", () =>
        t.intersection([
            t.type({
                url: Literal(
                    "http://hl7.org/fhir/StructureDefinition/humanname-own-name"
...
export const PatientGeburtsnameFamilyVorsatzwort: t.Type<PatientGeburtsnameFamilyVorsatzwort> =
    t.recursion("PatientGeburtsnameFamilyVorsatzwort", () =>
        t.intersection([
            t.type({
                url: Literal(
                    "http://hl7.org/fhir/StructureDefinition/humanname-own-prefix"
...
export const PatientStrassenanschriftLineStrasse: t.Type<PatientStrassenanschriftLineStrasse> =
    t.recursion("PatientStrassenanschriftLineStrasse", () =>
        t.intersection([
            t.type({
                url: Literal(
...
export const PatientStrassenanschriftLineHausnummer: t.Type<PatientStrassenanschriftLineHausnummer> =
    t.recursion("PatientStrassenanschriftLineHausnummer", () =>
        t.intersection([
            t.type({
                url: Literal(
...
export const PatientStrassenanschriftLineAdresszusatz: t.Type<PatientStrassenanschriftLineAdresszusatz> =
    t.recursion("PatientStrassenanschriftLineAdresszusatz", () =>
        t.intersection([
            t.type({
                url: Literal(
...
export const PatientPostfachLinePostfach: t.Type<PatientPostfachLinePostfach> =
    t.recursion("PatientPostfachLinePostfach", () =>
        t.intersection([
            t.type({
                url: Literal(
 ...
 */
export interface PatientVersichertennummerpkvAssignerReferenceIdentifier {
    system: "http://fhir.de/NamingSystem/arge-ik/iknr";
    value: string;
    id?: string;
    use?: "official";
    type?: PatientVersichertennummerpkvAssignerReferenceIdentifierType;
    period?: Period;
    assigner?: Reference;
}

export const PatientVersichertennummerpkvAssignerReferenceIdentifier: t.Type<PatientVersichertennummerpkvAssignerReferenceIdentifier> =
    t.recursion("PatientVersichertennummerpkvAssignerReferenceIdentifier", () =>
        t.intersection([
            t.type({
...
export interface PatientVersichertennummerpkvAssignerReference {
    ...
    identifier?: PatientVersichertennummerpkvAssignerReferenceIdentifier;
}
...
export const PatientStrassenanschriftLine: t.Type<PatientStrassenanschriftLine> =
    t.recursion("PatientStrassenanschriftLine", () =>
        t.partial({
            id: SCALARString,
            extension: ReqArray<
                t.UnionC<
...
export const PatientStrassenanschriftPeriod: t.Type<PatientStrassenanschriftPeriod> =
    t.recursion("PatientStrassenanschriftPeriod", () =>
                ...
                [
                    {
                        ...
                        sliceBy: {
                            ...
                            value: "http://fhir.de/StructureDefinition/identifier-pid"
                        }
                    },
                    {
