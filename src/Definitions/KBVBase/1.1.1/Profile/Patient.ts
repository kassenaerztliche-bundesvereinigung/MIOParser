 ...
 */
export interface PatientVersichertennummerpkvAssignerIdentifierTypeXXType {
...
export const PatientVersichertennummerpkvAssignerIdentifierTypeXXType: t.Type<PatientVersichertennummerpkvAssignerIdentifierTypeXXType> = t.recursion(
    "PatientVersichertennummerpkvAssignerIdentifierTypeXXType",
    () =>
        t.intersection([
            t.type({
 ...
 */
export interface PatientVersichertennummerpkvAssignerIdentifierType {
    coding: Array<PatientVersichertennummerpkvAssignerIdentifierTypeXXType>;
    id?: string;
    text?: string;
}

export const PatientVersichertennummerpkvAssignerIdentifierType: t.Type<PatientVersichertennummerpkvAssignerIdentifierType> = t.recursion(
...
export interface PatientVersichertennummerpkvAssignerIdentifier {
    ...
    id?: string;
    use?: "official";
    type?: PatientVersichertennummerpkvAssignerIdentifierType;
    period?: Period;
    assigner?: Reference;
}
