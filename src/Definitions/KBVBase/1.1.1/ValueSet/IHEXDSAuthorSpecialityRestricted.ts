...
// Canonical URL for ValueSet: https://fhir.kbv.de/ValueSet/KBV_VS_Base_IHEXDS_AuthorSpeciality_Restricted

type IHEXDSAuthorSpecialityRestricted =
    | "1"
    | "3"
    | "010"
    | "020"
...
type IHEXDSAuthorSpecialityRestrictedType = t.KeyofC<{
    "1": null;
    "3": null;
    "010": null;
    "020": null;
...
const IHEXDSAuthorSpecialityRestricted: IHEXDSAuthorSpecialityRestrictedType = t.keyof({
    "1": null,
    "3": null,
    "010": null,
    "020": null,
...
export const IHEXDSAuthorSpecialityRestrictedArray: string[] = [
    "1",
    "3",
    "010",
    "020",
...
export const IHEXDSAuthorSpecialityRestrictedValueSet: ValueSet = [
    {
...
export default IHEXDSAuthorSpecialityRestricted;
