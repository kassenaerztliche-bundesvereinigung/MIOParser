 ...
 */
export interface OrganizationInstitutionskennzeichenTypeXXType {
...
export const OrganizationInstitutionskennzeichenTypeXXType: t.Type<OrganizationInstitutionskennzeichenTypeXXType> =
    t.recursion("OrganizationInstitutionskennzeichenTypeXXType", () =>
        t.intersection([
            t.type({
...
export const OrganizationBetriebsstaettennummerTypeBSNRType: t.Type<OrganizationBetriebsstaettennummerTypeBSNRType> =
    t.recursion("OrganizationBetriebsstaettennummerTypeBSNRType", () =>
        t.intersection([
            t.type({
                system: Literal("http://terminology.hl7.org/CodeSystem/v2-0203"),
                code: Literal("BSNR")
...
export const OrganizationVKNRTypeNIIPType: t.Type<OrganizationVKNRTypeNIIPType> =
    t.recursion("OrganizationVKNRTypeNIIPType", () =>
        t.intersection([
            t.type({
                system: Literal("http://terminology.hl7.org/CodeSystem/v2-0203"),
                code: Literal("NIIP")
...
export const OrganizationKZVAbrechnungsnummerTypeZANRType: t.Type<OrganizationKZVAbrechnungsnummerTypeZANRType> =
    t.recursion("OrganizationKZVAbrechnungsnummerTypeZANRType", () =>
        t.intersection([
            t.type({
...
export interface OrganizationInstitutionskennzeichenType {
    coding: Array<OrganizationInstitutionskennzeichenTypeXXType>;
    id?: string;
    text?: string;
}
...
export const OrganizationInstitutionskennzeichenType: t.Type<OrganizationInstitutionskennzeichenType> =
    t.recursion("OrganizationInstitutionskennzeichenType", () =>
        t.intersection([
            t.type({
                coding: MinArray(1, OrganizationInstitutionskennzeichenTypeXXType)
            }),
            t.partial({
                id: SCALARString,
                text: SCALARString
