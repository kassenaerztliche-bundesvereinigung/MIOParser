...
import { Literal, MaxArray, ReqArray, ExtensibleCheck } from "../../../CustomTypes";
...
import Identifierefn from "../../../../Definitions/HL7DE/0.9.11/Profile/Identifierefn";
import Identifierlanr from "../../../../Definitions/HL7DE/0.9.11/Profile/Identifierlanr";
...
interface Practitioner {
    ...
    identifier?: (Identifierlanr | Identifierefn)[];
    active?: boolean;
...
const Practitioner: t.Type<Practitioner> = t.recursion("Practitioner", () =>
    t.intersection([
        ...
        t.partial({
            ...
            identifier: ReqArray<
                t.UnionC<[t.Type<Identifierlanr>, t.Type<Identifierefn>]>,
                t.Any
            >(
                t.union([Identifierlanr, Identifierefn]),
                [
                    {
                        codec: Identifierlanr,
                        occurrence: ["0", "*"],
                        sliceBy: {
                            path: "type.coding.code",
                            value: "http://fhir.de/StructureDefinition/identifier-lanr"
                        }
                    },
                    {
                        codec: Identifierefn,
                        ...
                        sliceBy: {
                            path: "type.coding.code",
                            value: "http://fhir.de/StructureDefinition/identifier-efn"
                        }
                    }
                ],
                ["0", "*"]
