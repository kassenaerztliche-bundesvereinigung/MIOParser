...
// Canonical URL for ValueSet: http://terminology.hl7.org/ValueSet/v3-ActEncounterCode

type V3ActEncounterCode =
    | "ACCTRECEIVABLE"
    | "CASH"
    | "AE"
    | "DN"
...
const V3ActEncounterCode: t.Type<V3ActEncounterCode> = t.union(
    [
...
export const V3ActEncounterCodeArray: string[] = [
    "ACCTRECEIVABLE",
    "CASH",
    "AE",
    "DN",
...
export const V3ActEncounterCodeValueSet: ValueSet = [
    {
...
export default V3ActEncounterCode;
