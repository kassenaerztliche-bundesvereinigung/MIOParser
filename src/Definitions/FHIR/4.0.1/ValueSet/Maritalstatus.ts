...
export const MaritalstatusValueSet: ValueSet = [
    ...
    },
    {
        system: "http://terminology.hl7.org/CodeSystem/v3-NullFlavor",
        concept: [
            { code: "DER", display: "derived" },
            { code: "NINF", display: "negative infinity" },
            { code: "PINF", display: "positive infinity" },
            { code: "UNC", display: "un-encoded" },
            { code: "MSK", display: "masked" },
            { code: "NA", display: "not applicable" },
            { code: "NAV", display: "temporarily unavailable" },
            { code: "NASK", display: "not asked" },
            { code: "NAVU", display: "Not available" },
            { code: "QS", display: "Sufficient Quantity" },
            { code: "TRC", display: "trace" },
            { code: "NP", display: "not present" }
        ]
    }
];
