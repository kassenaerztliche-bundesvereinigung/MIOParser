...
const VaccinationImmunizationOriginCodesGerman: ConceptMap = [
    {
        ...
        target:
            "https://fhir.kbv.de/CodeSystem/KBV_CS_MIO_Vaccination_ImmunizationOriginCodes_German",
        element: [
            {
                code: "recall",
                ...
                target: [
                    {
                        code: "Eltern-Patienten-Erziehungsberechtigter-Erinnerung",
            ...
            },
            {
                ...
                target: [
                    {
                        code: "Schriftliche-Dokumentation",
            ...
            },
            {
                ...
                target: [
                    {
                        code: "Anderer-Arzt-oder-sonstiger-im-Gesundheitsberuf",
