...
type VaccinationTargetdiseaseGerman =
    | "Notwendigkeit-Immunglobulingabe"
    | "Infektionskrankheit-unspezifiziert";

const VaccinationTargetdiseaseGerman: t.Type<VaccinationTargetdiseaseGerman> = t.union([
    t.literal("Notwendigkeit-Immunglobulingabe"),
    t.literal("Infektionskrankheit-unspezifiziert")
]);
