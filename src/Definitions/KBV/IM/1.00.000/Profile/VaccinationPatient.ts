 ...
 * A reference to a code defined by a terminology system.
 */
export interface VaccinationPatientReisepassnummerTypePassportType {
    system: "http://terminology.hl7.org/CodeSystem/v2-0203";
    code: "PPN";
    id?: string;
    version?: string;
...
export const VaccinationPatientReisepassnummerTypePassportType: t.Type<VaccinationPatientReisepassnummerTypePassportType> = t.recursion(
    "VaccinationPatientReisepassnummerTypePassportType",
    () =>
        Excess(
            t.intersection([
                t.type({
 ...
 * A reference to a code defined by a terminology system.
 */
export interface VaccinationPatientVersichertennummerkvkTypeKvk {
...
export const VaccinationPatientVersichertennummerkvkTypeKvk: t.Type<VaccinationPatientVersichertennummerkvkTypeKvk> = t.recursion(
    "VaccinationPatientVersichertennummerkvkTypeKvk",
    () =>
        Excess(
            t.intersection([
                t.type({
...
export interface VaccinationPatientReisepassnummerType {
    coding: Array<VaccinationPatientReisepassnummerTypePassportType>;
    id?: string;
}
...
export interface VaccinationPatientVersichertennummerkvkType {
    coding: Array<VaccinationPatientVersichertennummerkvkTypeKvk>;
    id?: string;
}
...
/**
 * Dieses Element beschreibt eine Person, die eine oder mehrere medizinische Leistungen in Anspruch nimmt.
 */
