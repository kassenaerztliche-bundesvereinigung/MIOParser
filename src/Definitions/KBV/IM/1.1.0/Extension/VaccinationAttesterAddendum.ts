...
export const VaccinationAttesterAddendumModeValueCodeableConceptCoding: t.Type<VaccinationAttesterAddendumModeValueCodeableConceptCoding> =
    t.recursion("VaccinationAttesterAddendumModeValueCodeableConceptCoding", () =>
        Excess(
            t.intersection([
                t.type({
...
export const VaccinationAttesterAddendumModeValueCodeableConcept: t.Type<VaccinationAttesterAddendumModeValueCodeableConcept> =
    t.recursion("VaccinationAttesterAddendumModeValueCodeableConcept", () =>
        Excess(
            t.intersection([
                t.type({
                    coding: MinMaxArray(
...
export const VaccinationAttesterAddendumPartyValueReference: t.Type<VaccinationAttesterAddendumPartyValueReference> =
    t.recursion("VaccinationAttesterAddendumPartyValueReference", () =>
        Excess(
            t.intersection([
                t.type({
...
export const VaccinationAttesterAddendumMode: t.Type<VaccinationAttesterAddendumMode> =
    t.recursion("VaccinationAttesterAddendumMode", () =>
        Excess(
            t.intersection([
                t.type({
                    url: Literal("mode"),
...
export const VaccinationAttesterAddendumParty: t.Type<VaccinationAttesterAddendumParty> =
    t.recursion("VaccinationAttesterAddendumParty", () =>
        Excess(
            t.intersection([
                t.type({
                    url: Literal("party"),
