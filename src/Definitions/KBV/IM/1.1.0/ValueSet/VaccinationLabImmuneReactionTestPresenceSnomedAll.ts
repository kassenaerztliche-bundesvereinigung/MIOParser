...
const VaccinationLabImmuneReactionTestPresenceSnomedAll: t.Type<VaccinationLabImmuneReactionTestPresenceSnomedAll> = t.union(
    [
        t.literal(
            "363787002:246093002=259858000,370134009=123029007,370132008=117363000,704319004=50863008,370130000=705057003,704327008=119364003"
        ),
...
export const VaccinationLabImmuneReactionTestPresenceSnomedAllValueSet: ValueSet = [
    ...
    },
    {
        system: "http://snomed.info/sct",
        concept: [
            { code: "268376005", display: "Mantoux: positive (finding)" },
            { code: "268375009", display: "Mantoux: negative (finding)" },
            { code: "440662009", display: "Interferon gamma assay positive (finding)" },
            { code: "440661002", display: "Interferon gamma assay negative (finding)" }
        ]
    }
];
