...
import TerminologyGerman from "../../../../../Definitions/KBVBase/1.1.3/Extension/TerminologyGerman";
...
export const MRControlNeededKodeValueCodeableConceptCodingDisplay: t.Type<MRControlNeededKodeValueCodeableConceptCodingDisplay> =
    t.recursion("MRControlNeededKodeValueCodeableConceptCodingDisplay", () =>
        Excess(
            t.partial({
                id: SCALARString,
...
export const MRControlNeededKodeValueCodeableConceptCoding: t.Type<MRControlNeededKodeValueCodeableConceptCoding> =
    t.recursion("MRControlNeededKodeValueCodeableConceptCoding", () =>
        Excess(
            t.intersection([
                t.type({
...
export const MRControlNeededKodeValueCodeableConcept: t.Type<MRControlNeededKodeValueCodeableConcept> =
    t.recursion("MRControlNeededKodeValueCodeableConcept", () =>
        Excess(
            t.intersection([
                t.type({
                    coding: MinMaxArray(
...
export const MRControlNeededKontrollbeduerftig: t.Type<MRControlNeededKontrollbeduerftig> =
    t.recursion("MRControlNeededKontrollbeduerftig", () =>
        Excess(
            t.intersection([
                t.type({
