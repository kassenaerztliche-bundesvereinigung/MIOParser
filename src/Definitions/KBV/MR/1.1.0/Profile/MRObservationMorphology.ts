...
import MRMorphologyVS from "../../../../../Definitions/KBV/MR/1.1.0/ValueSet/MRMorphology";
...
export interface MRObservationMorphologyCodeCodingDisplayAnzeigenameCodeSnomed {
    ...
    id?: string;
    extension?: MRObservationMorphologyCodeCodingDisplayAnzeigenameCodeSnomedContent[];
}
...
export interface MRObservationMorphologyBodySiteCodingDisplayAnzeigenameBodysiteSnomed {
    url: "https://fhir.kbv.de/StructureDefinition/KBV_EX_Base_Terminology_German";
    id?: string;
    extension?: MRObservationMorphologyBodySiteCodingDisplayAnzeigenameBodysiteSnomedContent[];
}
...
export interface MRObservationMorphologyCodeCodingDisplay {
    id?: string;
    extension?: MRObservationMorphologyCodeCodingDisplayAnzeigenameCodeSnomed[];
    value?: string;
}
...
export interface MRObservationMorphologyBodySiteCodingDisplay {
    id?: string;
    extension?: MRObservationMorphologyBodySiteCodingDisplayAnzeigenameBodysiteSnomed[];
    value?: string;
}
...
export interface MRObservationMorphologyMeta {
    profile: Array<"https://fhir.kbv.de/StructureDefinition/KBV_PR_MIO_MR_Observation_Morphology|1.1.0">;
    id?: string;
}
...
export interface MRObservationMorphologyBodySite {
    ...
    id?: string;
    extension?: MRObservationMorphologyBodySiteIdentifikation[];
    text?: string;
}
    ...
    t.recursion("MRObservationMorphologyBodySite", () =>
        Excess(
            t.intersection([
                ...
                t.partial({
                    id: SCALARString,
                    extension: t.array(MRObservationMorphologyBodySiteIdentifikation),
                    text: SCALARString
                })
            ])
        )
