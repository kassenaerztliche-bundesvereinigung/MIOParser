 ...
 */
export interface MRObservationOtherBloodGroupSystemsSubjectReference {
    reference: string;
    id?: string;
}

export const MRObservationOtherBloodGroupSystemsSubjectReference: t.Type<MRObservationOtherBloodGroupSystemsSubjectReference> =
    t.recursion("MRObservationOtherBloodGroupSystemsSubjectReference", () =>
        Excess(
            t.intersection([
                t.type({
 ...
 */
export interface MRObservationOtherBloodGroupSystemsEncounterReference {
    reference: string;
    id?: string;
}

export const MRObservationOtherBloodGroupSystemsEncounterReference: t.Type<MRObservationOtherBloodGroupSystemsEncounterReference> =
    t.recursion("MRObservationOtherBloodGroupSystemsEncounterReference", () =>
        Excess(
            t.intersection([
                t.type({
                    reference: CustomReference(SCALARString, [
 ...
 */
export interface MRObservationOtherBloodGroupSystemsPerformerReference {
    reference: string;
    id?: string;
}

export const MRObservationOtherBloodGroupSystemsPerformerReference: t.Type<MRObservationOtherBloodGroupSystemsPerformerReference> =
    t.recursion("MRObservationOtherBloodGroupSystemsPerformerReference", () =>
        Excess(
            t.intersection([
                t.type({
                    reference: CustomReference(SCALARString, [
...
interface MRObservationOtherBloodGroupSystems {
    ...
    subject: MRObservationOtherBloodGroupSystemsSubjectReference;
    encounter: MRObservationOtherBloodGroupSystemsEncounterReference;
    effectiveDateTime: string;
    valueString: string;
    id?: string;
    text?: Narrative;
    performer?: Array<MRObservationOtherBloodGroupSystemsPerformerReference>;
}
        ...
        Excess(
            t.intersection([
                ...
                t.partial({
                    ...
                    performer: MaxArray(
                        1,
                        MRObservationOtherBloodGroupSystemsPerformerReference
                    )
                })
            ])
        )
