...
export interface MRObservationChildPositionCodeCodingDisplayAnzeigenameCodeSnomed {
    ...
    id?: string;
    extension?: MRObservationChildPositionCodeCodingDisplayAnzeigenameCodeSnomedContent[];
}
...
export interface MRObservationChildPositionBodySiteCodingDisplayAnzeigenameBodysiteSnomed {
    url: "https://fhir.kbv.de/StructureDefinition/KBV_EX_Base_Terminology_German";
    id?: string;
    extension?: MRObservationChildPositionBodySiteCodingDisplayAnzeigenameBodysiteSnomedContent[];
}
...
export interface MRObservationChildPositionCodeCodingDisplay {
    id?: string;
    extension?: MRObservationChildPositionCodeCodingDisplayAnzeigenameCodeSnomed[];
    value?: string;
}
...
export interface MRObservationChildPositionBodySiteCodingDisplay {
    id?: string;
    extension?: MRObservationChildPositionBodySiteCodingDisplayAnzeigenameBodysiteSnomed[];
    value?: string;
}
...
export interface MRObservationChildPositionMeta {
    profile: Array<"https://fhir.kbv.de/StructureDefinition/KBV_PR_MIO_MR_Observation_Child_Position|1.1.0">;
    id?: string;
}
 ...
 */
export interface MRObservationChildPositionSubjectReference {
    reference: string;
    id?: string;
}

export const MRObservationChildPositionSubjectReference: t.Type<MRObservationChildPositionSubjectReference> =
    t.recursion("MRObservationChildPositionSubjectReference", () =>
        Excess(
            t.intersection([
                t.type({
 ...
 */
export interface MRObservationChildPositionEncounterReference {
    reference: string;
    id?: string;
}

export const MRObservationChildPositionEncounterReference: t.Type<MRObservationChildPositionEncounterReference> =
    t.recursion("MRObservationChildPositionEncounterReference", () =>
        Excess(
            t.intersection([
                t.type({
                    reference: CustomReference(SCALARString, [
 ...
 */
export interface MRObservationChildPositionPerformerReference {
    reference: string;
    id?: string;
}

export const MRObservationChildPositionPerformerReference: t.Type<MRObservationChildPositionPerformerReference> =
    t.recursion("MRObservationChildPositionPerformerReference", () =>
        Excess(
            t.intersection([
                t.type({
                    reference: CustomReference(SCALARString, [
...
export interface MRObservationChildPositionBodySite {
    ...
    id?: string;
    extension?: MRObservationChildPositionBodySiteIdentifikation[];
    text?: string;
}
    ...
    t.recursion("MRObservationChildPositionBodySite", () =>
        Excess(
            t.intersection([
                ...
                t.partial({
                    id: SCALARString,
                    extension: t.array(MRObservationChildPositionBodySiteIdentifikation),
                    text: SCALARString
                })
            ])
        )
...
interface MRObservationChildPosition {
    ...
    subject: MRObservationChildPositionSubjectReference;
    encounter: MRObservationChildPositionEncounterReference;
    effectiveDateTime: string;
    valueString: string;
    id?: string;
    text?: Narrative;
    performer?: Array<MRObservationChildPositionPerformerReference>;
        ...
        Excess(
            t.intersection([
                ...
                t.partial({
                    id: SCALARString,
                    text: Narrative,
                    performer: MaxArray(1, MRObservationChildPositionPerformerReference),
                    bodySite: MRObservationChildPositionBodySite
                })
            ])
        )
