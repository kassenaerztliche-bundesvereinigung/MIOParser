...
import MRCatalogueAVS from "../../../../../Definitions/KBV/MR/1.1.0/ValueSet/MRCatalogueA";
...
export interface MRObservationCatalogueACodeCodingDisplayAnzeigenameCodeSnomed {
    ...
    id?: string;
    extension?: MRObservationCatalogueACodeCodingDisplayAnzeigenameCodeSnomedContent[];
}
...
export interface MRObservationCatalogueACodeCodingDisplay {
    id?: string;
    extension?: MRObservationCatalogueACodeCodingDisplayAnzeigenameCodeSnomed[];
    value?: string;
}
...
export interface MRObservationCatalogueAMeta {
    profile: Array<"https://fhir.kbv.de/StructureDefinition/KBV_PR_MIO_MR_Observation_Catalogue_A|1.1.0">;
    id?: string;
}
