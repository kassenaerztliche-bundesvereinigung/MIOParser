...
export interface MREncounterInpatientTreatmentTypeCodingDisplayAnzeigenameCodeSnomed {
    ...
    id?: string;
    extension?: MREncounterInpatientTreatmentTypeCodingDisplayAnzeigenameCodeSnomedContent[];
}
...
export interface MREncounterInpatientTreatmentTypeCodingDisplay {
    id?: string;
    extension?: MREncounterInpatientTreatmentTypeCodingDisplayAnzeigenameCodeSnomed[];
    value?: string;
}
...
export interface MREncounterInpatientTreatmentMeta {
    profile: Array<"https://fhir.kbv.de/StructureDefinition/KBV_PR_MIO_MR_Encounter_Inpatient_Treatment|1.1.0">;
    id?: string;
}
...
export interface MREncounterInpatientTreatmentPeriod {
    id?: string;
    extension?: MREncounterInpatientTreatmentPeriodVonBis[];
}
...
export const MREncounterInpatientTreatmentPeriod: t.Type<MREncounterInpatientTreatmentPeriod> =
    t.recursion("MREncounterInpatientTreatmentPeriod", () =>
        Excess(
            t.partial({
                id: SCALARString,
                extension: t.array(MREncounterInpatientTreatmentPeriodVonBis)
            })
        )
    );
...
interface MREncounterInpatientTreatment {
    ...
    id?: string;
    text?: Narrative;
    extension?: MREncounterInpatientTreatmentTherapie[];
        ...
        Excess(
            t.intersection([
                ...
                t.partial({
                    id: SCALARString,
                    text: Narrative,
                    extension: t.array(MREncounterInpatientTreatmentTherapie),
