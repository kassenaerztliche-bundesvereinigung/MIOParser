...
export interface MRObservationWeightMotherCodeCodeSnomedDisplayAnzeigenameCodeSnomed {
    ...
    id?: string;
    extension?: MRObservationWeightMotherCodeCodeSnomedDisplayAnzeigenameCodeSnomedContent[];
}
...
export interface MRObservationWeightMotherCodeCodeLoincDisplayAnzeigenameCodeLoinc {
    url: "https://fhir.kbv.de/StructureDefinition/KBV_EX_Base_Terminology_German";
    id?: string;
    extension?: MRObservationWeightMotherCodeCodeLoincDisplayAnzeigenameCodeLoincContent[];
}
...
export interface MRObservationWeightMotherCodeCodeSnomedDisplay {
    id?: string;
    extension?: MRObservationWeightMotherCodeCodeSnomedDisplayAnzeigenameCodeSnomed[];
    value?: string;
}
...
export interface MRObservationWeightMotherCodeCodeLoincDisplay {
    id?: string;
    extension?: MRObservationWeightMotherCodeCodeLoincDisplayAnzeigenameCodeLoinc[];
    value?: string;
}
...
export interface MRObservationWeightMotherMeta {
    profile: Array<"https://fhir.kbv.de/StructureDefinition/KBV_PR_MIO_MR_Observation_Weight_Mother|1.1.0">;
    id?: string;
}
...
export const MRObservationWeightMotherSubject: t.Type<MRObservationWeightMotherSubject> =
    t.recursion("MRObservationWeightMotherSubject", () =>
        Excess(
            t.intersection([
                t.type({
...
export const MRObservationWeightMotherEncounter: t.Type<MRObservationWeightMotherEncounter> =
    t.recursion("MRObservationWeightMotherEncounter", () =>
        Excess(
            t.intersection([
                t.type({
                    reference: CustomReference(SCALARString, [
...
export const MRObservationWeightMotherPerformer: t.Type<MRObservationWeightMotherPerformer> =
    t.recursion("MRObservationWeightMotherPerformer", () =>
        Excess(
            t.intersection([
                t.type({
                    reference: CustomReference(SCALARString, [
