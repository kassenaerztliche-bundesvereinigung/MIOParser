...
import MRBirthModeVS from "../../../../../Definitions/KBV/MR/1.1.0/ValueSet/MRBirthMode";
...
export const MRObservationBirthModeValueCodeableConceptCodingDisplayAnzeigenameValueSnomedContent: t.Type<MRObservationBirthModeValueCodeableConceptCodingDisplayAnzeigenameValueSnomedContent> =
    t.recursion(
...
export const MRObservationBirthModeCodeCodingDisplayAnzeigenameCodeSnomedContent: t.Type<MRObservationBirthModeCodeCodingDisplayAnzeigenameCodeSnomedContent> =
    t.recursion(
...
export const MRObservationBirthModeValueCodeableConceptCodingDisplayAnzeigenameValueSnomed: t.Type<MRObservationBirthModeValueCodeableConceptCodingDisplayAnzeigenameValueSnomed> =
    t.recursion(
...
export const MRObservationBirthModeCodeCodingDisplayAnzeigenameCodeSnomed: t.Type<MRObservationBirthModeCodeCodingDisplayAnzeigenameCodeSnomed> =
    t.recursion("MRObservationBirthModeCodeCodingDisplayAnzeigenameCodeSnomed", () =>
        Excess(
            t.intersection([
                t.type({
                    url: Literal(
...
export const MRObservationBirthModeValueCodeableConceptCodingDisplay: t.Type<MRObservationBirthModeValueCodeableConceptCodingDisplay> =
    t.recursion("MRObservationBirthModeValueCodeableConceptCodingDisplay", () =>
        Excess(
            t.partial({
                id: SCALARString,
                extension: t.array(
...
export const MRObservationBirthModeCodeCodingDisplay: t.Type<MRObservationBirthModeCodeCodingDisplay> =
    t.recursion("MRObservationBirthModeCodeCodingDisplay", () =>
        Excess(
            t.partial({
                id: SCALARString,
                extension: t.array(
...
export const MRObservationBirthModeValueCodeableConceptCoding: t.Type<MRObservationBirthModeValueCodeableConceptCoding> =
    t.recursion("MRObservationBirthModeValueCodeableConceptCoding", () =>
        Excess(
            t.intersection([
                t.type({
...
export const MRObservationBirthModeCodeCoding: t.Type<MRObservationBirthModeCodeCoding> =
    t.recursion("MRObservationBirthModeCodeCoding", () =>
        Excess(
            t.intersection([
                t.type({
                    system: Literal("http://snomed.info/sct"),
...
export const MRObservationBirthModeValueCodeableConcept: t.Type<MRObservationBirthModeValueCodeableConcept> =
    t.recursion("MRObservationBirthModeValueCodeableConcept", () =>
        Excess(
            t.intersection([
                t.type({
                    coding: MinMaxArray(
...
export interface MRObservationBirthModeMeta {
    profile: Array<"https://fhir.kbv.de/StructureDefinition/KBV_PR_MIO_MR_Observation_Birth_Mode|1.1.0">;
    id?: string;
}
