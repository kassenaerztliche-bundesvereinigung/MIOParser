...
import MRDirectCoombstestVS from "../../../../../Definitions/KBV/MR/1.1.0/ValueSet/MRDirectCoombstest";
...
export const MRObservationDirectCoombstestValueCodeableConceptCodingDisplayAnzeigenameValueSnomedContent: t.Type<MRObservationDirectCoombstestValueCodeableConceptCodingDisplayAnzeigenameValueSnomedContent> =
    t.recursion(
...
export const MRObservationDirectCoombstestCodeCodingDisplayAnzeigenameCodeSnomedContent: t.Type<MRObservationDirectCoombstestCodeCodingDisplayAnzeigenameCodeSnomedContent> =
    t.recursion(
...
export interface MRObservationDirectCoombstestValueCodeableConceptCodingDisplayAnzeigenameValueSnomed {
    ...
    id?: string;
    extension?: MRObservationDirectCoombstestValueCodeableConceptCodingDisplayAnzeigenameValueSnomedContent[];
}

export const MRObservationDirectCoombstestValueCodeableConceptCodingDisplayAnzeigenameValueSnomed: t.Type<MRObservationDirectCoombstestValueCodeableConceptCodingDisplayAnzeigenameValueSnomed> =
    t.recursion(
...
export interface MRObservationDirectCoombstestCodeCodingDisplayAnzeigenameCodeSnomed {
    url: "https://fhir.kbv.de/StructureDefinition/KBV_EX_Base_Terminology_German";
    id?: string;
    extension?: MRObservationDirectCoombstestCodeCodingDisplayAnzeigenameCodeSnomedContent[];
}

export const MRObservationDirectCoombstestCodeCodingDisplayAnzeigenameCodeSnomed: t.Type<MRObservationDirectCoombstestCodeCodingDisplayAnzeigenameCodeSnomed> =
    t.recursion(
...
export interface MRObservationDirectCoombstestValueCodeableConceptCodingDisplay {
    id?: string;
    extension?: MRObservationDirectCoombstestValueCodeableConceptCodingDisplayAnzeigenameValueSnomed[];
    value?: string;
}

export const MRObservationDirectCoombstestValueCodeableConceptCodingDisplay: t.Type<MRObservationDirectCoombstestValueCodeableConceptCodingDisplay> =
    t.recursion("MRObservationDirectCoombstestValueCodeableConceptCodingDisplay", () =>
        Excess(
            t.partial({
                id: SCALARString,
                extension: t.array(
...
export interface MRObservationDirectCoombstestCodeCodingDisplay {
    id?: string;
    extension?: MRObservationDirectCoombstestCodeCodingDisplayAnzeigenameCodeSnomed[];
    value?: string;
}

export const MRObservationDirectCoombstestCodeCodingDisplay: t.Type<MRObservationDirectCoombstestCodeCodingDisplay> =
    t.recursion("MRObservationDirectCoombstestCodeCodingDisplay", () =>
        Excess(
            t.partial({
                id: SCALARString,
                extension: t.array(
...
export const MRObservationDirectCoombstestValueCodeableConceptCoding: t.Type<MRObservationDirectCoombstestValueCodeableConceptCoding> =
    t.recursion("MRObservationDirectCoombstestValueCodeableConceptCoding", () =>
        Excess(
            t.intersection([
                t.type({
...
export const MRObservationDirectCoombstestCodeCoding: t.Type<MRObservationDirectCoombstestCodeCoding> =
    t.recursion("MRObservationDirectCoombstestCodeCoding", () =>
        Excess(
            t.intersection([
                t.type({
                    system: Literal("http://snomed.info/sct"),
...
export const MRObservationDirectCoombstestValueCodeableConcept: t.Type<MRObservationDirectCoombstestValueCodeableConcept> =
    t.recursion("MRObservationDirectCoombstestValueCodeableConcept", () =>
        Excess(
            t.intersection([
                t.type({
                    coding: MinMaxArray(
...
export interface MRObservationDirectCoombstestMeta {
    profile: Array<"https://fhir.kbv.de/StructureDefinition/KBV_PR_MIO_MR_Observation_Direct_Coombstest|1.1.0">;
    id?: string;
}

export const MRObservationDirectCoombstestMeta: t.Type<MRObservationDirectCoombstestMeta> =
    t.recursion("MRObservationDirectCoombstestMeta", () =>
        Excess(
            t.intersection([
                t.type({
                    profile: MinMaxArray(
...
export const MRObservationDirectCoombstestCode: t.Type<MRObservationDirectCoombstestCode> =
    t.recursion("MRObservationDirectCoombstestCode", () =>
        Excess(
            t.intersection([
                t.type({
