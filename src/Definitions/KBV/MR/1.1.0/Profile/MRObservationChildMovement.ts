...
export interface MRObservationChildMovementCodeCodingDisplayAnzeigenameCodeSnomed {
    ...
    id?: string;
    extension?: MRObservationChildMovementCodeCodingDisplayAnzeigenameCodeSnomedContent[];
}
...
export interface MRObservationChildMovementBodySiteCodingDisplayAnzeigenameBodysiteSnomed {
    url: "https://fhir.kbv.de/StructureDefinition/KBV_EX_Base_Terminology_German";
    id?: string;
    extension?: MRObservationChildMovementBodySiteCodingDisplayAnzeigenameBodysiteSnomedContent[];
}
...
export interface MRObservationChildMovementCodeCodingDisplay {
    id?: string;
    extension?: MRObservationChildMovementCodeCodingDisplayAnzeigenameCodeSnomed[];
    value?: string;
}
...
export interface MRObservationChildMovementBodySiteCodingDisplay {
    id?: string;
    extension?: MRObservationChildMovementBodySiteCodingDisplayAnzeigenameBodysiteSnomed[];
    value?: string;
}
...
export interface MRObservationChildMovementMeta {
    profile: Array<"https://fhir.kbv.de/StructureDefinition/KBV_PR_MIO_MR_Observation_Child_Movement|1.1.0">;
    id?: string;
}
...
export interface MRObservationChildMovementBodySite {
    ...
    id?: string;
    extension?: MRObservationChildMovementBodySiteIdentifikation[];
}
    ...
    t.recursion("MRObservationChildMovementBodySite", () =>
        Excess(
            t.intersection([
                ...
                t.partial({
                    id: SCALARString,
                    extension: t.array(MRObservationChildMovementBodySiteIdentifikation)
                })
            ])
        )
    );
