...
export interface MRObservationVaginalExaminationCodeCodingDisplayAnzeigenameCodeSnomed {
    ...
    id?: string;
    extension?: MRObservationVaginalExaminationCodeCodingDisplayAnzeigenameCodeSnomedContent[];
}
...
export interface MRObservationVaginalExaminationCodeCodingDisplay {
    id?: string;
    extension?: MRObservationVaginalExaminationCodeCodingDisplayAnzeigenameCodeSnomed[];
    value?: string;
}
        ...
        Excess(
            t.intersection([
                t.type({
                    ...
                    code: Literal("113023007+51597003")
                }),
                t.partial({
                    id: SCALARString,
                    _display: MRObservationVaginalExaminationCodeCodingDisplay,
...
export interface MRObservationVaginalExaminationMeta {
    profile: Array<"https://fhir.kbv.de/StructureDefinition/KBV_PR_MIO_MR_Observation_Vaginal_Examination|1.1.0">;
    id?: string;
}
