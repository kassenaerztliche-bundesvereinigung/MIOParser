...
export interface MRObservationHeartSoundsChildCodeCodingDisplayAnzeigenameCodeSnomed {
    ...
    id?: string;
    extension?: MRObservationHeartSoundsChildCodeCodingDisplayAnzeigenameCodeSnomedContent[];
}
...
export interface MRObservationHeartSoundsChildBodySiteCodingDisplayAnzeigenameBodysiteSnomed {
    url: "https://fhir.kbv.de/StructureDefinition/KBV_EX_Base_Terminology_German";
    id?: string;
    extension?: MRObservationHeartSoundsChildBodySiteCodingDisplayAnzeigenameBodysiteSnomedContent[];
}
...
export interface MRObservationHeartSoundsChildCodeCodingDisplay {
    id?: string;
    extension?: MRObservationHeartSoundsChildCodeCodingDisplayAnzeigenameCodeSnomed[];
    value?: string;
}
...
export interface MRObservationHeartSoundsChildBodySiteCodingDisplay {
    id?: string;
    extension?: MRObservationHeartSoundsChildBodySiteCodingDisplayAnzeigenameBodysiteSnomed[];
    value?: string;
}
...
export interface MRObservationHeartSoundsChildMeta {
    profile: Array<"https://fhir.kbv.de/StructureDefinition/KBV_PR_MIO_MR_Observation_Heart_Sounds_Child|1.1.0">;
    id?: string;
}
...
export interface MRObservationHeartSoundsChildBodySite {
    ...
    id?: string;
    extension?: MRObservationHeartSoundsChildBodySiteIdentifikation[];
}
