...
import MRGeneralInformationVS from "../../../../../Definitions/KBV/MR/1.1.0/ValueSet/MRGeneralInformation";
...
export interface MRObservationGeneralInformationCodeCodingDisplayAnzeigenameCodeSnomed {
    ...
    id?: string;
    extension?: MRObservationGeneralInformationCodeCodingDisplayAnzeigenameCodeSnomedContent[];
}
...
export interface MRObservationGeneralInformationBodySiteCodingDisplayAnzeigenameBodysiteSnomed {
    url: "https://fhir.kbv.de/StructureDefinition/KBV_EX_Base_Terminology_German";
    id?: string;
    extension?: MRObservationGeneralInformationBodySiteCodingDisplayAnzeigenameBodysiteSnomedContent[];
}
...
export interface MRObservationGeneralInformationCodeCodingDisplay {
    id?: string;
    extension?: MRObservationGeneralInformationCodeCodingDisplayAnzeigenameCodeSnomed[];
    value?: string;
}
...
export interface MRObservationGeneralInformationBodySiteCodingDisplay {
    id?: string;
    extension?: MRObservationGeneralInformationBodySiteCodingDisplayAnzeigenameBodysiteSnomed[];
    value?: string;
}
...
export interface MRObservationGeneralInformationMeta {
    profile: Array<"https://fhir.kbv.de/StructureDefinition/KBV_PR_MIO_MR_Observation_General_Information|1.1.0">;
    id?: string;
}
...
export interface MRObservationGeneralInformationBodySite {
    ...
    id?: string;
    extension?: MRObservationGeneralInformationBodySiteIdentifikation[];
    text?: string;
}
