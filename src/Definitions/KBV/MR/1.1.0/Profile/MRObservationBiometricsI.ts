...
import MRBiometricsIVS from "../../../../../Definitions/KBV/MR/1.1.0/ValueSet/MRBiometricsI";
...
export interface MRObservationBiometricsICodeCodingDisplayAnzeigenameCodeSnomed {
    ...
    id?: string;
    extension?: MRObservationBiometricsICodeCodingDisplayAnzeigenameCodeSnomedContent[];
}
...
export interface MRObservationBiometricsIBodySiteCodingDisplayAnzeigenameBodySiteSnomed {
    url: "https://fhir.kbv.de/StructureDefinition/KBV_EX_Base_Terminology_German";
    id?: string;
    extension?: MRObservationBiometricsIBodySiteCodingDisplayAnzeigenameBodySiteSnomedContent[];
}
...
export interface MRObservationBiometricsICodeCodingDisplay {
    id?: string;
    extension?: MRObservationBiometricsICodeCodingDisplayAnzeigenameCodeSnomed[];
    value?: string;
}
...
export interface MRObservationBiometricsIBodySiteCodingDisplay {
    id?: string;
    extension?: MRObservationBiometricsIBodySiteCodingDisplayAnzeigenameBodySiteSnomed[];
    value?: string;
}
...
export interface MRObservationBiometricsIMeta {
    profile: Array<"https://fhir.kbv.de/StructureDefinition/KBV_PR_MIO_MR_Observation_Biometrics_I|1.1.0">;
    id?: string;
}
