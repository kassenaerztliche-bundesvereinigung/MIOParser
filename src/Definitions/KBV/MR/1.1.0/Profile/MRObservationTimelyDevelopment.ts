...
export interface MRObservationTimelyDevelopmentKontrollbeduerftigKodeValueCodeableConceptCodingDisplayAnzeigenameCodeSnomed {
    ...
    id?: string;
    extension?: MRObservationTimelyDevelopmentKontrollbeduerftigKodeValueCodeableConceptCodingDisplayAnzeigenameCodeSnomedContent[];
}
...
export interface MRObservationTimelyDevelopmentKontrollbeduerftigKodeValueCodeableConceptCodingDisplay {
    id?: string;
    extension?: MRObservationTimelyDevelopmentKontrollbeduerftigKodeValueCodeableConceptCodingDisplayAnzeigenameCodeSnomed[];
    value?: string;
}
...
export interface MRObservationTimelyDevelopmentCodeCodingDisplayAnzeigenameCodeSnomed {
    url: "https://fhir.kbv.de/StructureDefinition/KBV_EX_Base_Terminology_German";
    id?: string;
    extension?: MRObservationTimelyDevelopmentCodeCodingDisplayAnzeigenameCodeSnomedContent[];
}
...
export interface MRObservationTimelyDevelopmentBodySiteCodingDisplayAnzeigenameBodysiteSnomed {
    url: "https://fhir.kbv.de/StructureDefinition/KBV_EX_Base_Terminology_German";
    id?: string;
    extension?: MRObservationTimelyDevelopmentBodySiteCodingDisplayAnzeigenameBodysiteSnomedContent[];
}
...
export interface MRObservationTimelyDevelopmentCodeCodingDisplay {
    id?: string;
    extension?: MRObservationTimelyDevelopmentCodeCodingDisplayAnzeigenameCodeSnomed[];
    value?: string;
}
...
export interface MRObservationTimelyDevelopmentBodySiteCodingDisplay {
    id?: string;
    extension?: MRObservationTimelyDevelopmentBodySiteCodingDisplayAnzeigenameBodysiteSnomed[];
    value?: string;
}
...
export interface MRObservationTimelyDevelopmentMeta {
    profile: Array<"https://fhir.kbv.de/StructureDefinition/KBV_PR_MIO_MR_Observation_Timely_Development|1.1.0">;
    id?: string;
}
...
export interface MRObservationTimelyDevelopmentBodySite {
    ...
    id?: string;
    extension?: MRObservationTimelyDevelopmentBodySiteIdentifikation[];
    text?: string;
}
