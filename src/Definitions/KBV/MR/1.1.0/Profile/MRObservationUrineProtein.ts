...
export interface MRObservationUrineProteinCodeCodingDisplayAnzeigenameCodeSnomed {
    ...
    id?: string;
    extension?: MRObservationUrineProteinCodeCodingDisplayAnzeigenameCodeSnomedContent[];
}
...
export interface MRObservationUrineProteinCodeCodingDisplay {
    id?: string;
    extension?: MRObservationUrineProteinCodeCodingDisplayAnzeigenameCodeSnomed[];
    value?: string;
}
...
export interface MRObservationUrineProteinMeta {
    profile: Array<"https://fhir.kbv.de/StructureDefinition/KBV_PR_MIO_MR_Observation_Urine_Protein|1.1.0">;
    id?: string;
}
