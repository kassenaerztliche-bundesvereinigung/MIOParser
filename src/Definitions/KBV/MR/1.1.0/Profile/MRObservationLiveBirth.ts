...
export interface MRObservationLiveBirthCodeCodingDisplayAnzeigenameCodeSnomed {
    ...
    id?: string;
    extension?: MRObservationLiveBirthCodeCodingDisplayAnzeigenameCodeSnomedContent[];
}
...
export interface MRObservationLiveBirthCodeCodingDisplay {
    id?: string;
    extension?: MRObservationLiveBirthCodeCodingDisplayAnzeigenameCodeSnomed[];
    value?: string;
}
...
export interface MRObservationLiveBirthMeta {
    profile: Array<"https://fhir.kbv.de/StructureDefinition/KBV_PR_MIO_MR_Observation_Live_Birth|1.1.0">;
    id?: string;
}
