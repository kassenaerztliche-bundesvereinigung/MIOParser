...
export interface MRObservationInpatientStayDuringPregnancyCodeCodingDisplayAnzeigenameCodeSnomed {
    ...
    id?: string;
    extension?: MRObservationInpatientStayDuringPregnancyCodeCodingDisplayAnzeigenameCodeSnomedContent[];
}
...
export interface MRObservationInpatientStayDuringPregnancyCodeCodingDisplay {
    id?: string;
    extension?: MRObservationInpatientStayDuringPregnancyCodeCodingDisplayAnzeigenameCodeSnomed[];
    value?: string;
}
...
export interface MRObservationInpatientStayDuringPregnancyMeta {
    profile: Array<"https://fhir.kbv.de/StructureDefinition/KBV_PR_MIO_MR_Observation_Inpatient_Stay_During_Pregnancy|1.1.0">;
    id?: string;
}
