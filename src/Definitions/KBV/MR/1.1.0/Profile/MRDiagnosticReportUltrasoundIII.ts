 ...
 */
export interface MRDiagnosticReportUltrasoundIIIErgaenzendeAngaben {
    url: "https://fhir.kbv.de/StructureDefinition/KBV_EX_Base_Additional_Comment";
    valueString: string;
    id?: string;
}

export const MRDiagnosticReportUltrasoundIIIErgaenzendeAngaben: t.Type<MRDiagnosticReportUltrasoundIIIErgaenzendeAngaben> =
    t.recursion("MRDiagnosticReportUltrasoundIIIErgaenzendeAngaben", () =>
        Excess(
            t.intersection([
                t.type({
                    url: Literal(
...
export interface MRDiagnosticReportUltrasoundIIIMeta {
    profile: Array<"https://fhir.kbv.de/StructureDefinition/KBV_PR_MIO_MR_DiagnosticReport_Ultrasound_III|1.1.0">;
    id?: string;
}
