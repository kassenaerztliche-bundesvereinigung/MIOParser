...
export interface MRObservationGravidaCodeCodingDisplayAnzeigenameCodeSnomed {
    ...
    id?: string;
    extension?: MRObservationGravidaCodeCodingDisplayAnzeigenameCodeSnomedContent[];
}
...
export interface MRObservationGravidaCodeCodingDisplay {
    id?: string;
    extension?: MRObservationGravidaCodeCodingDisplayAnzeigenameCodeSnomed[];
    value?: string;
}
...
export interface MRObservationGravidaMeta {
    profile: Array<"https://fhir.kbv.de/StructureDefinition/KBV_PR_MIO_MR_Observation_Gravida|1.1.0">;
    id?: string;
}
