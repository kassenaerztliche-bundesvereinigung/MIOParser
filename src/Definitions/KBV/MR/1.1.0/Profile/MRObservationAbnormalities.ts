...
export interface MRObservationAbnormalitiesKontrollbeduerftigKodeValueCodeableConceptCodingDisplayAnzeigenameCodeSnomedContent {
    url: "content";
    valueString: "Auffälligkeiten kontrollbedürftig";
    id?: string;
}

export const MRObservationAbnormalitiesKontrollbeduerftigKodeValueCodeableConceptCodingDisplayAnzeigenameCodeSnomedContent: t.Type<MRObservationAbnormalitiesKontrollbeduerftigKodeValueCodeableConceptCodingDisplayAnzeigenameCodeSnomedContent> =
    t.recursion(
        ...
        () =>
            Excess(
                t.intersection([
                    t.type({
                        url: Literal("content"),
                        valueString: Literal("Auffälligkeiten kontrollbedürftig")
                    }),
                    t.partial({
                        id: SCALARString
                    })
...
export interface MRObservationAbnormalitiesKontrollbeduerftigKodeValueCodeableConceptCodingDisplayAnzeigenameCodeSnomed {
    ...
    id?: string;
    extension?: MRObservationAbnormalitiesKontrollbeduerftigKodeValueCodeableConceptCodingDisplayAnzeigenameCodeSnomedContent[];
}

export const MRObservationAbnormalitiesKontrollbeduerftigKodeValueCodeableConceptCodingDisplayAnzeigenameCodeSnomed: t.Type<MRObservationAbnormalitiesKontrollbeduerftigKodeValueCodeableConceptCodingDisplayAnzeigenameCodeSnomed> =
    t.recursion(
...
export interface MRObservationAbnormalitiesKontrollbeduerftigKodeValueCodeableConceptCodingDisplay {
    id?: string;
    extension?: MRObservationAbnormalitiesKontrollbeduerftigKodeValueCodeableConceptCodingDisplayAnzeigenameCodeSnomed[];
    value?: string;
}

export const MRObservationAbnormalitiesKontrollbeduerftigKodeValueCodeableConceptCodingDisplay: t.Type<MRObservationAbnormalitiesKontrollbeduerftigKodeValueCodeableConceptCodingDisplay> =
    t.recursion(
...
export const MRObservationAbnormalitiesKontrollbeduerftigKodeValueCodeableConceptCoding: t.Type<MRObservationAbnormalitiesKontrollbeduerftigKodeValueCodeableConceptCoding> =
    t.recursion(
...
export const MRObservationAbnormalitiesCodeCodingDisplayAnzeigenameCodeSnomedContent: t.Type<MRObservationAbnormalitiesCodeCodingDisplayAnzeigenameCodeSnomedContent> =
    t.recursion(
...
export interface MRObservationAbnormalitiesKontrollbeduerftigKodeValueCodeableConcept {
    coding: Array<MRObservationAbnormalitiesKontrollbeduerftigKodeValueCodeableConceptCoding>;
    id?: string;
}

export const MRObservationAbnormalitiesKontrollbeduerftigKodeValueCodeableConcept: t.Type<MRObservationAbnormalitiesKontrollbeduerftigKodeValueCodeableConcept> =
    t.recursion(
...
export interface MRObservationAbnormalitiesCodeCodingDisplayAnzeigenameCodeSnomed {
    url: "https://fhir.kbv.de/StructureDefinition/KBV_EX_Base_Terminology_German";
    id?: string;
    extension?: MRObservationAbnormalitiesCodeCodingDisplayAnzeigenameCodeSnomedContent[];
}

export const MRObservationAbnormalitiesCodeCodingDisplayAnzeigenameCodeSnomed: t.Type<MRObservationAbnormalitiesCodeCodingDisplayAnzeigenameCodeSnomed> =
    t.recursion("MRObservationAbnormalitiesCodeCodingDisplayAnzeigenameCodeSnomed", () =>
        Excess(
            t.intersection([
                t.type({
                    url: Literal(
...
export const MRObservationAbnormalitiesKontrollbeduerftigKode: t.Type<MRObservationAbnormalitiesKontrollbeduerftigKode> =
    t.recursion("MRObservationAbnormalitiesKontrollbeduerftigKode", () =>
        Excess(
            t.intersection([
                t.type({
                    url: Literal("kode"),
...
export const MRObservationAbnormalitiesKontrollbeduerftigKontrollbeduerftig: t.Type<MRObservationAbnormalitiesKontrollbeduerftigKontrollbeduerftig> =
    t.recursion("MRObservationAbnormalitiesKontrollbeduerftigKontrollbeduerftig", () =>
        Excess(
            t.intersection([
                t.type({
...
export interface MRObservationAbnormalitiesCodeCodingDisplay {
    id?: string;
    extension?: MRObservationAbnormalitiesCodeCodingDisplayAnzeigenameCodeSnomed[];
    value?: string;
}

export const MRObservationAbnormalitiesCodeCodingDisplay: t.Type<MRObservationAbnormalitiesCodeCodingDisplay> =
    t.recursion("MRObservationAbnormalitiesCodeCodingDisplay", () =>
        Excess(
            t.partial({
                id: SCALARString,
                extension: t.array(
...
export const MRObservationAbnormalitiesKontrollbeduerftig: t.Type<MRObservationAbnormalitiesKontrollbeduerftig> =
    t.recursion("MRObservationAbnormalitiesKontrollbeduerftig", () =>
        Excess(
            t.intersection([
                t.type({
                    url: Literal(
                    ...
                    extension: ReqArray<
                        t.UnionC<
                            [
                                ...
                                t.Type<MRObservationAbnormalitiesKontrollbeduerftigKontrollbeduerftig>
                            ]
                        >,
                        t.Any
                    >(
...
export const MRObservationAbnormalitiesCodeCoding: t.Type<MRObservationAbnormalitiesCodeCoding> =
    t.recursion("MRObservationAbnormalitiesCodeCoding", () =>
        Excess(
            t.intersection([
                t.type({
                    system: Literal("http://snomed.info/sct"),
...
export interface MRObservationAbnormalitiesMeta {
    profile: Array<"https://fhir.kbv.de/StructureDefinition/KBV_PR_MIO_MR_Observation_Abnormalities|1.1.0">;
    id?: string;
}

export const MRObservationAbnormalitiesMeta: t.Type<MRObservationAbnormalitiesMeta> =
    t.recursion("MRObservationAbnormalitiesMeta", () =>
        Excess(
            t.intersection([
                t.type({
                    profile: MinMaxArray(
...
export const MRObservationAbnormalitiesCode: t.Type<MRObservationAbnormalitiesCode> =
    t.recursion("MRObservationAbnormalitiesCode", () =>
        Excess(
            t.intersection([
                t.type({
...
interface MRObservationAbnormalities {
    ...
    id?: string;
    text?: Narrative;
    extension?: MRObservationAbnormalitiesKontrollbeduerftig[];
        ...
        Excess(
            t.intersection([
                ...
                t.partial({
                    id: SCALARString,
                    text: Narrative,
                    extension: t.array(MRObservationAbnormalitiesKontrollbeduerftig),
