...
export const MRObservationNumberOfCheckupsCodeCodingDisplayAnzeigenameCodeSnomedContent: t.Type<MRObservationNumberOfCheckupsCodeCodingDisplayAnzeigenameCodeSnomedContent> = t.recursion(
...
export const MRObservationNumberOfCheckupsCodeCodingDisplayAnzeigenameCodeSnomed: t.Type<MRObservationNumberOfCheckupsCodeCodingDisplayAnzeigenameCodeSnomed> = t.recursion(
...
export const MRObservationNumberOfCheckupsCodeCodingDisplay: t.Type<MRObservationNumberOfCheckupsCodeCodingDisplay> = t.recursion(
    "MRObservationNumberOfCheckupsCodeCodingDisplay",
    () =>
        Excess(
            t.partial({
                id: SCALARString,
...
export const MRObservationNumberOfCheckupsCodeCoding: t.Type<MRObservationNumberOfCheckupsCodeCoding> = t.recursion(
    "MRObservationNumberOfCheckupsCodeCoding",
    () =>
        Excess(
            t.intersection([
                t.type({
...
export const MRObservationNumberOfCheckupsValueQuantity: t.Type<MRObservationNumberOfCheckupsValueQuantity> = t.recursion(
    "MRObservationNumberOfCheckupsValueQuantity",
    () =>
        Excess(
            t.intersection([
                t.type({
...
export const MRObservationNumberOfCheckupsMeta: t.Type<MRObservationNumberOfCheckupsMeta> = t.recursion(
    "MRObservationNumberOfCheckupsMeta",
    () =>
        Excess(
            t.intersection([
                t.type({
...
export const MRObservationNumberOfCheckupsCode: t.Type<MRObservationNumberOfCheckupsCode> = t.recursion(
    "MRObservationNumberOfCheckupsCode",
    () =>
        Excess(
            t.intersection([
                t.type({
...
export const MRObservationNumberOfCheckupsSubject: t.Type<MRObservationNumberOfCheckupsSubject> = t.recursion(
    "MRObservationNumberOfCheckupsSubject",
    () =>
        Excess(
            t.intersection([
                t.type({
...
export const MRObservationNumberOfCheckupsEncounter: t.Type<MRObservationNumberOfCheckupsEncounter> = t.recursion(
    "MRObservationNumberOfCheckupsEncounter",
    () =>
        Excess(
            t.intersection([
                t.type({
...
export const MRObservationNumberOfCheckupsPerformer: t.Type<MRObservationNumberOfCheckupsPerformer> = t.recursion(
    "MRObservationNumberOfCheckupsPerformer",
    () =>
        Excess(
            t.intersection([
                t.type({
