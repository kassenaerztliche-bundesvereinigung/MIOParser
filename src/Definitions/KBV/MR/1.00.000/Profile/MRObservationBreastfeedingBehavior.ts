...
import MRBreastfeedingBehaviorVS from "../../../../../Definitions/KBV/MR/1.00.000/ValueSet/MRBreastfeedingBehavior";
            ...
            t.partial({
                ...
                >(
                    ...
                    [
                        ...
                        {
                            codec: MRObservationBreastfeedingBehaviorCodeCodingDisplayAnzeigenameCodeSnomed,
                            occurrence: ["1", "1"],
                            sliceBy: {
                                path: "url",
                                value:
