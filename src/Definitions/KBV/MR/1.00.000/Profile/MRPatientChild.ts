...
export const MRPatientChildIdentifierNummer: t.Type<MRPatientChildIdentifierNummer> = t.recursion(
    "MRPatientChildIdentifierNummer",
    () =>
        Excess(
            t.intersection([
                t.type({
...
export const MRPatientChildErgaenzendeAngaben: t.Type<MRPatientChildErgaenzendeAngaben> = t.recursion(
    "MRPatientChildErgaenzendeAngaben",
    () =>
        Excess(
            t.intersection([
                t.type({
