...
export const MRObservationAdviceOnIodineIntakeCodeCodingDisplayAnzeigenameCodeSnomedContent: t.Type<MRObservationAdviceOnIodineIntakeCodeCodingDisplayAnzeigenameCodeSnomedContent> = t.recursion(
...
export const MRObservationAdviceOnIodineIntakeCodeCodingDisplayAnzeigenameCodeSnomed: t.Type<MRObservationAdviceOnIodineIntakeCodeCodingDisplayAnzeigenameCodeSnomed> = t.recursion(
...
export const MRObservationAdviceOnIodineIntakeCodeCodingDisplay: t.Type<MRObservationAdviceOnIodineIntakeCodeCodingDisplay> = t.recursion(
    "MRObservationAdviceOnIodineIntakeCodeCodingDisplay",
    () =>
        Excess(
            t.partial({
                id: SCALARString,
...
export const MRObservationAdviceOnIodineIntakeCodeCoding: t.Type<MRObservationAdviceOnIodineIntakeCodeCoding> = t.recursion(
    "MRObservationAdviceOnIodineIntakeCodeCoding",
    () =>
        Excess(
            t.intersection([
                t.type({
...
export const MRObservationAdviceOnIodineIntakeMeta: t.Type<MRObservationAdviceOnIodineIntakeMeta> = t.recursion(
    "MRObservationAdviceOnIodineIntakeMeta",
    () =>
        Excess(
            t.intersection([
                t.type({
...
export const MRObservationAdviceOnIodineIntakeCode: t.Type<MRObservationAdviceOnIodineIntakeCode> = t.recursion(
    "MRObservationAdviceOnIodineIntakeCode",
    () =>
        Excess(
            t.intersection([
                t.type({
...
export const MRObservationAdviceOnIodineIntakeSubject: t.Type<MRObservationAdviceOnIodineIntakeSubject> = t.recursion(
    "MRObservationAdviceOnIodineIntakeSubject",
    () =>
        Excess(
            t.intersection([
                t.type({
...
export const MRObservationAdviceOnIodineIntakeEncounter: t.Type<MRObservationAdviceOnIodineIntakeEncounter> = t.recursion(
    "MRObservationAdviceOnIodineIntakeEncounter",
    () =>
        Excess(
            t.intersection([
                t.type({
...
export const MRObservationAdviceOnIodineIntakePerformer: t.Type<MRObservationAdviceOnIodineIntakePerformer> = t.recursion(
    "MRObservationAdviceOnIodineIntakePerformer",
    () =>
        Excess(
            t.intersection([
                t.type({
...
const MRObservationAdviceOnIodineIntake: t.Type<MRObservationAdviceOnIodineIntake> = t.recursion(
