...
const MRAB0SystemFirstExaminationAfterChildbirthGerman: t.Type<MRAB0SystemFirstExaminationAfterChildbirthGerman> = t.union(
    [t.literal("A"), t.literal("B"), t.literal("AB"), t.literal("0")]
);
