...
const MRExaminationInterpretationGerman: t.Type<MRExaminationInterpretationGerman> = t.union(
    [t.literal("Immunitaeterreicht"), t.literal("Immunitaetnichterreicht")]
);
