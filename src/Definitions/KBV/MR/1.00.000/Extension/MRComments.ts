...
export const MRCommentsHinweiseSchwangere: t.Type<MRCommentsHinweiseSchwangere> = t.recursion(
...
export const MRCommentsAufbewahrungshinweis: t.Type<MRCommentsAufbewahrungshinweis> = t.recursion(
