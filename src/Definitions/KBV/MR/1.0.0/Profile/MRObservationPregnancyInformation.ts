                    ...
                    t.partial({
                        ...
                        extension: ReqArray<
                            t.UnionC<
                                [
                                    t.Type<Extension>,
                                    t.Type<MRObservationPregnancyInformationCodeCodingDisplayAnzeigenameCodeSnomedContent>
                                ]
                            >,
                            t.Any
                        >(
            ...
            t.partial({
                ...
                extension: ReqArray<
                    t.UnionC<
                        [
                            t.Type<Extension>,
                            t.Type<MRObservationPregnancyInformationCodeCodingDisplayAnzeigenameCodeSnomed>
                        ]
                    >,
                    t.Any
                >(
...
export interface MRObservationPregnancyInformationMeta {
    profile: Array<"https://fhir.kbv.de/StructureDefinition/KBV_PR_MIO_MR_Observation_Pregnancy_Information|1.0.0">;
    id?: string;
}
...
export const MRObservationPregnancyInformationSubject: t.Type<MRObservationPregnancyInformationSubject> =
    t.recursion("MRObservationPregnancyInformationSubject", () =>
        Excess(
            t.intersection([
                t.type({
...
export const MRObservationPregnancyInformationEncounter: t.Type<MRObservationPregnancyInformationEncounter> =
    t.recursion("MRObservationPregnancyInformationEncounter", () =>
        Excess(
            t.intersection([
                t.type({
                    reference: CustomReference(SCALARString, [
...
export const MRObservationPregnancyInformationPerformer: t.Type<MRObservationPregnancyInformationPerformer> =
    t.recursion("MRObservationPregnancyInformationPerformer", () =>
        Excess(
            t.intersection([
                t.type({
                    reference: CustomReference(SCALARString, [
