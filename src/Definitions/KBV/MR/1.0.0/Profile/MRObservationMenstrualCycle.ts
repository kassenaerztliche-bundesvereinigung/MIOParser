                ...
                t.partial({
                    ...
                    >(
                        ...
                        [
                            ...
                            {
                                codec: MRObservationMenstrualCycleCodeCodingDisplayAnzeigenameCodeSnomedContent,
                                occurrence: ["1", "1"],
                                sliceBy: { path: "url", value: "content" }
                            }
                        ],
            ...
            t.partial({
                ...
                >(
                    ...
                    [
                        ...
                        {
                            codec: MRObservationMenstrualCycleZykluslaengeCodeCodingDisplayAnzeigenameCodeSnomed,
                            occurrence: ["1", "1"],
                            sliceBy: {
                                path: "url",
            ...
            t.partial({
                ...
                >(
                    ...
                    [
                        ...
                        {
                            codec: MRObservationMenstrualCycleBlutungsdauerCodeCodingDisplayAnzeigenameCodeSnomed,
                            occurrence: ["1", "1"],
                            sliceBy: {
                                path: "url",
                                value: "https://fhir.kbv.de/StructureDefinition/KBV_EX_Base_Terminology_German"
            ...
            t.partial({
                ...
                >(
                    ...
                    [
                        ...
                        {
                            codec: MRObservationMenstrualCycleLetztePeriodeCodeCodingDisplayAnzeigenameCodeSnomed,
                            occurrence: ["1", "1"],
                            sliceBy: {
                                path: "url",
                                value: "https://fhir.kbv.de/StructureDefinition/KBV_EX_Base_Terminology_German"
            ...
            t.partial({
                ...
                >(
                    ...
                    [
                        ...
                        {
                            codec: MRObservationMenstrualCycleCodeCodingDisplayAnzeigenameCodeSnomed,
                            occurrence: ["1", "1"],
                            sliceBy: {
                                path: "url",
                                value: "https://fhir.kbv.de/StructureDefinition/KBV_EX_Base_Terminology_German"
