...
import MRDirectCoombstestVS from "../../../../../Definitions/KBV/MR/1.0.0/ValueSet/MRDirectCoombstest";
                    ...
                    t.partial({
                        ...
                        extension: ReqArray<
                            t.UnionC<
                                [
                                    t.Type<Extension>,
                                    t.Type<MRObservationDirectCoombstestValueCodeableConceptCodingDisplayAnzeigenameValueSnomedContent>
                                ]
                            >,
                            t.Any
                        >(
                    ...
                    t.partial({
                        ...
                        extension: ReqArray<
                            t.UnionC<
                                [
                                    t.Type<Extension>,
                                    t.Type<MRObservationDirectCoombstestCodeCodingDisplayAnzeigenameCodeSnomedContent>
                                ]
                            >,
                            t.Any
                        >(
            ...
            t.partial({
                ...
                extension: ReqArray<
                    t.UnionC<
                        [
                            t.Type<Extension>,
                            t.Type<MRObservationDirectCoombstestValueCodeableConceptCodingDisplayAnzeigenameValueSnomed>
                        ]
                    >,
                    t.Any
                >(
            ...
            t.partial({
                ...
                extension: ReqArray<
                    t.UnionC<
                        [
                            t.Type<Extension>,
                            t.Type<MRObservationDirectCoombstestCodeCodingDisplayAnzeigenameCodeSnomed>
                        ]
                    >,
                    t.Any
                >(
...
export interface MRObservationDirectCoombstestMeta {
    profile: Array<"https://fhir.kbv.de/StructureDefinition/KBV_PR_MIO_MR_Observation_Direct_Coombstest|1.0.0">;
    id?: string;
}
