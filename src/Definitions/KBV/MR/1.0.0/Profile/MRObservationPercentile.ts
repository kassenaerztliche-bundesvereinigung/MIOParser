                ...
                t.partial({
                    ...
                    >(
                        ...
                        [
                            ...
                            {
                                codec: MRObservationPercentileCodeCodingDisplayAnzeigenameCodeSnomedContent,
                                occurrence: ["1", "1"],
            ...
            t.partial({
                ...
                >(
                    ...
                    [
                        ...
                        {
                            codec: MRObservationPercentileCodeCodingDisplayAnzeigenameCodeSnomed,
                            occurrence: ["1", "1"],
                            sliceBy: {
                                path: "url",
            ...
            t.partial({
                ...
                >(
                    ...
                    [
                        ...
                        {
                            codec: MRObservationPercentileBodySiteCodingDisplayAnzeigenameBodysiteSnomed,
                            occurrence: ["1", "1"],
                            sliceBy: {
                                path: "url",
                                value: "https://fhir.kbv.de/StructureDefinition/KBV_EX_Base_Terminology_German"
...
export interface MRObservationPercentileCodeCoding {
    ...
    code: "363787002:370130000=118583003";
    id?: string;
        ...
        Excess(
            t.intersection([
                t.type({
                    ...
                    code: Literal("363787002:370130000=118583003")
                }),
                t.partial({
                    id: SCALARString,
                    _display: MRObservationPercentileCodeCodingDisplay,
...
export interface MRObservationPercentileBodySite {
    ...
    id?: string;
    extension?: (Extension | MRObservationPercentileBodySiteIdentifikation)[];
    text?: string;
}
                ...
                t.partial({
                    ...
                    extension: ReqArray<
                        t.UnionC<
                            [
                                t.Type<Extension>,
                                t.Type<MRObservationPercentileBodySiteIdentifikation>
                            ]
                        >,
                        t.Any
                    >(
                        ...
                        [
                            ...
                            {
                                codec: MRObservationPercentileBodySiteIdentifikation,
                                occurrence: ["0", "1"],
                                sliceBy: {
                                    path: "url",
