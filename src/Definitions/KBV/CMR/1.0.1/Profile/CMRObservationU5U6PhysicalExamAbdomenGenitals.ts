...
import CMRU5U6PhysicalExamAbdomenGenitalsVS from "../../../../../Definitions/KBV/CMR/1.0.1/ValueSet/CMRU5U6PhysicalExamAbdomenGenitals";
...
export const CMRObservationU5U6PhysicalExamAbdomenGenitalsCodeCodingDisplayAnzeigenameCodeSnomedContent: t.Type<CMRObservationU5U6PhysicalExamAbdomenGenitalsCodeCodingDisplayAnzeigenameCodeSnomedContent> =
    t.recursion(
...
export const CMRObservationU5U6PhysicalExamAbdomenGenitalsCodeCodingDisplayAnzeigenameCodeSnomed: t.Type<CMRObservationU5U6PhysicalExamAbdomenGenitalsCodeCodingDisplayAnzeigenameCodeSnomed> =
    t.recursion(
                    ...
                    t.partial({
                        ...
                        extension: ReqArray<
                            t.UnionC<
                                [
                                    t.Type<Extension>,
                                    t.Type<CMRObservationU5U6PhysicalExamAbdomenGenitalsCodeCodingDisplayAnzeigenameCodeSnomedContent>
                                ]
                            >,
                            t.Any
                        >(
...
export const CMRObservationU5U6PhysicalExamAbdomenGenitalsCodeCodingDisplay: t.Type<CMRObservationU5U6PhysicalExamAbdomenGenitalsCodeCodingDisplay> =
    t.recursion("CMRObservationU5U6PhysicalExamAbdomenGenitalsCodeCodingDisplay", () =>
        Excess(
            t.partial({
                id: SCALARString,
                extension: ReqArray<
                    t.UnionC<
                        [
                            t.Type<Extension>,
                            t.Type<CMRObservationU5U6PhysicalExamAbdomenGenitalsCodeCodingDisplayAnzeigenameCodeSnomed>
                        ]
                    >,
                    t.Any
                >(
...
export const CMRObservationU5U6PhysicalExamAbdomenGenitalsCodeCoding: t.Type<CMRObservationU5U6PhysicalExamAbdomenGenitalsCodeCoding> =
    t.recursion("CMRObservationU5U6PhysicalExamAbdomenGenitalsCodeCoding", () =>
        Excess(
            t.intersection([
                t.type({
                    system: SCALARUri,
...
export interface CMRObservationU5U6PhysicalExamAbdomenGenitalsMeta {
    profile: Array<"https://fhir.kbv.de/StructureDefinition/KBV_PR_MIO_CMR_Observation_U5_U6_Physical_Exam_Abdomen_Genitals|1.0.1">;
    id?: string;
}

export const CMRObservationU5U6PhysicalExamAbdomenGenitalsMeta: t.Type<CMRObservationU5U6PhysicalExamAbdomenGenitalsMeta> =
    t.recursion("CMRObservationU5U6PhysicalExamAbdomenGenitalsMeta", () =>
        Excess(
            t.intersection([
                t.type({
                    profile: MinMaxArray(
...
export const CMRObservationU5U6PhysicalExamAbdomenGenitalsCode: t.Type<CMRObservationU5U6PhysicalExamAbdomenGenitalsCode> =
    t.recursion("CMRObservationU5U6PhysicalExamAbdomenGenitalsCode", () =>
        Excess(
            t.intersection([
                t.type({
                    coding: MinMaxArray(
...
const CMRObservationU5U6PhysicalExamAbdomenGenitals: t.Type<CMRObservationU5U6PhysicalExamAbdomenGenitals> =
    t.recursion("CMRObservationU5U6PhysicalExamAbdomenGenitals", () =>
        Excess(
            t.intersection([
                t.type({
