...
export const PNEncounterTypeCodingDisplayAnzeigenameTypeSnomedContent: t.Type<PNEncounterTypeCodingDisplayAnzeigenameTypeSnomedContent> =
    t.recursion("PNEncounterTypeCodingDisplayAnzeigenameTypeSnomedContent", () =>
        Excess(
            t.intersection([
                t.type({
                    url: Literal("content"),
...
export const PNEncounterTypeCodingDisplayAnzeigenameTypeSnomed: t.Type<PNEncounterTypeCodingDisplayAnzeigenameTypeSnomed> =
    t.recursion("PNEncounterTypeCodingDisplayAnzeigenameTypeSnomed", () =>
        Excess(
            t.intersection([
                t.type({
                    url: Literal(
                ...
                t.partial({
                    ...
                    extension: ReqArray<
                        t.UnionC<
                            [
                                t.Type<Extension>,
                                t.Type<PNEncounterTypeCodingDisplayAnzeigenameTypeSnomedContent>
                            ]
                        >,
                        t.Any
                    >(
...
export const PNEncounterTypeCodingDisplay: t.Type<PNEncounterTypeCodingDisplay> =
    t.recursion("PNEncounterTypeCodingDisplay", () =>
        Excess(
            t.partial({
                id: SCALARString,
                extension: ReqArray<
...
export interface PNEncounterMeta {
    profile: Array<"https://fhir.kbv.de/StructureDefinition/KBV_PR_MIO_PN_Encounter|1.0.1">;
    id?: string;
}
