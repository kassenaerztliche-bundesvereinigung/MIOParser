...
import CMRU6CurrentChildHistoryVS from "../../../../../Definitions/KBV/CMR/1.0.1/ValueSet/CMRU6CurrentChildHistory";
...
export const CMRObservationU6CurrentChildHistoryCodeCodingDisplayAnzeigenameCodeSnomedContent: t.Type<CMRObservationU6CurrentChildHistoryCodeCodingDisplayAnzeigenameCodeSnomedContent> =
    t.recursion(
...
export const CMRObservationU6CurrentChildHistoryCodeCodingDisplayAnzeigenameCodeSnomed: t.Type<CMRObservationU6CurrentChildHistoryCodeCodingDisplayAnzeigenameCodeSnomed> =
    t.recursion(
                    ...
                    t.partial({
                        ...
                        extension: ReqArray<
                            t.UnionC<
                                [
                                    t.Type<Extension>,
                                    t.Type<CMRObservationU6CurrentChildHistoryCodeCodingDisplayAnzeigenameCodeSnomedContent>
                                ]
                            >,
                            t.Any
                        >(
...
export const CMRObservationU6CurrentChildHistoryCodeCodingDisplay: t.Type<CMRObservationU6CurrentChildHistoryCodeCodingDisplay> =
    t.recursion("CMRObservationU6CurrentChildHistoryCodeCodingDisplay", () =>
        Excess(
            t.partial({
                id: SCALARString,
                extension: ReqArray<
                    t.UnionC<
                        [
                            t.Type<Extension>,
                            t.Type<CMRObservationU6CurrentChildHistoryCodeCodingDisplayAnzeigenameCodeSnomed>
                        ]
                    >,
                    t.Any
                >(
...
export const CMRObservationU6CurrentChildHistoryCodeCoding: t.Type<CMRObservationU6CurrentChildHistoryCodeCoding> =
    t.recursion("CMRObservationU6CurrentChildHistoryCodeCoding", () =>
        Excess(
            t.intersection([
                t.type({
                    system: SCALARUri,
...
export interface CMRObservationU6CurrentChildHistoryMeta {
    profile: Array<"https://fhir.kbv.de/StructureDefinition/KBV_PR_MIO_CMR_Observation_U6_Current_Child_History|1.0.1">;
    id?: string;
}

export const CMRObservationU6CurrentChildHistoryMeta: t.Type<CMRObservationU6CurrentChildHistoryMeta> =
    t.recursion("CMRObservationU6CurrentChildHistoryMeta", () =>
        Excess(
            t.intersection([
                t.type({
                    profile: MinMaxArray(
...
export const CMRObservationU6CurrentChildHistoryCode: t.Type<CMRObservationU6CurrentChildHistoryCode> =
    t.recursion("CMRObservationU6CurrentChildHistoryCode", () =>
        Excess(
            t.intersection([
                t.type({
                    coding: MinMaxArray(
...
const CMRObservationU6CurrentChildHistory: t.Type<CMRObservationU6CurrentChildHistory> =
    t.recursion("CMRObservationU6CurrentChildHistory", () =>
        Excess(
            t.intersection([
                t.type({
