...
export const CMRCompositionPulseOxymetryScreeningTypeCoding: t.Type<CMRCompositionPulseOxymetryScreeningTypeCoding> =
    t.recursion("CMRCompositionPulseOxymetryScreeningTypeCoding", () =>
        Excess(
            t.intersection([
                t.type({
...
export const CMRCompositionPulseOxymetryScreeningCategoryCoding: t.Type<CMRCompositionPulseOxymetryScreeningCategoryCoding> =
    t.recursion("CMRCompositionPulseOxymetryScreeningCategoryCoding", () =>
        Excess(
            t.intersection([
                t.type({
                    system: Literal("http://snomed.info/sct"),
...
export interface CMRCompositionPulseOxymetryScreeningMeta {
    profile: Array<"https://fhir.kbv.de/StructureDefinition/KBV_PR_MIO_CMR_Composition_Pulse_Oxymetry_Screening|1.0.1">;
    id?: string;
}

export const CMRCompositionPulseOxymetryScreeningMeta: t.Type<CMRCompositionPulseOxymetryScreeningMeta> =
    t.recursion("CMRCompositionPulseOxymetryScreeningMeta", () =>
        Excess(
            t.intersection([
                t.type({
                    profile: MinMaxArray(
                        ...
                        1,
                        Literal(
                            "https://fhir.kbv.de/StructureDefinition/KBV_PR_MIO_CMR_Composition_Pulse_Oxymetry_Screening|1.0.1"
                        )
                    )
                }),
                t.partial({
...
export const CMRCompositionPulseOxymetryScreeningType: t.Type<CMRCompositionPulseOxymetryScreeningType> =
    t.recursion("CMRCompositionPulseOxymetryScreeningType", () =>
        Excess(
            t.intersection([
                t.type({
                    coding: MinMaxArray(
...
export const CMRCompositionPulseOxymetryScreeningCategory: t.Type<CMRCompositionPulseOxymetryScreeningCategory> =
    t.recursion("CMRCompositionPulseOxymetryScreeningCategory", () =>
        Excess(
            t.intersection([
                t.type({
                    coding: MinMaxArray(
...
export const CMRCompositionPulseOxymetryScreeningSection: t.Type<CMRCompositionPulseOxymetryScreeningSection> =
    t.recursion("CMRCompositionPulseOxymetryScreeningSection", () =>
        Excess(
            t.intersection([
                t.type({
...
const CMRCompositionPulseOxymetryScreening: t.Type<CMRCompositionPulseOxymetryScreening> =
    t.recursion("CMRCompositionPulseOxymetryScreening", () =>
        Excess(
            t.intersection([
                t.type({
