...
export const PNObservationParentalNotesCodeCodingDisplayAnzeigenameCodeSnomedContent: t.Type<PNObservationParentalNotesCodeCodingDisplayAnzeigenameCodeSnomedContent> =
    t.recursion(
...
export const PNObservationParentalNotesCodeCodingDisplayAnzeigenameCodeSnomed: t.Type<PNObservationParentalNotesCodeCodingDisplayAnzeigenameCodeSnomed> =
    t.recursion("PNObservationParentalNotesCodeCodingDisplayAnzeigenameCodeSnomed", () =>
        Excess(
            t.intersection([
                t.type({
                    url: Literal(
                ...
                t.partial({
                    ...
                    extension: ReqArray<
                        t.UnionC<
                            [
                                t.Type<Extension>,
                                t.Type<PNObservationParentalNotesCodeCodingDisplayAnzeigenameCodeSnomedContent>
                            ]
                        >,
                        t.Any
                    >(
...
export const PNObservationParentalNotesCodeCodingDisplay: t.Type<PNObservationParentalNotesCodeCodingDisplay> =
    t.recursion("PNObservationParentalNotesCodeCodingDisplay", () =>
        Excess(
            t.partial({
                id: SCALARString,
                extension: ReqArray<
                    t.UnionC<
                        [
                            t.Type<Extension>,
                            t.Type<PNObservationParentalNotesCodeCodingDisplayAnzeigenameCodeSnomed>
                        ]
                    >,
                    t.Any
                >(
...
export const PNObservationParentalNotesCodeCoding: t.Type<PNObservationParentalNotesCodeCoding> =
    t.recursion("PNObservationParentalNotesCodeCoding", () =>
        Excess(
            t.intersection([
                t.type({
...
export interface PNObservationParentalNotesMeta {
    profile: Array<"https://fhir.kbv.de/StructureDefinition/KBV_PR_MIO_PN_Observation_Parental_Notes|1.0.1">;
    id?: string;
}

export const PNObservationParentalNotesMeta: t.Type<PNObservationParentalNotesMeta> =
    t.recursion("PNObservationParentalNotesMeta", () =>
        Excess(
            t.intersection([
                t.type({
                    profile: MinMaxArray(
...
export const PNObservationParentalNotesCode: t.Type<PNObservationParentalNotesCode> =
    t.recursion("PNObservationParentalNotesCode", () =>
        Excess(
            t.intersection([
                t.type({
