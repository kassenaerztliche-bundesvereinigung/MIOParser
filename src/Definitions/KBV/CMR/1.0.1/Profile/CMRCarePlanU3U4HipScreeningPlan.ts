...
import CMRHipProceedingVS from "../../../../../Definitions/KBV/CMR/1.0.1/ValueSet/CMRHipProceeding";
...
export const CMRCarePlanU3U4HipScreeningPlanActivityDetailCodeCodingDisplayAnzeigenameActivitySnomedContent: t.Type<CMRCarePlanU3U4HipScreeningPlanActivityDetailCodeCodingDisplayAnzeigenameActivitySnomedContent> =
    t.recursion(
...
export const CMRCarePlanU3U4HipScreeningPlanActivityDetailCodeCodingDisplayAnzeigenameActivitySnomed: t.Type<CMRCarePlanU3U4HipScreeningPlanActivityDetailCodeCodingDisplayAnzeigenameActivitySnomed> =
    t.recursion(
                    ...
                    t.partial({
                        ...
                        extension: ReqArray<
                            t.UnionC<
                                [
                                    t.Type<Extension>,
                                    t.Type<CMRCarePlanU3U4HipScreeningPlanActivityDetailCodeCodingDisplayAnzeigenameActivitySnomedContent>
                                ]
                            >,
                            t.Any
                        >(
...
export const CMRCarePlanU3U4HipScreeningPlanActivityDetailCodeCodingDisplay: t.Type<CMRCarePlanU3U4HipScreeningPlanActivityDetailCodeCodingDisplay> =
    t.recursion("CMRCarePlanU3U4HipScreeningPlanActivityDetailCodeCodingDisplay", () =>
        Excess(
            t.partial({
                id: SCALARString,
                extension: ReqArray<
                    t.UnionC<
                        [
                            t.Type<Extension>,
                            t.Type<CMRCarePlanU3U4HipScreeningPlanActivityDetailCodeCodingDisplayAnzeigenameActivitySnomed>
                        ]
                    >,
                    t.Any
                >(
...
export const CMRCarePlanU3U4HipScreeningPlanActivityDetailCodeCoding: t.Type<CMRCarePlanU3U4HipScreeningPlanActivityDetailCodeCoding> =
    t.recursion("CMRCarePlanU3U4HipScreeningPlanActivityDetailCodeCoding", () =>
        Excess(
            t.intersection([
                t.type({
                    system: SCALARUri,
...
export const CMRCarePlanU3U4HipScreeningPlanActivityDetailCode: t.Type<CMRCarePlanU3U4HipScreeningPlanActivityDetailCode> =
    t.recursion("CMRCarePlanU3U4HipScreeningPlanActivityDetailCode", () =>
        Excess(
            t.intersection([
                t.type({
                    coding: MinMaxArray(
...
export const CMRCarePlanU3U4HipScreeningPlanActivityDetail: t.Type<CMRCarePlanU3U4HipScreeningPlanActivityDetail> =
    t.recursion("CMRCarePlanU3U4HipScreeningPlanActivityDetail", () =>
        Excess(
            t.intersection([
                t.type({
                    code: CMRCarePlanU3U4HipScreeningPlanActivityDetailCode,
...
export interface CMRCarePlanU3U4HipScreeningPlanMeta {
    profile: Array<"https://fhir.kbv.de/StructureDefinition/KBV_PR_MIO_CMR_Care_Plan_U3_U4_Hip_Screening_Plan|1.0.1">;
    id?: string;
}

export const CMRCarePlanU3U4HipScreeningPlanMeta: t.Type<CMRCarePlanU3U4HipScreeningPlanMeta> =
    t.recursion("CMRCarePlanU3U4HipScreeningPlanMeta", () =>
        Excess(
            t.intersection([
                t.type({
                    profile: MinMaxArray(
...
export const CMRCarePlanU3U4HipScreeningPlanActivity: t.Type<CMRCarePlanU3U4HipScreeningPlanActivity> =
    t.recursion("CMRCarePlanU3U4HipScreeningPlanActivity", () =>
        Excess(
            t.intersection([
                t.type({
                    detail: CMRCarePlanU3U4HipScreeningPlanActivityDetail
...
const CMRCarePlanU3U4HipScreeningPlan: t.Type<CMRCarePlanU3U4HipScreeningPlan> =
    t.recursion("CMRCarePlanU3U4HipScreeningPlan", () =>
        Excess(
            t.intersection([
                t.type({
