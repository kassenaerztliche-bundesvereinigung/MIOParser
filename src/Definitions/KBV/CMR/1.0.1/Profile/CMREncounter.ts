...
import CMRExaminationNumberVS from "../../../../../Definitions/KBV/CMR/1.0.1/ValueSet/CMRExaminationNumber";
...
export const CMREncounterTypeCodingDisplayAnzeigenameTypeSnomedContent: t.Type<CMREncounterTypeCodingDisplayAnzeigenameTypeSnomedContent> =
    t.recursion("CMREncounterTypeCodingDisplayAnzeigenameTypeSnomedContent", () =>
        Excess(
            t.intersection([
                t.type({
                    url: Literal("content"),
...
export const CMREncounterTypeCodingDisplayAnzeigenameTypeSnomed: t.Type<CMREncounterTypeCodingDisplayAnzeigenameTypeSnomed> =
    t.recursion("CMREncounterTypeCodingDisplayAnzeigenameTypeSnomed", () =>
        Excess(
            t.intersection([
                t.type({
                    url: Literal(
                ...
                t.partial({
                    ...
                    extension: ReqArray<
                        t.UnionC<
                            [
                                t.Type<Extension>,
                                t.Type<CMREncounterTypeCodingDisplayAnzeigenameTypeSnomedContent>
                            ]
                        >,
                        t.Any
                    >(
...
export const CMREncounterTypeCodingDisplay: t.Type<CMREncounterTypeCodingDisplay> =
    t.recursion("CMREncounterTypeCodingDisplay", () =>
        Excess(
            t.partial({
                id: SCALARString,
                extension: ReqArray<
...
export const CMREncounterParticipantTypeCoding: t.Type<CMREncounterParticipantTypeCoding> =
    t.recursion("CMREncounterParticipantTypeCoding", () =>
        Excess(
            t.intersection([
                t.type({
                    system: Literal(
...
export const CMREncounterParticipantType: t.Type<CMREncounterParticipantType> =
    t.recursion("CMREncounterParticipantType", () =>
        Excess(
            t.intersection([
                t.type({
...
export interface CMREncounterMeta {
    profile: Array<"https://fhir.kbv.de/StructureDefinition/KBV_PR_MIO_CMR_Encounter|1.0.1">;
    id?: string;
}
