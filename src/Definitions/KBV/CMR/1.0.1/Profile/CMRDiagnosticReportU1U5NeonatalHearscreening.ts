...
export const CMRDiagnosticReportU1U5NeonatalHearscreeningCodeCodingDisplayAnzeigenameCodeSnomedContent: t.Type<CMRDiagnosticReportU1U5NeonatalHearscreeningCodeCodingDisplayAnzeigenameCodeSnomedContent> =
    t.recursion(
...
export const CMRDiagnosticReportU1U5NeonatalHearscreeningCodeCodingDisplayAnzeigenameCodeSnomed: t.Type<CMRDiagnosticReportU1U5NeonatalHearscreeningCodeCodingDisplayAnzeigenameCodeSnomed> =
    t.recursion(
                    ...
                    t.partial({
                        ...
                        extension: ReqArray<
                            t.UnionC<
                                [
                                    t.Type<Extension>,
                                    t.Type<CMRDiagnosticReportU1U5NeonatalHearscreeningCodeCodingDisplayAnzeigenameCodeSnomedContent>
                                ]
                            >,
                            t.Any
                        >(
...
export const CMRDiagnosticReportU1U5NeonatalHearscreeningCodeCodingDisplay: t.Type<CMRDiagnosticReportU1U5NeonatalHearscreeningCodeCodingDisplay> =
    t.recursion("CMRDiagnosticReportU1U5NeonatalHearscreeningCodeCodingDisplay", () =>
        Excess(
            t.partial({
                id: SCALARString,
                extension: ReqArray<
                    t.UnionC<
                        [
                            t.Type<Extension>,
                            t.Type<CMRDiagnosticReportU1U5NeonatalHearscreeningCodeCodingDisplayAnzeigenameCodeSnomed>
                        ]
                    >,
                    t.Any
                >(
...
export const CMRDiagnosticReportU1U5NeonatalHearscreeningCodeCoding: t.Type<CMRDiagnosticReportU1U5NeonatalHearscreeningCodeCoding> =
    t.recursion("CMRDiagnosticReportU1U5NeonatalHearscreeningCodeCoding", () =>
        Excess(
            t.intersection([
                t.type({
...
export interface CMRDiagnosticReportU1U5NeonatalHearscreeningMeta {
    profile: Array<"https://fhir.kbv.de/StructureDefinition/KBV_PR_MIO_CMR_Diagnostic_Report_U1_U5_Neonatal_Hearscreening|1.0.1">;
    id?: string;
}

export const CMRDiagnosticReportU1U5NeonatalHearscreeningMeta: t.Type<CMRDiagnosticReportU1U5NeonatalHearscreeningMeta> =
    t.recursion("CMRDiagnosticReportU1U5NeonatalHearscreeningMeta", () =>
        Excess(
            t.intersection([
                t.type({
                    profile: MinMaxArray(
...
export const CMRDiagnosticReportU1U5NeonatalHearscreeningCode: t.Type<CMRDiagnosticReportU1U5NeonatalHearscreeningCode> =
    t.recursion("CMRDiagnosticReportU1U5NeonatalHearscreeningCode", () =>
        Excess(
            t.intersection([
                t.type({
                    coding: MinMaxArray(
...
const CMRDiagnosticReportU1U5NeonatalHearscreening: t.Type<CMRDiagnosticReportU1U5NeonatalHearscreening> =
    t.recursion("CMRDiagnosticReportU1U5NeonatalHearscreening", () =>
        Excess(
            t.intersection([
                t.type({
