...
export const CMRProcedureConsultationAnnotationCodeCodingDisplayAnzeigenameCodeSnomedContent: t.Type<CMRProcedureConsultationAnnotationCodeCodingDisplayAnzeigenameCodeSnomedContent> =
    t.recursion(
...
export const CMRProcedureConsultationAnnotationCodeCodingDisplayAnzeigenameCodeSnomed: t.Type<CMRProcedureConsultationAnnotationCodeCodingDisplayAnzeigenameCodeSnomed> =
    t.recursion(
                    ...
                    t.partial({
                        ...
                        extension: ReqArray<
                            t.UnionC<
                                [
                                    t.Type<Extension>,
                                    t.Type<CMRProcedureConsultationAnnotationCodeCodingDisplayAnzeigenameCodeSnomedContent>
                                ]
                            >,
                            t.Any
                        >(
...
export const CMRProcedureConsultationAnnotationCodeCodingDisplay: t.Type<CMRProcedureConsultationAnnotationCodeCodingDisplay> =
    t.recursion("CMRProcedureConsultationAnnotationCodeCodingDisplay", () =>
        Excess(
            t.partial({
                id: SCALARString,
                extension: ReqArray<
                    t.UnionC<
                        [
                            t.Type<Extension>,
                            t.Type<CMRProcedureConsultationAnnotationCodeCodingDisplayAnzeigenameCodeSnomed>
                        ]
                    >,
                    t.Any
                >(
...
export const CMRProcedureConsultationAnnotationCodeCoding: t.Type<CMRProcedureConsultationAnnotationCodeCoding> =
    t.recursion("CMRProcedureConsultationAnnotationCodeCoding", () =>
        Excess(
            t.intersection([
                t.type({
...
export interface CMRProcedureConsultationAnnotationMeta {
    profile: Array<"https://fhir.kbv.de/StructureDefinition/KBV_PR_MIO_CMR_Procedure_Consultation_Annotation|1.0.1">;
    id?: string;
}

export const CMRProcedureConsultationAnnotationMeta: t.Type<CMRProcedureConsultationAnnotationMeta> =
    t.recursion("CMRProcedureConsultationAnnotationMeta", () =>
        Excess(
            t.intersection([
                t.type({
                    profile: MinMaxArray(
...
export const CMRProcedureConsultationAnnotationCode: t.Type<CMRProcedureConsultationAnnotationCode> =
    t.recursion("CMRProcedureConsultationAnnotationCode", () =>
        Excess(
            t.intersection([
                t.type({
                    coding: MinMaxArray(
...
export const CMRProcedureConsultationAnnotationNote: t.Type<CMRProcedureConsultationAnnotationNote> =
    t.recursion("CMRProcedureConsultationAnnotationNote", () =>
        Excess(
            t.intersection([
                t.type({
                    text: SCALARMarkdown
...
const CMRProcedureConsultationAnnotation: t.Type<CMRProcedureConsultationAnnotation> =
    t.recursion("CMRProcedureConsultationAnnotation", () =>
        Excess(
            t.intersection([
                t.type({
