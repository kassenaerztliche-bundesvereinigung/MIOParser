...
export const CMRCompositionPercentileCurveTypeCoding: t.Type<CMRCompositionPercentileCurveTypeCoding> =
    t.recursion("CMRCompositionPercentileCurveTypeCoding", () =>
        Excess(
            t.intersection([
                t.type({
...
export const CMRCompositionPercentileCurveCategoryCoding: t.Type<CMRCompositionPercentileCurveCategoryCoding> =
    t.recursion("CMRCompositionPercentileCurveCategoryCoding", () =>
        Excess(
            t.intersection([
                t.type({
                    system: Literal("http://snomed.info/sct"),
...
export interface CMRCompositionPercentileCurveMeta {
    profile: Array<"https://fhir.kbv.de/StructureDefinition/KBV_PR_MIO_CMR_Composition_Percentile_Curve|1.0.1">;
    id?: string;
}

export const CMRCompositionPercentileCurveMeta: t.Type<CMRCompositionPercentileCurveMeta> =
    t.recursion("CMRCompositionPercentileCurveMeta", () =>
        Excess(
            t.intersection([
                t.type({
                    profile: MinMaxArray(
                        ...
                        1,
                        Literal(
                            "https://fhir.kbv.de/StructureDefinition/KBV_PR_MIO_CMR_Composition_Percentile_Curve|1.0.1"
                        )
                    )
                }),
                t.partial({
...
export const CMRCompositionPercentileCurveType: t.Type<CMRCompositionPercentileCurveType> =
    t.recursion("CMRCompositionPercentileCurveType", () =>
        Excess(
            t.intersection([
                t.type({
...
export const CMRCompositionPercentileCurveCategory: t.Type<CMRCompositionPercentileCurveCategory> =
    t.recursion("CMRCompositionPercentileCurveCategory", () =>
        Excess(
            t.intersection([
                t.type({
...
export const CMRCompositionPercentileCurveSection: t.Type<CMRCompositionPercentileCurveSection> =
    t.recursion("CMRCompositionPercentileCurveSection", () =>
        Excess(
            t.intersection([
                t.type({
