...
export const CMRDiagnosticReportU8U9PhysicalExamMouthNoseCodeCodingDisplayAnzeigenameCodeSnomedContent: t.Type<CMRDiagnosticReportU8U9PhysicalExamMouthNoseCodeCodingDisplayAnzeigenameCodeSnomedContent> =
    t.recursion(
...
export const CMRDiagnosticReportU8U9PhysicalExamMouthNoseCodeCodingDisplayAnzeigenameCodeSnomed: t.Type<CMRDiagnosticReportU8U9PhysicalExamMouthNoseCodeCodingDisplayAnzeigenameCodeSnomed> =
    t.recursion(
                    ...
                    t.partial({
                        ...
                        extension: ReqArray<
                            t.UnionC<
                                [
                                    t.Type<Extension>,
                                    t.Type<CMRDiagnosticReportU8U9PhysicalExamMouthNoseCodeCodingDisplayAnzeigenameCodeSnomedContent>
                                ]
                            >,
                            t.Any
                        >(
...
export const CMRDiagnosticReportU8U9PhysicalExamMouthNoseCodeCodingDisplay: t.Type<CMRDiagnosticReportU8U9PhysicalExamMouthNoseCodeCodingDisplay> =
    t.recursion("CMRDiagnosticReportU8U9PhysicalExamMouthNoseCodeCodingDisplay", () =>
        Excess(
            t.partial({
                id: SCALARString,
                extension: ReqArray<
                    t.UnionC<
                        [
                            t.Type<Extension>,
                            t.Type<CMRDiagnosticReportU8U9PhysicalExamMouthNoseCodeCodingDisplayAnzeigenameCodeSnomed>
                        ]
                    >,
                    t.Any
                >(
...
export const CMRDiagnosticReportU8U9PhysicalExamMouthNoseCodeCoding: t.Type<CMRDiagnosticReportU8U9PhysicalExamMouthNoseCodeCoding> =
    t.recursion("CMRDiagnosticReportU8U9PhysicalExamMouthNoseCodeCoding", () =>
        Excess(
            t.intersection([
                t.type({
...
export interface CMRDiagnosticReportU8U9PhysicalExamMouthNoseMeta {
    profile: Array<"https://fhir.kbv.de/StructureDefinition/KBV_PR_MIO_CMR_Diagnostic_Report_U8_U9_Physical_Exam_Mouth_Nose|1.0.1">;
    id?: string;
}

export const CMRDiagnosticReportU8U9PhysicalExamMouthNoseMeta: t.Type<CMRDiagnosticReportU8U9PhysicalExamMouthNoseMeta> =
    t.recursion("CMRDiagnosticReportU8U9PhysicalExamMouthNoseMeta", () =>
        Excess(
            t.intersection([
                t.type({
                    profile: MinMaxArray(
...
export const CMRDiagnosticReportU8U9PhysicalExamMouthNoseCode: t.Type<CMRDiagnosticReportU8U9PhysicalExamMouthNoseCode> =
    t.recursion("CMRDiagnosticReportU8U9PhysicalExamMouthNoseCode", () =>
        Excess(
            t.intersection([
                t.type({
                    coding: MinMaxArray(
...
const CMRDiagnosticReportU8U9PhysicalExamMouthNose: t.Type<CMRDiagnosticReportU8U9PhysicalExamMouthNose> =
    t.recursion("CMRDiagnosticReportU8U9PhysicalExamMouthNose", () =>
        Excess(
            t.intersection([
                t.type({
