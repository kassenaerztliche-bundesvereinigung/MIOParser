...
export const CMRCompositionExtendedNewbornScreeningTypeCoding: t.Type<CMRCompositionExtendedNewbornScreeningTypeCoding> =
    t.recursion("CMRCompositionExtendedNewbornScreeningTypeCoding", () =>
        Excess(
            t.intersection([
                t.type({
...
export const CMRCompositionExtendedNewbornScreeningCategoryCoding: t.Type<CMRCompositionExtendedNewbornScreeningCategoryCoding> =
    t.recursion("CMRCompositionExtendedNewbornScreeningCategoryCoding", () =>
        Excess(
            t.intersection([
                t.type({
                    system: Literal("http://snomed.info/sct"),
...
export interface CMRCompositionExtendedNewbornScreeningMeta {
    profile: Array<"https://fhir.kbv.de/StructureDefinition/KBV_PR_MIO_CMR_Composition_Extended_Newborn_Screening|1.0.1">;
    id?: string;
}

export const CMRCompositionExtendedNewbornScreeningMeta: t.Type<CMRCompositionExtendedNewbornScreeningMeta> =
    t.recursion("CMRCompositionExtendedNewbornScreeningMeta", () =>
        Excess(
            t.intersection([
                t.type({
                    profile: MinMaxArray(
...
export const CMRCompositionExtendedNewbornScreeningType: t.Type<CMRCompositionExtendedNewbornScreeningType> =
    t.recursion("CMRCompositionExtendedNewbornScreeningType", () =>
        Excess(
            t.intersection([
                t.type({
                    coding: MinMaxArray(
...
export const CMRCompositionExtendedNewbornScreeningCategory: t.Type<CMRCompositionExtendedNewbornScreeningCategory> =
    t.recursion("CMRCompositionExtendedNewbornScreeningCategory", () =>
        Excess(
            t.intersection([
                t.type({
                    coding: MinMaxArray(
...
export const CMRCompositionExtendedNewbornScreeningSection: t.Type<CMRCompositionExtendedNewbornScreeningSection> =
    t.recursion("CMRCompositionExtendedNewbornScreeningSection", () =>
        Excess(
            t.intersection([
                t.type({
...
const CMRCompositionExtendedNewbornScreening: t.Type<CMRCompositionExtendedNewbornScreening> =
    t.recursion("CMRCompositionExtendedNewbornScreening", () =>
        Excess(
            t.intersection([
                t.type({
