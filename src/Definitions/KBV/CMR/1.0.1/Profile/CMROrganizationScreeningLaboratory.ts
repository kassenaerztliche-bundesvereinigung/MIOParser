...
export const CMROrganizationScreeningLaboratoryInstitutionskennzeichenTypeXXType: t.Type<CMROrganizationScreeningLaboratoryInstitutionskennzeichenTypeXXType> =
    t.recursion(
...
export const CMROrganizationScreeningLaboratoryBetriebsstaettennummerTypeBSNRType: t.Type<CMROrganizationScreeningLaboratoryBetriebsstaettennummerTypeBSNRType> =
    t.recursion(
...
export const CMROrganizationScreeningLaboratoryStrassenanschriftLineStrasse: t.Type<CMROrganizationScreeningLaboratoryStrassenanschriftLineStrasse> =
    t.recursion("CMROrganizationScreeningLaboratoryStrassenanschriftLineStrasse", () =>
        Excess(
            t.intersection([
                t.type({
                    url: Literal(
...
export const CMROrganizationScreeningLaboratoryStrassenanschriftLineHausnummer: t.Type<CMROrganizationScreeningLaboratoryStrassenanschriftLineHausnummer> =
    t.recursion("CMROrganizationScreeningLaboratoryStrassenanschriftLineHausnummer", () =>
        Excess(
            t.intersection([
                t.type({
                    url: Literal(
...
export const CMROrganizationScreeningLaboratoryStrassenanschriftLineAdresszusatz: t.Type<CMROrganizationScreeningLaboratoryStrassenanschriftLineAdresszusatz> =
    t.recursion(
...
export const CMROrganizationScreeningLaboratoryPostfachLinePostfach: t.Type<CMROrganizationScreeningLaboratoryPostfachLinePostfach> =
    t.recursion("CMROrganizationScreeningLaboratoryPostfachLinePostfach", () =>
        Excess(
            t.intersection([
                t.type({
                    url: Literal(
...
export const CMROrganizationScreeningLaboratoryStrassenanschriftStadtteil: t.Type<CMROrganizationScreeningLaboratoryStrassenanschriftStadtteil> =
    t.recursion("CMROrganizationScreeningLaboratoryStrassenanschriftStadtteil", () =>
        Excess(
            t.intersection([
                t.type({
                    url: Literal(
...
export const CMROrganizationScreeningLaboratoryInstitutionskennzeichenType: t.Type<CMROrganizationScreeningLaboratoryInstitutionskennzeichenType> =
    t.recursion("CMROrganizationScreeningLaboratoryInstitutionskennzeichenType", () =>
        Excess(
            t.intersection([
                t.type({
                    coding: MinArray(
...
export const CMROrganizationScreeningLaboratoryBetriebsstaettennummerType: t.Type<CMROrganizationScreeningLaboratoryBetriebsstaettennummerType> =
    t.recursion("CMROrganizationScreeningLaboratoryBetriebsstaettennummerType", () =>
        Excess(
            t.intersection([
                t.type({
                    coding: MinArray(
...
export const CMROrganizationScreeningLaboratoryStrassenanschriftLine: t.Type<CMROrganizationScreeningLaboratoryStrassenanschriftLine> =
    t.recursion("CMROrganizationScreeningLaboratoryStrassenanschriftLine", () =>
        Excess(
            t.partial({
                id: SCALARString,
                extension: ReqArray<
                    t.UnionC<
                        [
                            t.Type<Extension>,
                            t.Type<CMROrganizationScreeningLaboratoryStrassenanschriftLineStrasse>,
                            t.Type<CMROrganizationScreeningLaboratoryStrassenanschriftLineHausnummer>,
                            t.Type<CMROrganizationScreeningLaboratoryStrassenanschriftLineAdresszusatz>
                        ]
                    >,
                    t.Any
                >(
...
export const CMROrganizationScreeningLaboratoryStrassenanschriftPeriod: t.Type<CMROrganizationScreeningLaboratoryStrassenanschriftPeriod> =
    t.recursion("CMROrganizationScreeningLaboratoryStrassenanschriftPeriod", () =>
        Excess(
...
export const CMROrganizationScreeningLaboratoryPostfachLine: t.Type<CMROrganizationScreeningLaboratoryPostfachLine> =
    t.recursion("CMROrganizationScreeningLaboratoryPostfachLine", () =>
        Excess(
            t.partial({
                id: SCALARString,
                extension: ReqArray<
...
export const CMROrganizationScreeningLaboratoryPostfachPeriod: t.Type<CMROrganizationScreeningLaboratoryPostfachPeriod> =
    t.recursion("CMROrganizationScreeningLaboratoryPostfachPeriod", () =>
        Excess(
            t.partial({ id: SCALARString, start: SCALARDateTime, end: SCALARDateTime })
        )
    );
...
export const CMROrganizationScreeningLaboratoryInstitutionskennzeichen: t.Type<CMROrganizationScreeningLaboratoryInstitutionskennzeichen> =
    t.recursion("CMROrganizationScreeningLaboratoryInstitutionskennzeichen", () =>
        Excess(
            t.intersection([
                t.type({
                    type: CMROrganizationScreeningLaboratoryInstitutionskennzeichenType,
...
export const CMROrganizationScreeningLaboratoryBetriebsstaettennummer: t.Type<CMROrganizationScreeningLaboratoryBetriebsstaettennummer> =
    t.recursion("CMROrganizationScreeningLaboratoryBetriebsstaettennummer", () =>
        Excess(
            t.intersection([
                t.type({
                    type: CMROrganizationScreeningLaboratoryBetriebsstaettennummerType,
...
export const CMROrganizationScreeningLaboratoryStrassenanschrift: t.Type<CMROrganizationScreeningLaboratoryStrassenanschrift> =
    t.recursion("CMROrganizationScreeningLaboratoryStrassenanschrift", () =>
        Excess(
            t.intersection([
                t.type({
                    type: Literal("both")
                ...
                t.partial({
                    ...
                    extension: ReqArray<
                        t.UnionC<
                            [
                                t.Type<Extension>,
                                t.Type<CMROrganizationScreeningLaboratoryStrassenanschriftStadtteil>
                            ]
                        >,
                        t.Any
                    >(
...
export const CMROrganizationScreeningLaboratoryPostfach: t.Type<CMROrganizationScreeningLaboratoryPostfach> =
    t.recursion("CMROrganizationScreeningLaboratoryPostfach", () =>
        Excess(
            t.intersection([
                t.type({
                    type: Literal("postal")
...
export const CMROrganizationScreeningLaboratoryContactTelecom: t.Type<CMROrganizationScreeningLaboratoryContactTelecom> =
    t.recursion("CMROrganizationScreeningLaboratoryContactTelecom", () =>
        Excess(
            t.intersection([
                t.type({
                    system: ContactpointsystemVS,
...
export interface CMROrganizationScreeningLaboratoryMeta {
    profile: Array<"https://fhir.kbv.de/StructureDefinition/KBV_PR_MIO_CMR_Organization_Screening_Laboratory|1.0.1">;
    id?: string;
}

export const CMROrganizationScreeningLaboratoryMeta: t.Type<CMROrganizationScreeningLaboratoryMeta> =
    t.recursion("CMROrganizationScreeningLaboratoryMeta", () =>
        Excess(
            t.intersection([
                t.type({
                    profile: MinMaxArray(
                        ...
                        1,
                        Literal(
                            "https://fhir.kbv.de/StructureDefinition/KBV_PR_MIO_CMR_Organization_Screening_Laboratory|1.0.1"
                        )
                    )
                }),
                t.partial({
...
export const CMROrganizationScreeningLaboratoryContact: t.Type<CMROrganizationScreeningLaboratoryContact> =
    t.recursion("CMROrganizationScreeningLaboratoryContact", () =>
        Excess(
            t.partial({
                id: SCALARString,
                name: HumanName,
...
const CMROrganizationScreeningLaboratory: t.Type<CMROrganizationScreeningLaboratory> =
    t.recursion("CMROrganizationScreeningLaboratory", () =>
        Excess(
            t.intersection([
                t.type({
                    ...
                    address: ReqArray<
                        t.UnionC<
                            [
                                t.Type<CMROrganizationScreeningLaboratoryStrassenanschrift>,
                ...
                t.partial({
                    ...
                    identifier: ReqArray<
                        t.UnionC<
                            [
                                t.Type<CMROrganizationScreeningLaboratoryInstitutionskennzeichen>,
                                t.Type<CMROrganizationScreeningLaboratoryBetriebsstaettennummer>
                            ]
                        >,
                        t.Any
                    >(
