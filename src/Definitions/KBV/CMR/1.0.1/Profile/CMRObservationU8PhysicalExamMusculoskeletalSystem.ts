 ...
 */
export interface CMRObservationU8PhysicalExamMusculoskeletalSystemSubjectReference {
    reference: string;
    id?: string;
}

export const CMRObservationU8PhysicalExamMusculoskeletalSystemSubjectReference: t.Type<CMRObservationU8PhysicalExamMusculoskeletalSystemSubjectReference> =
    t.recursion("CMRObservationU8PhysicalExamMusculoskeletalSystemSubjectReference", () =>
        Excess(
            t.intersection([
                t.type({
 ...
 */
export interface CMRObservationU8PhysicalExamMusculoskeletalSystemEncounterReference {
    reference: string;
    id?: string;
}

export const CMRObservationU8PhysicalExamMusculoskeletalSystemEncounterReference: t.Type<CMRObservationU8PhysicalExamMusculoskeletalSystemEncounterReference> =
    t.recursion(
        "CMRObservationU8PhysicalExamMusculoskeletalSystemEncounterReference",
        () =>
            Excess(
                t.intersection([
                    t.type({
 ...
 */
export interface CMRObservationU8PhysicalExamMusculoskeletalSystemPerformerReference {
    reference: string;
    id?: string;
}

export const CMRObservationU8PhysicalExamMusculoskeletalSystemPerformerReference: t.Type<CMRObservationU8PhysicalExamMusculoskeletalSystemPerformerReference> =
    t.recursion(
        "CMRObservationU8PhysicalExamMusculoskeletalSystemPerformerReference",
        () =>
            Excess(
                t.intersection([
                    t.type({
...
interface CMRObservationU8PhysicalExamMusculoskeletalSystem {
    ...
    subject: CMRObservationU8PhysicalExamMusculoskeletalSystemSubjectReference;
    encounter: CMRObservationU8PhysicalExamMusculoskeletalSystemEncounterReference;
    effectiveDateTime: string;
    valueBoolean: true;
    id?: string;
    text?: Narrative;
    performer?: Array<CMRObservationU8PhysicalExamMusculoskeletalSystemPerformerReference>;
}
        ...
        Excess(
            t.intersection([
                t.type({
                    ...
                    code: CMRObservationU8PhysicalExamMusculoskeletalSystemCode,
                    subject:
                        CMRObservationU8PhysicalExamMusculoskeletalSystemSubjectReference,
                    encounter:
                        CMRObservationU8PhysicalExamMusculoskeletalSystemEncounterReference,
