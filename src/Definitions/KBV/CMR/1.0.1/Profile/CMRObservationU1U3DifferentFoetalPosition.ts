...
export const CMRObservationU1U3DifferentFoetalPositionCodeCodingDisplayAnzeigenameCodeSnomedContent: t.Type<CMRObservationU1U3DifferentFoetalPositionCodeCodingDisplayAnzeigenameCodeSnomedContent> =
    t.recursion(
...
export const CMRObservationU1U3DifferentFoetalPositionCodeCodingDisplayAnzeigenameCodeSnomed: t.Type<CMRObservationU1U3DifferentFoetalPositionCodeCodingDisplayAnzeigenameCodeSnomed> =
    t.recursion(
                    ...
                    t.partial({
                        ...
                        extension: ReqArray<
                            t.UnionC<
                                [
                                    t.Type<Extension>,
                                    t.Type<CMRObservationU1U3DifferentFoetalPositionCodeCodingDisplayAnzeigenameCodeSnomedContent>
                                ]
                            >,
                            t.Any
                        >(
...
export const CMRObservationU1U3DifferentFoetalPositionCodeCodingDisplay: t.Type<CMRObservationU1U3DifferentFoetalPositionCodeCodingDisplay> =
    t.recursion("CMRObservationU1U3DifferentFoetalPositionCodeCodingDisplay", () =>
        Excess(
            t.partial({
                id: SCALARString,
                extension: ReqArray<
                    t.UnionC<
                        [
                            t.Type<Extension>,
                            t.Type<CMRObservationU1U3DifferentFoetalPositionCodeCodingDisplayAnzeigenameCodeSnomed>
                        ]
                    >,
                    t.Any
                >(
...
export const CMRObservationU1U3DifferentFoetalPositionCodeCoding: t.Type<CMRObservationU1U3DifferentFoetalPositionCodeCoding> =
    t.recursion("CMRObservationU1U3DifferentFoetalPositionCodeCoding", () =>
        Excess(
            t.intersection([
                t.type({
...
export interface CMRObservationU1U3DifferentFoetalPositionMeta {
    profile: Array<"https://fhir.kbv.de/StructureDefinition/KBV_PR_MIO_CMR_Observation_U1_U3_Different_Foetal_Position|1.0.1">;
    id?: string;
}

export const CMRObservationU1U3DifferentFoetalPositionMeta: t.Type<CMRObservationU1U3DifferentFoetalPositionMeta> =
    t.recursion("CMRObservationU1U3DifferentFoetalPositionMeta", () =>
        Excess(
            t.intersection([
                t.type({
                    profile: MinMaxArray(
...
export const CMRObservationU1U3DifferentFoetalPositionCode: t.Type<CMRObservationU1U3DifferentFoetalPositionCode> =
    t.recursion("CMRObservationU1U3DifferentFoetalPositionCode", () =>
        Excess(
            t.intersection([
                t.type({
                    coding: MinMaxArray(
...
const CMRObservationU1U3DifferentFoetalPosition: t.Type<CMRObservationU1U3DifferentFoetalPosition> =
    t.recursion("CMRObservationU1U3DifferentFoetalPosition", () =>
        Excess(
            t.intersection([
                t.type({
