...
export const CMRDiagnosticReportU7U9PhysicalExamHeartBloodCirculationCodeCodingDisplayAnzeigenameCodeSnomedContent: t.Type<CMRDiagnosticReportU7U9PhysicalExamHeartBloodCirculationCodeCodingDisplayAnzeigenameCodeSnomedContent> = t.recursion(
...
export const CMRDiagnosticReportU7U9PhysicalExamHeartBloodCirculationCodeCodingDisplayAnzeigenameCodeSnomed: t.Type<CMRDiagnosticReportU7U9PhysicalExamHeartBloodCirculationCodeCodingDisplayAnzeigenameCodeSnomed> = t.recursion(
...
export const CMRDiagnosticReportU7U9PhysicalExamHeartBloodCirculationCodeCodingDisplay: t.Type<CMRDiagnosticReportU7U9PhysicalExamHeartBloodCirculationCodeCodingDisplay> = t.recursion(
...
export const CMRDiagnosticReportU7U9PhysicalExamHeartBloodCirculationCodeCoding: t.Type<CMRDiagnosticReportU7U9PhysicalExamHeartBloodCirculationCodeCoding> = t.recursion(
...
export const CMRDiagnosticReportU7U9PhysicalExamHeartBloodCirculationMeta: t.Type<CMRDiagnosticReportU7U9PhysicalExamHeartBloodCirculationMeta> = t.recursion(
...
export const CMRDiagnosticReportU7U9PhysicalExamHeartBloodCirculationCode: t.Type<CMRDiagnosticReportU7U9PhysicalExamHeartBloodCirculationCode> = t.recursion(
...
export const CMRDiagnosticReportU7U9PhysicalExamHeartBloodCirculationSubject: t.Type<CMRDiagnosticReportU7U9PhysicalExamHeartBloodCirculationSubject> = t.recursion(
...
export const CMRDiagnosticReportU7U9PhysicalExamHeartBloodCirculationEncounter: t.Type<CMRDiagnosticReportU7U9PhysicalExamHeartBloodCirculationEncounter> = t.recursion(
...
export const CMRDiagnosticReportU7U9PhysicalExamHeartBloodCirculationPerformer: t.Type<CMRDiagnosticReportU7U9PhysicalExamHeartBloodCirculationPerformer> = t.recursion(
...
export const CMRDiagnosticReportU7U9PhysicalExamHeartBloodCirculationResult: t.Type<CMRDiagnosticReportU7U9PhysicalExamHeartBloodCirculationResult> = t.recursion(
    ...
    () =>
        Excess(
            t.intersection([
                t.type({
                    reference: CustomReference(SCALARString, [
                        "https://fhir.kbv.de/StructureDefinition/KBV_PR_MIO_CMR_Observation_U7_U9_Physical_Exam_Heart_Blood_Circulation|1.0.0"
                    ])
                }),
                t.partial({
                    id: SCALARString
...
const CMRDiagnosticReportU7U9PhysicalExamHeartBloodCirculation: t.Type<CMRDiagnosticReportU7U9PhysicalExamHeartBloodCirculation> = t.recursion(
