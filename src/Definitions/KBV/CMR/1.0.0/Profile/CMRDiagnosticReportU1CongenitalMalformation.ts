...
export const CMRDiagnosticReportU1CongenitalMalformationCodeCodingDisplayAnzeigenameCodeSnomedContent: t.Type<CMRDiagnosticReportU1CongenitalMalformationCodeCodingDisplayAnzeigenameCodeSnomedContent> = t.recursion(
...
export const CMRDiagnosticReportU1CongenitalMalformationCodeCodingDisplayAnzeigenameCodeSnomed: t.Type<CMRDiagnosticReportU1CongenitalMalformationCodeCodingDisplayAnzeigenameCodeSnomed> = t.recursion(
...
export const CMRDiagnosticReportU1CongenitalMalformationCodeCodingDisplay: t.Type<CMRDiagnosticReportU1CongenitalMalformationCodeCodingDisplay> = t.recursion(
...
export const CMRDiagnosticReportU1CongenitalMalformationCodeCoding: t.Type<CMRDiagnosticReportU1CongenitalMalformationCodeCoding> = t.recursion(
...
export const CMRDiagnosticReportU1CongenitalMalformationMeta: t.Type<CMRDiagnosticReportU1CongenitalMalformationMeta> = t.recursion(
...
export const CMRDiagnosticReportU1CongenitalMalformationCode: t.Type<CMRDiagnosticReportU1CongenitalMalformationCode> = t.recursion(
...
export const CMRDiagnosticReportU1CongenitalMalformationSubject: t.Type<CMRDiagnosticReportU1CongenitalMalformationSubject> = t.recursion(
...
export const CMRDiagnosticReportU1CongenitalMalformationEncounter: t.Type<CMRDiagnosticReportU1CongenitalMalformationEncounter> = t.recursion(
...
export const CMRDiagnosticReportU1CongenitalMalformationPerformer: t.Type<CMRDiagnosticReportU1CongenitalMalformationPerformer> = t.recursion(
...
export const CMRDiagnosticReportU1CongenitalMalformationResult: t.Type<CMRDiagnosticReportU1CongenitalMalformationResult> = t.recursion(
    ...
    () =>
        Excess(
            t.intersection([
                t.type({
                    reference: CustomReference(SCALARString, [
                        "https://fhir.kbv.de/StructureDefinition/KBV_PR_MIO_CMR_Observation_U1_Congenital_Malformation|1.0.0"
                    ])
                }),
                t.partial({
                    id: SCALARString
...
const CMRDiagnosticReportU1CongenitalMalformation: t.Type<CMRDiagnosticReportU1CongenitalMalformation> = t.recursion(
