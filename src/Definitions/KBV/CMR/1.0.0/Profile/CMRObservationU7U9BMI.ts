...
export const CMRObservationU7U9BMICodeCodeSnomedDisplayAnzeigenameCodeSnomedContent: t.Type<CMRObservationU7U9BMICodeCodeSnomedDisplayAnzeigenameCodeSnomedContent> = t.recursion(
...
export const CMRObservationU7U9BMICodeCodeLoincDisplayAnzeigenameCodeLoincContent: t.Type<CMRObservationU7U9BMICodeCodeLoincDisplayAnzeigenameCodeLoincContent> = t.recursion(
...
export const CMRObservationU7U9BMICodeCodeSnomedDisplayAnzeigenameCodeSnomed: t.Type<CMRObservationU7U9BMICodeCodeSnomedDisplayAnzeigenameCodeSnomed> = t.recursion(
...
export const CMRObservationU7U9BMICodeCodeLoincDisplayAnzeigenameCodeLoinc: t.Type<CMRObservationU7U9BMICodeCodeLoincDisplayAnzeigenameCodeLoinc> = t.recursion(
...
export const CMRObservationU7U9BMICodeCodeSnomedDisplay: t.Type<CMRObservationU7U9BMICodeCodeSnomedDisplay> = t.recursion(
...
export const CMRObservationU7U9BMICodeCodeLoincDisplay: t.Type<CMRObservationU7U9BMICodeCodeLoincDisplay> = t.recursion(
...
export const CMRObservationU7U9BMICodeCodeSnomed: t.Type<CMRObservationU7U9BMICodeCodeSnomed> = t.recursion(
...
export const CMRObservationU7U9BMICodeCodeLoinc: t.Type<CMRObservationU7U9BMICodeCodeLoinc> = t.recursion(
...
export const CMRObservationU7U9BMIValueQuantity: t.Type<CMRObservationU7U9BMIValueQuantity> = t.recursion(
...
export const CMRObservationU7U9BMIMeta: t.Type<CMRObservationU7U9BMIMeta> = t.recursion(
    ...
    () =>
        Excess(
            t.intersection([
                t.type({
                    profile: MinMaxArray(1, 1, SCALARCanonical)
                }),
                t.partial({
                    id: SCALARString
                })
...
export const CMRObservationU7U9BMISubject: t.Type<CMRObservationU7U9BMISubject> = t.recursion(
...
export const CMRObservationU7U9BMIEncounter: t.Type<CMRObservationU7U9BMIEncounter> = t.recursion(
...
export const CMRObservationU7U9BMIPerformer: t.Type<CMRObservationU7U9BMIPerformer> = t.recursion(
