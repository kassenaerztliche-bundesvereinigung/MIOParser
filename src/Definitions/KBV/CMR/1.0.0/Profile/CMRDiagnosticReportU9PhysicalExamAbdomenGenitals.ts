...
export const CMRDiagnosticReportU9PhysicalExamAbdomenGenitalsCodeCodingDisplayAnzeigenameCodeSnomedContent: t.Type<CMRDiagnosticReportU9PhysicalExamAbdomenGenitalsCodeCodingDisplayAnzeigenameCodeSnomedContent> = t.recursion(
...
export const CMRDiagnosticReportU9PhysicalExamAbdomenGenitalsCodeCodingDisplayAnzeigenameCodeSnomed: t.Type<CMRDiagnosticReportU9PhysicalExamAbdomenGenitalsCodeCodingDisplayAnzeigenameCodeSnomed> = t.recursion(
...
export const CMRDiagnosticReportU9PhysicalExamAbdomenGenitalsCodeCodingDisplay: t.Type<CMRDiagnosticReportU9PhysicalExamAbdomenGenitalsCodeCodingDisplay> = t.recursion(
...
export const CMRDiagnosticReportU9PhysicalExamAbdomenGenitalsCodeCoding: t.Type<CMRDiagnosticReportU9PhysicalExamAbdomenGenitalsCodeCoding> = t.recursion(
...
export const CMRDiagnosticReportU9PhysicalExamAbdomenGenitalsMeta: t.Type<CMRDiagnosticReportU9PhysicalExamAbdomenGenitalsMeta> = t.recursion(
...
export const CMRDiagnosticReportU9PhysicalExamAbdomenGenitalsCode: t.Type<CMRDiagnosticReportU9PhysicalExamAbdomenGenitalsCode> = t.recursion(
...
export const CMRDiagnosticReportU9PhysicalExamAbdomenGenitalsSubject: t.Type<CMRDiagnosticReportU9PhysicalExamAbdomenGenitalsSubject> = t.recursion(
...
export const CMRDiagnosticReportU9PhysicalExamAbdomenGenitalsEncounter: t.Type<CMRDiagnosticReportU9PhysicalExamAbdomenGenitalsEncounter> = t.recursion(
...
export const CMRDiagnosticReportU9PhysicalExamAbdomenGenitalsPerformer: t.Type<CMRDiagnosticReportU9PhysicalExamAbdomenGenitalsPerformer> = t.recursion(
...
export const CMRDiagnosticReportU9PhysicalExamAbdomenGenitalsResult: t.Type<CMRDiagnosticReportU9PhysicalExamAbdomenGenitalsResult> = t.recursion(
    ...
    () =>
        Excess(
            t.intersection([
                t.type({
                    reference: CustomReference(SCALARString, [
                        "https://fhir.kbv.de/StructureDefinition/KBV_PR_MIO_CMR_Observation_U9_Physical_Exam_Abdomen_Genitals|1.0.0"
                    ])
                }),
                t.partial({
                    id: SCALARString
...
const CMRDiagnosticReportU9PhysicalExamAbdomenGenitals: t.Type<CMRDiagnosticReportU9PhysicalExamAbdomenGenitals> = t.recursion(
