...
export const CMRDiagnosticReportU2U3PhysicalExamEarsCodeCodingDisplayAnzeigenameCodeSnomedContent: t.Type<CMRDiagnosticReportU2U3PhysicalExamEarsCodeCodingDisplayAnzeigenameCodeSnomedContent> = t.recursion(
...
export const CMRDiagnosticReportU2U3PhysicalExamEarsCodeCodingDisplayAnzeigenameCodeSnomed: t.Type<CMRDiagnosticReportU2U3PhysicalExamEarsCodeCodingDisplayAnzeigenameCodeSnomed> = t.recursion(
...
export const CMRDiagnosticReportU2U3PhysicalExamEarsCodeCodingDisplay: t.Type<CMRDiagnosticReportU2U3PhysicalExamEarsCodeCodingDisplay> = t.recursion(
...
export const CMRDiagnosticReportU2U3PhysicalExamEarsCodeCoding: t.Type<CMRDiagnosticReportU2U3PhysicalExamEarsCodeCoding> = t.recursion(
...
export const CMRDiagnosticReportU2U3PhysicalExamEarsMeta: t.Type<CMRDiagnosticReportU2U3PhysicalExamEarsMeta> = t.recursion(
...
export const CMRDiagnosticReportU2U3PhysicalExamEarsCode: t.Type<CMRDiagnosticReportU2U3PhysicalExamEarsCode> = t.recursion(
...
export const CMRDiagnosticReportU2U3PhysicalExamEarsSubject: t.Type<CMRDiagnosticReportU2U3PhysicalExamEarsSubject> = t.recursion(
...
export const CMRDiagnosticReportU2U3PhysicalExamEarsEncounter: t.Type<CMRDiagnosticReportU2U3PhysicalExamEarsEncounter> = t.recursion(
...
export const CMRDiagnosticReportU2U3PhysicalExamEarsPerformer: t.Type<CMRDiagnosticReportU2U3PhysicalExamEarsPerformer> = t.recursion(
...
export const CMRDiagnosticReportU2U3PhysicalExamEarsResult: t.Type<CMRDiagnosticReportU2U3PhysicalExamEarsResult> = t.recursion(
    ...
    () =>
        Excess(
            t.intersection([
                t.type({
                    reference: CustomReference(SCALARString, [
                        "https://fhir.kbv.de/StructureDefinition/KBV_PR_MIO_CMR_Observation_U2_U3_Physical_Exam_Ears|1.0.0"
                    ])
                }),
                t.partial({
                    id: SCALARString
...
const CMRDiagnosticReportU2U3PhysicalExamEars: t.Type<CMRDiagnosticReportU2U3PhysicalExamEars> = t.recursion(
