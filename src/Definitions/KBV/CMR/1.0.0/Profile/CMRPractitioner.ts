...
import CMRPractitionerSpecialityVS from "../../../../../Definitions/KBV/CMR/1.0.0/ValueSet/CMRPractitionerSpeciality";
...
export const CMRPractitionerQualificationCodeCodingDisplayAnzeigenameQualifikationContent: t.Type<CMRPractitionerQualificationCodeCodingDisplayAnzeigenameQualifikationContent> = t.recursion(
...
export const CMRPractitionerQualificationCodeCodingDisplayAnzeigenameQualifikation: t.Type<CMRPractitionerQualificationCodeCodingDisplayAnzeigenameQualifikation> = t.recursion(
 ...
 */
export interface CMRPractitionerANRTypeLANRType {
...
export const CMRPractitionerANRTypeLANRType: t.Type<CMRPractitionerANRTypeLANRType> = t.recursion(
 ...
 * A reference to a code defined by a terminology system.
 */
export interface CMRPractitionerEFNTypeDNType {
    system: "http://terminology.hl7.org/CodeSystem/v2-0203";
    code: "DN";
    id?: string;
    version?: string;
...
export const CMRPractitionerEFNTypeDNType: t.Type<CMRPractitionerEFNTypeDNType> = t.recursion(
 ...
 * A reference to a code defined by a terminology system.
 */
export interface CMRPractitionerHebammenIKTypeXXType {
    system: "http://terminology.hl7.org/CodeSystem/v2-0203";
    code: "XX";
    id?: string;
    version?: string;
...
export const CMRPractitionerHebammenIKTypeXXType: t.Type<CMRPractitionerHebammenIKTypeXXType> = t.recursion(
...
export const CMRPractitionerNameFamilyNamenszusatz: t.Type<CMRPractitionerNameFamilyNamenszusatz> = t.recursion(
...
export const CMRPractitionerNameFamilyNachname: t.Type<CMRPractitionerNameFamilyNachname> = t.recursion(
...
export const CMRPractitionerNameFamilyVorsatzwort: t.Type<CMRPractitionerNameFamilyVorsatzwort> = t.recursion(
...
export const CMRPractitionerNamePrefixPrefixqualifier: t.Type<CMRPractitionerNamePrefixPrefixqualifier> = t.recursion(
...
export const CMRPractitionerStrassenanschriftLineStrasse: t.Type<CMRPractitionerStrassenanschriftLineStrasse> = t.recursion(
...
export const CMRPractitionerStrassenanschriftLineHausnummer: t.Type<CMRPractitionerStrassenanschriftLineHausnummer> = t.recursion(
...
export const CMRPractitionerStrassenanschriftLineAdresszusatz: t.Type<CMRPractitionerStrassenanschriftLineAdresszusatz> = t.recursion(
...
export const CMRPractitionerPostfachLinePostfach: t.Type<CMRPractitionerPostfachLinePostfach> = t.recursion(
...
export const CMRPractitionerANRAssignerIdentifier: t.Type<CMRPractitionerANRAssignerIdentifier> = t.recursion(
...
export const CMRPractitionerEFNAssignerIdentifier: t.Type<CMRPractitionerEFNAssignerIdentifier> = t.recursion(
...
export const CMRPractitionerStrassenanschriftStadtteil: t.Type<CMRPractitionerStrassenanschriftStadtteil> = t.recursion(
...
export const CMRPractitionerPostfachStadtteil: t.Type<CMRPractitionerPostfachStadtteil> = t.recursion(
...
export const CMRPractitionerQualificationCodeCodingDisplay: t.Type<CMRPractitionerQualificationCodeCodingDisplay> = t.recursion(
...
export interface CMRPractitionerANRType {
    coding: Array<CMRPractitionerANRTypeLANRType>;
    id?: string;
    text?: string;
}
...
export const CMRPractitionerANRType: t.Type<CMRPractitionerANRType> = t.recursion(
    ...
    () =>
        Excess(
            t.intersection([
                t.type({
                    coding: MinArray(1, CMRPractitionerANRTypeLANRType)
                }),
                t.partial({
                    id: SCALARString,
                    text: SCALARString
...
export interface CMRPractitionerEFNType {
    coding: Array<CMRPractitionerEFNTypeDNType>;
    id?: string;
    text?: string;
}
...
export const CMRPractitionerEFNType: t.Type<CMRPractitionerEFNType> = t.recursion(
    ...
    () =>
        Excess(
            t.intersection([
                t.type({
                    coding: MinArray(1, CMRPractitionerEFNTypeDNType)
                }),
                t.partial({
                    id: SCALARString,
                    text: SCALARString
...
export interface CMRPractitionerHebammenIKType {
    coding: Array<CMRPractitionerHebammenIKTypeXXType>;
    id?: string;
    text?: string;
}

export const CMRPractitionerHebammenIKType: t.Type<CMRPractitionerHebammenIKType> = t.recursion(
    "CMRPractitionerHebammenIKType",
    () =>
        Excess(
            t.intersection([
                t.type({
                    coding: MinArray(1, CMRPractitionerHebammenIKTypeXXType)
                }),
                t.partial({
                    id: SCALARString,
                    text: SCALARString
...
export const CMRPractitionerHebammenIKAssigner: t.Type<CMRPractitionerHebammenIKAssigner> = t.recursion(
...
export const CMRPractitionerStrassenanschriftLine: t.Type<CMRPractitionerStrassenanschriftLine> = t.recursion(
...
export const CMRPractitionerPostfachLine: t.Type<CMRPractitionerPostfachLine> = t.recursion(
...
export const CMRPractitionerPostfachPeriod: t.Type<CMRPractitionerPostfachPeriod> = t.recursion(
...
export const CMRPractitionerQualificationCodeCoding: t.Type<CMRPractitionerQualificationCodeCoding> = t.recursion(
...
export const CMRPractitionerErgaenzendeAngaben: t.Type<CMRPractitionerErgaenzendeAngaben> = t.recursion(
...
export const CMRPractitionerStrassenanschrift: t.Type<CMRPractitionerStrassenanschrift> = t.recursion(
...
export const CMRPractitionerQualificationCode: t.Type<CMRPractitionerQualificationCode> = t.recursion(
...
export const CMRPractitionerQualification: t.Type<CMRPractitionerQualification> = t.recursion(
