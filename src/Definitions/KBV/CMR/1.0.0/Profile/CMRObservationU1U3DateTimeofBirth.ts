...
export const CMRObservationU1U3DateTimeofBirthCodeCodingDisplayAnzeigenameCodeSnomedContent: t.Type<CMRObservationU1U3DateTimeofBirthCodeCodingDisplayAnzeigenameCodeSnomedContent> = t.recursion(
...
export const CMRObservationU1U3DateTimeofBirthCodeCodingDisplayAnzeigenameCodeSnomed: t.Type<CMRObservationU1U3DateTimeofBirthCodeCodingDisplayAnzeigenameCodeSnomed> = t.recursion(
...
export const CMRObservationU1U3DateTimeofBirthCodeCodingDisplay: t.Type<CMRObservationU1U3DateTimeofBirthCodeCodingDisplay> = t.recursion(
...
export const CMRObservationU1U3DateTimeofBirthCodeCoding: t.Type<CMRObservationU1U3DateTimeofBirthCodeCoding> = t.recursion(
...
export const CMRObservationU1U3DateTimeofBirthMeta: t.Type<CMRObservationU1U3DateTimeofBirthMeta> = t.recursion(
...
export const CMRObservationU1U3DateTimeofBirthCode: t.Type<CMRObservationU1U3DateTimeofBirthCode> = t.recursion(
 ...
 */
export interface CMRObservationU1U3DateTimeofBirthSubject {
    reference: string;
    id?: string;
}

export const CMRObservationU1U3DateTimeofBirthSubject: t.Type<CMRObservationU1U3DateTimeofBirthSubject> = t.recursion(
 ...
 */
export interface CMRObservationU1U3DateTimeofBirthEncounter {
    reference: string;
    id?: string;
}

export const CMRObservationU1U3DateTimeofBirthEncounter: t.Type<CMRObservationU1U3DateTimeofBirthEncounter> = t.recursion(
 ...
 */
export interface CMRObservationU1U3DateTimeofBirthPerformer {
    reference: string;
    id?: string;
}

export const CMRObservationU1U3DateTimeofBirthPerformer: t.Type<CMRObservationU1U3DateTimeofBirthPerformer> = t.recursion(
...
interface CMRObservationU1U3DateTimeofBirth {
    ...
    subject: CMRObservationU1U3DateTimeofBirthSubject;
    encounter: CMRObservationU1U3DateTimeofBirthEncounter;
    effectiveDateTime: string;
    valueDateTime: string;
    id?: string;
    text?: Narrative;
    performer?: Array<CMRObservationU1U3DateTimeofBirthPerformer>;
}

const CMRObservationU1U3DateTimeofBirth: t.Type<CMRObservationU1U3DateTimeofBirth> = t.recursion(
        ...
        Excess(
            t.intersection([
                ...
                t.partial({
                    id: SCALARString,
                    text: Narrative,
                    performer: MaxArray(1, CMRObservationU1U3DateTimeofBirthPerformer)
                })
            ])
        )
);
