...
export const CMRDiagnosticReportU2U6PhysicalExamHeartBloodCirculationCodeCodingDisplayAnzeigenameCodeSnomedContent: t.Type<CMRDiagnosticReportU2U6PhysicalExamHeartBloodCirculationCodeCodingDisplayAnzeigenameCodeSnomedContent> = t.recursion(
...
export const CMRDiagnosticReportU2U6PhysicalExamHeartBloodCirculationCodeCodingDisplayAnzeigenameCodeSnomed: t.Type<CMRDiagnosticReportU2U6PhysicalExamHeartBloodCirculationCodeCodingDisplayAnzeigenameCodeSnomed> = t.recursion(
...
export const CMRDiagnosticReportU2U6PhysicalExamHeartBloodCirculationCodeCodingDisplay: t.Type<CMRDiagnosticReportU2U6PhysicalExamHeartBloodCirculationCodeCodingDisplay> = t.recursion(
...
export const CMRDiagnosticReportU2U6PhysicalExamHeartBloodCirculationCodeCoding: t.Type<CMRDiagnosticReportU2U6PhysicalExamHeartBloodCirculationCodeCoding> = t.recursion(
...
export const CMRDiagnosticReportU2U6PhysicalExamHeartBloodCirculationMeta: t.Type<CMRDiagnosticReportU2U6PhysicalExamHeartBloodCirculationMeta> = t.recursion(
...
export const CMRDiagnosticReportU2U6PhysicalExamHeartBloodCirculationCode: t.Type<CMRDiagnosticReportU2U6PhysicalExamHeartBloodCirculationCode> = t.recursion(
...
export const CMRDiagnosticReportU2U6PhysicalExamHeartBloodCirculationSubject: t.Type<CMRDiagnosticReportU2U6PhysicalExamHeartBloodCirculationSubject> = t.recursion(
...
export const CMRDiagnosticReportU2U6PhysicalExamHeartBloodCirculationEncounter: t.Type<CMRDiagnosticReportU2U6PhysicalExamHeartBloodCirculationEncounter> = t.recursion(
...
export const CMRDiagnosticReportU2U6PhysicalExamHeartBloodCirculationPerformer: t.Type<CMRDiagnosticReportU2U6PhysicalExamHeartBloodCirculationPerformer> = t.recursion(
...
export const CMRDiagnosticReportU2U6PhysicalExamHeartBloodCirculationResult: t.Type<CMRDiagnosticReportU2U6PhysicalExamHeartBloodCirculationResult> = t.recursion(
    ...
    () =>
        Excess(
            t.intersection([
                t.type({
                    reference: CustomReference(SCALARString, [
                        "https://fhir.kbv.de/StructureDefinition/KBV_PR_MIO_CMR_Observation_U2_U6_Physical_Exam_Heart_Blood_Circulation|1.0.0"
                    ])
                }),
                t.partial({
                    id: SCALARString
...
const CMRDiagnosticReportU2U6PhysicalExamHeartBloodCirculation: t.Type<CMRDiagnosticReportU2U6PhysicalExamHeartBloodCirculation> = t.recursion(
