...
export const CMRDiagnosticReportU8PhysicalExamEarsCodeCodingDisplayAnzeigenameCodeSnomedContent: t.Type<CMRDiagnosticReportU8PhysicalExamEarsCodeCodingDisplayAnzeigenameCodeSnomedContent> = t.recursion(
...
export const CMRDiagnosticReportU8PhysicalExamEarsCodeCodingDisplayAnzeigenameCodeSnomed: t.Type<CMRDiagnosticReportU8PhysicalExamEarsCodeCodingDisplayAnzeigenameCodeSnomed> = t.recursion(
...
export const CMRDiagnosticReportU8PhysicalExamEarsCodeCodingDisplay: t.Type<CMRDiagnosticReportU8PhysicalExamEarsCodeCodingDisplay> = t.recursion(
...
export const CMRDiagnosticReportU8PhysicalExamEarsCodeCoding: t.Type<CMRDiagnosticReportU8PhysicalExamEarsCodeCoding> = t.recursion(
...
export const CMRDiagnosticReportU8PhysicalExamEarsMeta: t.Type<CMRDiagnosticReportU8PhysicalExamEarsMeta> = t.recursion(
...
export const CMRDiagnosticReportU8PhysicalExamEarsCode: t.Type<CMRDiagnosticReportU8PhysicalExamEarsCode> = t.recursion(
...
export const CMRDiagnosticReportU8PhysicalExamEarsSubject: t.Type<CMRDiagnosticReportU8PhysicalExamEarsSubject> = t.recursion(
...
export const CMRDiagnosticReportU8PhysicalExamEarsEncounter: t.Type<CMRDiagnosticReportU8PhysicalExamEarsEncounter> = t.recursion(
...
export const CMRDiagnosticReportU8PhysicalExamEarsPerformer: t.Type<CMRDiagnosticReportU8PhysicalExamEarsPerformer> = t.recursion(
...
export const CMRDiagnosticReportU8PhysicalExamEarsResult: t.Type<CMRDiagnosticReportU8PhysicalExamEarsResult> = t.recursion(
    ...
    () =>
        Excess(
            t.intersection([
                t.type({
                    reference: CustomReference(SCALARString, [
                        "https://fhir.kbv.de/StructureDefinition/KBV_PR_MIO_CMR_Observation_U8_Physical_Exam_Ears|1.0.0"
                    ])
                }),
                t.partial({
                    id: SCALARString
...
const CMRDiagnosticReportU8PhysicalExamEars: t.Type<CMRDiagnosticReportU8PhysicalExamEars> = t.recursion(
