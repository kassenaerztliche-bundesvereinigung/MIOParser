...
export const CMRDiagnosticReportU5U6PhysicalExamHeadCodeCodingDisplayAnzeigenameCodeSnomedContent: t.Type<CMRDiagnosticReportU5U6PhysicalExamHeadCodeCodingDisplayAnzeigenameCodeSnomedContent> = t.recursion(
...
export const CMRDiagnosticReportU5U6PhysicalExamHeadCodeCodingDisplayAnzeigenameCodeSnomed: t.Type<CMRDiagnosticReportU5U6PhysicalExamHeadCodeCodingDisplayAnzeigenameCodeSnomed> = t.recursion(
...
export const CMRDiagnosticReportU5U6PhysicalExamHeadCodeCodingDisplay: t.Type<CMRDiagnosticReportU5U6PhysicalExamHeadCodeCodingDisplay> = t.recursion(
...
export const CMRDiagnosticReportU5U6PhysicalExamHeadCodeCoding: t.Type<CMRDiagnosticReportU5U6PhysicalExamHeadCodeCoding> = t.recursion(
...
export const CMRDiagnosticReportU5U6PhysicalExamHeadMeta: t.Type<CMRDiagnosticReportU5U6PhysicalExamHeadMeta> = t.recursion(
...
export const CMRDiagnosticReportU5U6PhysicalExamHeadCode: t.Type<CMRDiagnosticReportU5U6PhysicalExamHeadCode> = t.recursion(
 ...
 */
export interface CMRDiagnosticReportU5U6PhysicalExamHeadSubject {
    reference: string;
    id?: string;
}

export const CMRDiagnosticReportU5U6PhysicalExamHeadSubject: t.Type<CMRDiagnosticReportU5U6PhysicalExamHeadSubject> = t.recursion(
 ...
 */
export interface CMRDiagnosticReportU5U6PhysicalExamHeadEncounter {
    reference: string;
    id?: string;
}

export const CMRDiagnosticReportU5U6PhysicalExamHeadEncounter: t.Type<CMRDiagnosticReportU5U6PhysicalExamHeadEncounter> = t.recursion(
 ...
 */
export interface CMRDiagnosticReportU5U6PhysicalExamHeadPerformer {
    reference: string;
    id?: string;
}

export const CMRDiagnosticReportU5U6PhysicalExamHeadPerformer: t.Type<CMRDiagnosticReportU5U6PhysicalExamHeadPerformer> = t.recursion(
 ...
 */
export interface CMRDiagnosticReportU5U6PhysicalExamHeadResult {
    reference: string;
    id?: string;
}

export const CMRDiagnosticReportU5U6PhysicalExamHeadResult: t.Type<CMRDiagnosticReportU5U6PhysicalExamHeadResult> = t.recursion(
...
interface CMRDiagnosticReportU5U6PhysicalExamHead {
    ...
    subject: CMRDiagnosticReportU5U6PhysicalExamHeadSubject;
    encounter: CMRDiagnosticReportU5U6PhysicalExamHeadEncounter;
    effectiveDateTime: string;
    id?: string;
    text?: Narrative;
    performer?: Array<CMRDiagnosticReportU5U6PhysicalExamHeadPerformer>;
    result?: CMRDiagnosticReportU5U6PhysicalExamHeadResult[];
}

const CMRDiagnosticReportU5U6PhysicalExamHead: t.Type<CMRDiagnosticReportU5U6PhysicalExamHead> = t.recursion(
        ...
        Excess(
            t.intersection([
                ...
                t.partial({
                    ...
                    result: t.array(CMRDiagnosticReportU5U6PhysicalExamHeadResult)
                })
            ])
        )
);
