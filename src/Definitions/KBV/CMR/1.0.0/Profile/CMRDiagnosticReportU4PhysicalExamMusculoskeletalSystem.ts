...
export const CMRDiagnosticReportU4PhysicalExamMusculoskeletalSystemCodeCodingDisplayAnzeigenameCodeSnomedContent: t.Type<CMRDiagnosticReportU4PhysicalExamMusculoskeletalSystemCodeCodingDisplayAnzeigenameCodeSnomedContent> = t.recursion(
...
export const CMRDiagnosticReportU4PhysicalExamMusculoskeletalSystemCodeCodingDisplayAnzeigenameCodeSnomed: t.Type<CMRDiagnosticReportU4PhysicalExamMusculoskeletalSystemCodeCodingDisplayAnzeigenameCodeSnomed> = t.recursion(
...
export const CMRDiagnosticReportU4PhysicalExamMusculoskeletalSystemCodeCodingDisplay: t.Type<CMRDiagnosticReportU4PhysicalExamMusculoskeletalSystemCodeCodingDisplay> = t.recursion(
...
export const CMRDiagnosticReportU4PhysicalExamMusculoskeletalSystemCodeCoding: t.Type<CMRDiagnosticReportU4PhysicalExamMusculoskeletalSystemCodeCoding> = t.recursion(
...
export const CMRDiagnosticReportU4PhysicalExamMusculoskeletalSystemMeta: t.Type<CMRDiagnosticReportU4PhysicalExamMusculoskeletalSystemMeta> = t.recursion(
...
export const CMRDiagnosticReportU4PhysicalExamMusculoskeletalSystemCode: t.Type<CMRDiagnosticReportU4PhysicalExamMusculoskeletalSystemCode> = t.recursion(
...
export const CMRDiagnosticReportU4PhysicalExamMusculoskeletalSystemSubject: t.Type<CMRDiagnosticReportU4PhysicalExamMusculoskeletalSystemSubject> = t.recursion(
...
export const CMRDiagnosticReportU4PhysicalExamMusculoskeletalSystemEncounter: t.Type<CMRDiagnosticReportU4PhysicalExamMusculoskeletalSystemEncounter> = t.recursion(
...
export const CMRDiagnosticReportU4PhysicalExamMusculoskeletalSystemPerformer: t.Type<CMRDiagnosticReportU4PhysicalExamMusculoskeletalSystemPerformer> = t.recursion(
...
export const CMRDiagnosticReportU4PhysicalExamMusculoskeletalSystemResult: t.Type<CMRDiagnosticReportU4PhysicalExamMusculoskeletalSystemResult> = t.recursion(
    ...
    () =>
        Excess(
            t.intersection([
                t.type({
                    reference: CustomReference(SCALARString, [
                        "https://fhir.kbv.de/StructureDefinition/KBV_PR_MIO_CMR_Observation_U4_Physical_Exam_Musculoskeletal_System|1.0.0"
                    ])
                }),
                t.partial({
                    id: SCALARString
...
const CMRDiagnosticReportU4PhysicalExamMusculoskeletalSystem: t.Type<CMRDiagnosticReportU4PhysicalExamMusculoskeletalSystem> = t.recursion(
