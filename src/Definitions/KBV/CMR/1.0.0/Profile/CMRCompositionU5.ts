...
export const CMRCompositionU5ErgebnisseSectionCodeCoding: t.Type<CMRCompositionU5ErgebnisseSectionCodeCoding> = t.recursion(
...
export const CMRCompositionU5HoerscreeningCodeCodeSnomed: t.Type<CMRCompositionU5HoerscreeningCodeCodeSnomed> = t.recursion(
...
export const CMRCompositionU5HoerscreeningCodeCodeLoinc: t.Type<CMRCompositionU5HoerscreeningCodeCodeLoinc> = t.recursion(
...
export const CMRCompositionU5AktuelleAnamneseDesKindesAnamneseAnweisung: t.Type<CMRCompositionU5AktuelleAnamneseDesKindesAnamneseAnweisung> = t.recursion(
...
export const CMRCompositionU5AktuelleAnamneseDesKindesCodeCoding: t.Type<CMRCompositionU5AktuelleAnamneseDesKindesCodeCoding> = t.recursion(
...
export const CMRCompositionU5AktuelleAnamneseDesKindesEmptyReasonCoding: t.Type<CMRCompositionU5AktuelleAnamneseDesKindesEmptyReasonCoding> = t.recursion(
...
export const CMRCompositionU5SozialanamneseAnamneseAnweisung: t.Type<CMRCompositionU5SozialanamneseAnamneseAnweisung> = t.recursion(
...
export const CMRCompositionU5SozialanamneseCodeCoding: t.Type<CMRCompositionU5SozialanamneseCodeCoding> = t.recursion(
...
export const CMRCompositionU5SozialanamneseEmptyReasonCoding: t.Type<CMRCompositionU5SozialanamneseEmptyReasonCoding> = t.recursion(
...
export const CMRCompositionU5UntersuchungUntersuchungAnweisung: t.Type<CMRCompositionU5UntersuchungUntersuchungAnweisung> = t.recursion(
...
export const CMRCompositionU5UntersuchungCodeCoding: t.Type<CMRCompositionU5UntersuchungCodeCoding> = t.recursion(
...
export const CMRCompositionU5UntersuchungEmptyReasonCoding: t.Type<CMRCompositionU5UntersuchungEmptyReasonCoding> = t.recursion(
...
export const CMRCompositionU5BeratungBeratungAnweisung: t.Type<CMRCompositionU5BeratungBeratungAnweisung> = t.recursion(
...
export const CMRCompositionU5BeratungBeratungHinweis: t.Type<CMRCompositionU5BeratungBeratungHinweis> = t.recursion(
...
export const CMRCompositionU5BeratungCodeCoding: t.Type<CMRCompositionU5BeratungCodeCoding> = t.recursion(
...
export const CMRCompositionU5BeratungEmptyReasonCoding: t.Type<CMRCompositionU5BeratungEmptyReasonCoding> = t.recursion(
 ...
 * Mit diesem Profil ist eine zusätzlicher Kommentar/Information definiert worden. Dieser kann an diverse Ressourcen hinzugefügt werden. Der Informationsgehalt der beinhaltenden Ressource darf nicht grundlegend verändert oder negiert werden.
 */
export interface CMRCompositionU5ErgebnissePruefungAufklaerungHinweis {
    url: "https://fhir.kbv.de/StructureDefinition/KBV_EX_MIO_CMR_Note";
    valueString: "- Neugeborenen-Hörscreening";
    id?: string;
}

export const CMRCompositionU5ErgebnissePruefungAufklaerungHinweis: t.Type<CMRCompositionU5ErgebnissePruefungAufklaerungHinweis> = t.recursion(
...
export const CMRCompositionU5ErgebnisseCodeCoding: t.Type<CMRCompositionU5ErgebnisseCodeCoding> = t.recursion(
...
export const CMRCompositionU5ErgebnisseEmptyReasonCoding: t.Type<CMRCompositionU5ErgebnisseEmptyReasonCoding> = t.recursion(
...
export const CMRCompositionU5ErgebnisseSectionCode: t.Type<CMRCompositionU5ErgebnisseSectionCode> = t.recursion(
 ...
 */
export interface CMRCompositionU5ErgebnisseSectionEntry {
    reference: string;
    id?: string;
}

export const CMRCompositionU5ErgebnisseSectionEntry: t.Type<CMRCompositionU5ErgebnisseSectionEntry> = t.recursion(
...
export const CMRCompositionU5HoerscreeningEmptyReasonCoding: t.Type<CMRCompositionU5HoerscreeningEmptyReasonCoding> = t.recursion(
...
export const CMRCompositionU5OrientierendeBeurteilungDerEntwicklungBeurteilungAnweisung: t.Type<CMRCompositionU5OrientierendeBeurteilungDerEntwicklungBeurteilungAnweisung> = t.recursion(
...
export interface CMRCompositionU5OrientierendeBeurteilungDerEntwicklungBeurteilungHinweis {
    url: "https://fhir.kbv.de/StructureDefinition/KBV_EX_MIO_CMR_Note";
    valueString: "Beobachtung der Interaktion: Insbersondere die folgenden Reaktionen des Kindes können der Ärztin oder dem Arzt als Hinweis zur Einschätzung von Stimmung, Kommunikations- Regulationsmöglichkeiten des Kindes im Kontak mit seiner primären Bezugsperson und als weitere Grundlage für das Ärztin oder Arzt-Elterngespräch dienen:";
    id?: string;
}

export const CMRCompositionU5OrientierendeBeurteilungDerEntwicklungBeurteilungHinweis: t.Type<CMRCompositionU5OrientierendeBeurteilungDerEntwicklungBeurteilungHinweis> = t.recursion(
        ...
        Excess(
            t.intersection([
                t.type({
                    ...
                    valueString: Literal(
                        "Beobachtung der Interaktion: Insbersondere die folgenden Reaktionen des Kindes können der Ärztin oder dem Arzt als Hinweis zur Einschätzung von Stimmung, Kommunikations- Regulationsmöglichkeiten des Kindes im Kontak mit seiner primären Bezugsperson und als weitere Grundlage für das Ärztin oder Arzt-Elterngespräch dienen:"
                    )
                }),
                t.partial({
                    id: SCALARString
...
export const CMRCompositionU5OrientierendeBeurteilungDerEntwicklungCodeCoding: t.Type<CMRCompositionU5OrientierendeBeurteilungDerEntwicklungCodeCoding> = t.recursion(
...
export const CMRCompositionU5OrientierendeBeurteilungDerEntwicklungEmptyReasonCoding: t.Type<CMRCompositionU5OrientierendeBeurteilungDerEntwicklungEmptyReasonCoding> = t.recursion(
...
export const CMRCompositionU5PerzentilkurvenCodeCoding: t.Type<CMRCompositionU5PerzentilkurvenCodeCoding> = t.recursion(
...
export const CMRCompositionU5PerzentilkurvenEmptyReasonCoding: t.Type<CMRCompositionU5PerzentilkurvenEmptyReasonCoding> = t.recursion(
...
export const CMRCompositionU5AktuelleAnamneseDesKindesCode: t.Type<CMRCompositionU5AktuelleAnamneseDesKindesCode> = t.recursion(
...
export const CMRCompositionU5AktuelleAnamneseDesKindesText: t.Type<CMRCompositionU5AktuelleAnamneseDesKindesText> = t.recursion(
 ...
 * A reference to the actual resource from which the narrative in the section is derived.
 */
export interface CMRCompositionU5AktuelleAnamneseDesKindesEntry {
    reference: string;
    id?: string;
}

export const CMRCompositionU5AktuelleAnamneseDesKindesEntry: t.Type<CMRCompositionU5AktuelleAnamneseDesKindesEntry> = t.recursion(
...
export const CMRCompositionU5AktuelleAnamneseDesKindesEmptyReason: t.Type<CMRCompositionU5AktuelleAnamneseDesKindesEmptyReason> = t.recursion(
...
export const CMRCompositionU5SozialanamneseCode: t.Type<CMRCompositionU5SozialanamneseCode> = t.recursion(
...
export const CMRCompositionU5SozialanamneseText: t.Type<CMRCompositionU5SozialanamneseText> = t.recursion(
 ...
 * A reference to the actual resource from which the narrative in the section is derived.
 */
export interface CMRCompositionU5SozialanamneseEntry {
    reference: string;
    id?: string;
}

export const CMRCompositionU5SozialanamneseEntry: t.Type<CMRCompositionU5SozialanamneseEntry> = t.recursion(
...
export const CMRCompositionU5SozialanamneseEmptyReason: t.Type<CMRCompositionU5SozialanamneseEmptyReason> = t.recursion(
...
export const CMRCompositionU5UntersuchungCode: t.Type<CMRCompositionU5UntersuchungCode> = t.recursion(
...
export const CMRCompositionU5UntersuchungText: t.Type<CMRCompositionU5UntersuchungText> = t.recursion(
 ...
 * A reference to the actual resource from which the narrative in the section is derived.
 */
export interface CMRCompositionU5UntersuchungEntry {
    reference: string;
    id?: string;
}

export const CMRCompositionU5UntersuchungEntry: t.Type<CMRCompositionU5UntersuchungEntry> = t.recursion(
...
export const CMRCompositionU5UntersuchungEmptyReason: t.Type<CMRCompositionU5UntersuchungEmptyReason> = t.recursion(
...
export const CMRCompositionU5BeratungCode: t.Type<CMRCompositionU5BeratungCode> = t.recursion(
...
export const CMRCompositionU5BeratungText: t.Type<CMRCompositionU5BeratungText> = t.recursion(
 ...
 * A reference to the actual resource from which the narrative in the section is derived.
 */
export interface CMRCompositionU5BeratungEntry {
    reference: string;
    id?: string;
}

export const CMRCompositionU5BeratungEntry: t.Type<CMRCompositionU5BeratungEntry> = t.recursion(
...
export const CMRCompositionU5BeratungEmptyReason: t.Type<CMRCompositionU5BeratungEmptyReason> = t.recursion(
...
export const CMRCompositionU5ErgebnisseCode: t.Type<CMRCompositionU5ErgebnisseCode> = t.recursion(
...
export const CMRCompositionU5ErgebnisseText: t.Type<CMRCompositionU5ErgebnisseText> = t.recursion(
 ...
 * A reference to the actual resource from which the narrative in the section is derived.
 */
export interface CMRCompositionU5ErgebnisseEntry {
    reference: string;
    id?: string;
}

export const CMRCompositionU5ErgebnisseEntry: t.Type<CMRCompositionU5ErgebnisseEntry> = t.recursion(
...
export const CMRCompositionU5ErgebnisseEmptyReason: t.Type<CMRCompositionU5ErgebnisseEmptyReason> = t.recursion(
...
export interface CMRCompositionU5ErgebnisseSection {
    ...
    id?: string;
    entry?: Array<CMRCompositionU5ErgebnisseSectionEntry>;
}

export const CMRCompositionU5ErgebnisseSection: t.Type<CMRCompositionU5ErgebnisseSection> = t.recursion(
    ...
    () =>
        Excess(
            t.intersection([
                ...
                t.partial({
                    id: SCALARString,
                    entry: MaxArray(1, CMRCompositionU5ErgebnisseSectionEntry)
                })
            ])
        )
);
...
export const CMRCompositionU5HoerscreeningCode: t.Type<CMRCompositionU5HoerscreeningCode> = t.recursion(
...
export const CMRCompositionU5HoerscreeningText: t.Type<CMRCompositionU5HoerscreeningText> = t.recursion(
 ...
 * A reference to the actual resource from which the narrative in the section is derived.
 */
export interface CMRCompositionU5HoerscreeningEntry {
    reference: string;
    id?: string;
}

export const CMRCompositionU5HoerscreeningEntry: t.Type<CMRCompositionU5HoerscreeningEntry> = t.recursion(
...
export const CMRCompositionU5HoerscreeningEmptyReason: t.Type<CMRCompositionU5HoerscreeningEmptyReason> = t.recursion(
...
export const CMRCompositionU5OrientierendeBeurteilungDerEntwicklungCode: t.Type<CMRCompositionU5OrientierendeBeurteilungDerEntwicklungCode> = t.recursion(
...
export const CMRCompositionU5OrientierendeBeurteilungDerEntwicklungText: t.Type<CMRCompositionU5OrientierendeBeurteilungDerEntwicklungText> = t.recursion(
 ...
 * A reference to the actual resource from which the narrative in the section is derived.
 */
export interface CMRCompositionU5OrientierendeBeurteilungDerEntwicklungEntry {
    reference: string;
    id?: string;
}

export const CMRCompositionU5OrientierendeBeurteilungDerEntwicklungEntry: t.Type<CMRCompositionU5OrientierendeBeurteilungDerEntwicklungEntry> = t.recursion(
...
export const CMRCompositionU5OrientierendeBeurteilungDerEntwicklungEmptyReason: t.Type<CMRCompositionU5OrientierendeBeurteilungDerEntwicklungEmptyReason> = t.recursion(
...
export const CMRCompositionU5PerzentilkurvenCode: t.Type<CMRCompositionU5PerzentilkurvenCode> = t.recursion(
...
export const CMRCompositionU5PerzentilkurvenText: t.Type<CMRCompositionU5PerzentilkurvenText> = t.recursion(
 ...
 * A reference to the actual resource from which the narrative in the section is derived.
 */
export interface CMRCompositionU5PerzentilkurvenEntry {
    reference: string;
    id?: string;
}

export const CMRCompositionU5PerzentilkurvenEntry: t.Type<CMRCompositionU5PerzentilkurvenEntry> = t.recursion(
...
export const CMRCompositionU5PerzentilkurvenEmptyReason: t.Type<CMRCompositionU5PerzentilkurvenEmptyReason> = t.recursion(
...
export const CMRCompositionU5U5Einleitung: t.Type<CMRCompositionU5U5Einleitung> = t.recursion(
...
export const CMRCompositionU5CategoryCoding: t.Type<CMRCompositionU5CategoryCoding> = t.recursion(
...
export interface CMRCompositionU5AktuelleAnamneseDesKindes {
    ...
    entry?: CMRCompositionU5AktuelleAnamneseDesKindesEntry[];
    emptyReason?: CMRCompositionU5AktuelleAnamneseDesKindesEmptyReason;
}

export const CMRCompositionU5AktuelleAnamneseDesKindes: t.Type<CMRCompositionU5AktuelleAnamneseDesKindes> = t.recursion(
        ...
        Excess(
            t.intersection([
                ...
                t.partial({
                    ...
                    entry: t.array(CMRCompositionU5AktuelleAnamneseDesKindesEntry),
                    emptyReason: CMRCompositionU5AktuelleAnamneseDesKindesEmptyReason
                })
            ])
        )
...
export interface CMRCompositionU5Sozialanamnese {
    ...
    entry?: CMRCompositionU5SozialanamneseEntry[];
    emptyReason?: CMRCompositionU5SozialanamneseEmptyReason;
}

export const CMRCompositionU5Sozialanamnese: t.Type<CMRCompositionU5Sozialanamnese> = t.recursion(
        ...
        Excess(
            t.intersection([
                ...
                t.partial({
                    ...
                    entry: t.array(CMRCompositionU5SozialanamneseEntry),
                    emptyReason: CMRCompositionU5SozialanamneseEmptyReason
                })
            ])
        )
...
export interface CMRCompositionU5Untersuchung {
    ...
    entry?: CMRCompositionU5UntersuchungEntry[];
    emptyReason?: CMRCompositionU5UntersuchungEmptyReason;
}

export const CMRCompositionU5Untersuchung: t.Type<CMRCompositionU5Untersuchung> = t.recursion(
        ...
        Excess(
            t.intersection([
                ...
                t.partial({
                    ...
                    entry: t.array(CMRCompositionU5UntersuchungEntry),
                    emptyReason: CMRCompositionU5UntersuchungEmptyReason
                })
            ])
        )
...
export interface CMRCompositionU5Beratung {
    ...
    entry?: CMRCompositionU5BeratungEntry[];
        ...
        Excess(
            t.intersection([
                ...
                t.partial({
                    ...
                    entry: t.array(CMRCompositionU5BeratungEntry),
                    emptyReason: CMRCompositionU5BeratungEmptyReason
                })
            ])
        )
...
export interface CMRCompositionU5Ergebnisse {
    ...
    id?: string;
    extension?: (Extension | CMRCompositionU5ErgebnissePruefungAufklaerungHinweis)[];
    entry?: CMRCompositionU5ErgebnisseEntry[];
                ...
                t.partial({
                    ...
                    >(
                        ...
                        [
                            ...
                            {
                                codec: CMRCompositionU5ErgebnissePruefungAufklaerungHinweis,
                                occurrence: ["1", "1"],
                                sliceBy: {
                                    path: "url",
                                    value:
                    ...
                    entry: t.array(CMRCompositionU5ErgebnisseEntry),
                    emptyReason: CMRCompositionU5ErgebnisseEmptyReason
                })
            ])
        )
...
export interface CMRCompositionU5Hoerscreening {
    ...
    id?: string;
    entry?: CMRCompositionU5HoerscreeningEntry[];
    emptyReason?: CMRCompositionU5HoerscreeningEmptyReason;
}

export const CMRCompositionU5Hoerscreening: t.Type<CMRCompositionU5Hoerscreening> = t.recursion(
    ...
    () =>
        Excess(
            t.intersection([
                ...
                t.partial({
                    id: SCALARString,
                    entry: t.array(CMRCompositionU5HoerscreeningEntry),
                    emptyReason: CMRCompositionU5HoerscreeningEmptyReason
                })
            ])
        )
...
export interface CMRCompositionU5OrientierendeBeurteilungDerEntwicklung {
    ...
    entry?: CMRCompositionU5OrientierendeBeurteilungDerEntwicklungEntry[];
    emptyReason?: CMRCompositionU5OrientierendeBeurteilungDerEntwicklungEmptyReason;
}

export const CMRCompositionU5OrientierendeBeurteilungDerEntwicklung: t.Type<CMRCompositionU5OrientierendeBeurteilungDerEntwicklung> = t.recursion(
...
export interface CMRCompositionU5Perzentilkurven {
    ...
    id?: string;
    entry?: Array<CMRCompositionU5PerzentilkurvenEntry>;
    emptyReason?: CMRCompositionU5PerzentilkurvenEmptyReason;
}

export const CMRCompositionU5Perzentilkurven: t.Type<CMRCompositionU5Perzentilkurven> = t.recursion(
    ...
    () =>
        Excess(
            t.intersection([
                ...
                t.partial({
                    id: SCALARString,
                    entry: MaxArray(1, CMRCompositionU5PerzentilkurvenEntry),
                    emptyReason: CMRCompositionU5PerzentilkurvenEmptyReason
                })
            ])
        )
 ...
 */
export interface CMRCompositionU5Subject {
    reference: string;
    id?: string;
}

export const CMRCompositionU5Subject: t.Type<CMRCompositionU5Subject> = t.recursion(
 ...
 */
export interface CMRCompositionU5Encounter {
    reference: string;
    id?: string;
}

export const CMRCompositionU5Encounter: t.Type<CMRCompositionU5Encounter> = t.recursion(
 ...
 */
export interface CMRCompositionU5Author {
    reference: string;
    id?: string;
}

export const CMRCompositionU5Author: t.Type<CMRCompositionU5Author> = t.recursion(
...
interface CMRCompositionU5 {
    ...
    subject: CMRCompositionU5Subject;
    encounter: CMRCompositionU5Encounter;
    date: string;
    author: Array<CMRCompositionU5Author>;
    title: "U5";
    id?: string;
    text?: Narrative;
    ...
    Excess(
        t.intersection([
            t.type({
                ...
                encounter: CMRCompositionU5Encounter,
                date: SCALARDateTime,
                author: MinMaxArray(1, 2, CMRCompositionU5Author),
                title: Literal("U5")
            }),
            t.partial({
                id: SCALARString,
