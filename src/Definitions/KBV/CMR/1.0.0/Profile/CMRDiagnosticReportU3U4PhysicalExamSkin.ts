...
export const CMRDiagnosticReportU3U4PhysicalExamSkinCodeCodingDisplayAnzeigenameCodeSnomedContent: t.Type<CMRDiagnosticReportU3U4PhysicalExamSkinCodeCodingDisplayAnzeigenameCodeSnomedContent> = t.recursion(
...
export const CMRDiagnosticReportU3U4PhysicalExamSkinCodeCodingDisplayAnzeigenameCodeSnomed: t.Type<CMRDiagnosticReportU3U4PhysicalExamSkinCodeCodingDisplayAnzeigenameCodeSnomed> = t.recursion(
...
export const CMRDiagnosticReportU3U4PhysicalExamSkinCodeCodingDisplay: t.Type<CMRDiagnosticReportU3U4PhysicalExamSkinCodeCodingDisplay> = t.recursion(
...
export const CMRDiagnosticReportU3U4PhysicalExamSkinCodeCoding: t.Type<CMRDiagnosticReportU3U4PhysicalExamSkinCodeCoding> = t.recursion(
...
export const CMRDiagnosticReportU3U4PhysicalExamSkinMeta: t.Type<CMRDiagnosticReportU3U4PhysicalExamSkinMeta> = t.recursion(
...
export const CMRDiagnosticReportU3U4PhysicalExamSkinCode: t.Type<CMRDiagnosticReportU3U4PhysicalExamSkinCode> = t.recursion(
...
export const CMRDiagnosticReportU3U4PhysicalExamSkinSubject: t.Type<CMRDiagnosticReportU3U4PhysicalExamSkinSubject> = t.recursion(
...
export const CMRDiagnosticReportU3U4PhysicalExamSkinEncounter: t.Type<CMRDiagnosticReportU3U4PhysicalExamSkinEncounter> = t.recursion(
...
export const CMRDiagnosticReportU3U4PhysicalExamSkinPerformer: t.Type<CMRDiagnosticReportU3U4PhysicalExamSkinPerformer> = t.recursion(
...
export const CMRDiagnosticReportU3U4PhysicalExamSkinResult: t.Type<CMRDiagnosticReportU3U4PhysicalExamSkinResult> = t.recursion(
    ...
    () =>
        Excess(
            t.intersection([
                t.type({
                    reference: CustomReference(SCALARString, [
                        "https://fhir.kbv.de/StructureDefinition/KBV_PR_MIO_CMR_Observation_U3_U4_Physical_Exam_Skin|1.0.0"
                    ])
                }),
                t.partial({
                    id: SCALARString
...
const CMRDiagnosticReportU3U4PhysicalExamSkin: t.Type<CMRDiagnosticReportU3U4PhysicalExamSkin> = t.recursion(
