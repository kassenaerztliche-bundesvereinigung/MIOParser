...
export const CMRDiagnosticReportU7aPhysicalExamMouthNoseCodeCodingDisplayAnzeigenameCodeSnomedContent: t.Type<CMRDiagnosticReportU7aPhysicalExamMouthNoseCodeCodingDisplayAnzeigenameCodeSnomedContent> = t.recursion(
...
export const CMRDiagnosticReportU7aPhysicalExamMouthNoseCodeCodingDisplayAnzeigenameCodeSnomed: t.Type<CMRDiagnosticReportU7aPhysicalExamMouthNoseCodeCodingDisplayAnzeigenameCodeSnomed> = t.recursion(
...
export const CMRDiagnosticReportU7aPhysicalExamMouthNoseCodeCodingDisplay: t.Type<CMRDiagnosticReportU7aPhysicalExamMouthNoseCodeCodingDisplay> = t.recursion(
...
export const CMRDiagnosticReportU7aPhysicalExamMouthNoseCodeCoding: t.Type<CMRDiagnosticReportU7aPhysicalExamMouthNoseCodeCoding> = t.recursion(
...
export const CMRDiagnosticReportU7aPhysicalExamMouthNoseMeta: t.Type<CMRDiagnosticReportU7aPhysicalExamMouthNoseMeta> = t.recursion(
...
export const CMRDiagnosticReportU7aPhysicalExamMouthNoseCode: t.Type<CMRDiagnosticReportU7aPhysicalExamMouthNoseCode> = t.recursion(
...
export const CMRDiagnosticReportU7aPhysicalExamMouthNoseSubject: t.Type<CMRDiagnosticReportU7aPhysicalExamMouthNoseSubject> = t.recursion(
...
export const CMRDiagnosticReportU7aPhysicalExamMouthNoseEncounter: t.Type<CMRDiagnosticReportU7aPhysicalExamMouthNoseEncounter> = t.recursion(
...
export const CMRDiagnosticReportU7aPhysicalExamMouthNosePerformer: t.Type<CMRDiagnosticReportU7aPhysicalExamMouthNosePerformer> = t.recursion(
...
export const CMRDiagnosticReportU7aPhysicalExamMouthNoseResult: t.Type<CMRDiagnosticReportU7aPhysicalExamMouthNoseResult> = t.recursion(
    ...
    () =>
        Excess(
            t.intersection([
                t.type({
                    reference: CustomReference(SCALARString, [
                        "https://fhir.kbv.de/StructureDefinition/KBV_PR_MIO_CMR_Observation_U7a_Physical_Exam_Mouth_Nose|1.0.0"
                    ])
                }),
                t.partial({
                    id: SCALARString
...
const CMRDiagnosticReportU7aPhysicalExamMouthNose: t.Type<CMRDiagnosticReportU7aPhysicalExamMouthNose> = t.recursion(
