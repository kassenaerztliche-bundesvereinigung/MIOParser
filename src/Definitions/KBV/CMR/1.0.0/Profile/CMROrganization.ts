 ...
 */
export interface CMROrganizationInstitutionskennzeichenTypeXXType {
...
export const CMROrganizationInstitutionskennzeichenTypeXXType: t.Type<CMROrganizationInstitutionskennzeichenTypeXXType> = t.recursion(
 ...
 * A reference to a code defined by a terminology system.
 */
export interface CMROrganizationBetriebsstaettennummerTypeBSNRType {
    system: "http://terminology.hl7.org/CodeSystem/v2-0203";
    code: "BSNR";
    id?: string;
    version?: string;
...
export const CMROrganizationBetriebsstaettennummerTypeBSNRType: t.Type<CMROrganizationBetriebsstaettennummerTypeBSNRType> = t.recursion(
...
export const CMROrganizationStrassenanschriftLineStrasse: t.Type<CMROrganizationStrassenanschriftLineStrasse> = t.recursion(
...
export const CMROrganizationStrassenanschriftLineHausnummer: t.Type<CMROrganizationStrassenanschriftLineHausnummer> = t.recursion(
...
export const CMROrganizationStrassenanschriftLineAdresszusatz: t.Type<CMROrganizationStrassenanschriftLineAdresszusatz> = t.recursion(
...
export const CMROrganizationPostfachLinePostfach: t.Type<CMROrganizationPostfachLinePostfach> = t.recursion(
...
export const CMROrganizationBetriebsstaettennummerAssignerIdentifier: t.Type<CMROrganizationBetriebsstaettennummerAssignerIdentifier> = t.recursion(
...
export const CMROrganizationStrassenanschriftStadtteil: t.Type<CMROrganizationStrassenanschriftStadtteil> = t.recursion(
...
export const CMROrganizationPostfachStadtteil: t.Type<CMROrganizationPostfachStadtteil> = t.recursion(
...
export interface CMROrganizationInstitutionskennzeichenType {
    coding: Array<CMROrganizationInstitutionskennzeichenTypeXXType>;
    id?: string;
    text?: string;
}

export const CMROrganizationInstitutionskennzeichenType: t.Type<CMROrganizationInstitutionskennzeichenType> = t.recursion(
    "CMROrganizationInstitutionskennzeichenType",
    () =>
        Excess(
            t.intersection([
                t.type({
                    coding: MinArray(1, CMROrganizationInstitutionskennzeichenTypeXXType)
                }),
                t.partial({
                    id: SCALARString,
                    text: SCALARString
...
export interface CMROrganizationBetriebsstaettennummerType {
    coding: Array<CMROrganizationBetriebsstaettennummerTypeBSNRType>;
    id?: string;
    text?: string;
}

export const CMROrganizationBetriebsstaettennummerType: t.Type<CMROrganizationBetriebsstaettennummerType> = t.recursion(
    "CMROrganizationBetriebsstaettennummerType",
    () =>
        Excess(
            t.intersection([
                t.type({
                    coding: MinArray(1, CMROrganizationBetriebsstaettennummerTypeBSNRType)
                }),
                t.partial({
                    id: SCALARString,
                    text: SCALARString
...
export const CMROrganizationBetriebsstaettennummerAssigner: t.Type<CMROrganizationBetriebsstaettennummerAssigner> = t.recursion(
...
export const CMROrganizationStrassenanschriftLine: t.Type<CMROrganizationStrassenanschriftLine> = t.recursion(
...
export const CMROrganizationPostfachLine: t.Type<CMROrganizationPostfachLine> = t.recursion(
...
export const CMROrganizationErgaenzendeAngaben: t.Type<CMROrganizationErgaenzendeAngaben> = t.recursion(
...
export const CMROrganizationInstitutionskennzeichen: t.Type<CMROrganizationInstitutionskennzeichen> = t.recursion(
...
export interface CMROrganizationBetriebsstaettennummer {
    type: CMROrganizationBetriebsstaettennummerType;
...
export const CMROrganizationBetriebsstaettennummer: t.Type<CMROrganizationBetriebsstaettennummer> = t.recursion(
...
export const CMROrganizationStrassenanschrift: t.Type<CMROrganizationStrassenanschrift> = t.recursion(
