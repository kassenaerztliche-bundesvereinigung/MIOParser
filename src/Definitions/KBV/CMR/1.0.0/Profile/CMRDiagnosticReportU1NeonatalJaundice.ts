...
export const CMRDiagnosticReportU1NeonatalJaundiceCodeCodingDisplayAnzeigenameCodeSnomedContent: t.Type<CMRDiagnosticReportU1NeonatalJaundiceCodeCodingDisplayAnzeigenameCodeSnomedContent> = t.recursion(
...
export const CMRDiagnosticReportU1NeonatalJaundiceCodeCodingDisplayAnzeigenameCodeSnomed: t.Type<CMRDiagnosticReportU1NeonatalJaundiceCodeCodingDisplayAnzeigenameCodeSnomed> = t.recursion(
...
export const CMRDiagnosticReportU1NeonatalJaundiceCodeCodingDisplay: t.Type<CMRDiagnosticReportU1NeonatalJaundiceCodeCodingDisplay> = t.recursion(
...
export const CMRDiagnosticReportU1NeonatalJaundiceCodeCoding: t.Type<CMRDiagnosticReportU1NeonatalJaundiceCodeCoding> = t.recursion(
...
export const CMRDiagnosticReportU1NeonatalJaundiceMeta: t.Type<CMRDiagnosticReportU1NeonatalJaundiceMeta> = t.recursion(
...
export const CMRDiagnosticReportU1NeonatalJaundiceCode: t.Type<CMRDiagnosticReportU1NeonatalJaundiceCode> = t.recursion(
...
export const CMRDiagnosticReportU1NeonatalJaundiceSubject: t.Type<CMRDiagnosticReportU1NeonatalJaundiceSubject> = t.recursion(
...
export const CMRDiagnosticReportU1NeonatalJaundiceEncounter: t.Type<CMRDiagnosticReportU1NeonatalJaundiceEncounter> = t.recursion(
...
export const CMRDiagnosticReportU1NeonatalJaundicePerformer: t.Type<CMRDiagnosticReportU1NeonatalJaundicePerformer> = t.recursion(
...
export const CMRDiagnosticReportU1NeonatalJaundiceResult: t.Type<CMRDiagnosticReportU1NeonatalJaundiceResult> = t.recursion(
    ...
    () =>
        Excess(
            t.intersection([
                t.type({
                    reference: CustomReference(SCALARString, [
                        "https://fhir.kbv.de/StructureDefinition/KBV_PR_MIO_CMR_Observation_U1_Neonatal_Jaundice|1.0.0"
                    ])
                }),
                t.partial({
                    id: SCALARString
...
const CMRDiagnosticReportU1NeonatalJaundice: t.Type<CMRDiagnosticReportU1NeonatalJaundice> = t.recursion(
