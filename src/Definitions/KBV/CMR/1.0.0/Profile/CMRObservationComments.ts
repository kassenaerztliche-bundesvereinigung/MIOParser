...
export const CMRObservationCommentsCodeCodingDisplayAnzeigenameCodeSnomedContent: t.Type<CMRObservationCommentsCodeCodingDisplayAnzeigenameCodeSnomedContent> = t.recursion(
...
export const CMRObservationCommentsCodeCodingDisplayAnzeigenameCodeSnomed: t.Type<CMRObservationCommentsCodeCodingDisplayAnzeigenameCodeSnomed> = t.recursion(
...
export const CMRObservationCommentsCodeCodingDisplay: t.Type<CMRObservationCommentsCodeCodingDisplay> = t.recursion(
...
export const CMRObservationCommentsCodeCoding: t.Type<CMRObservationCommentsCodeCoding> = t.recursion(
...
export const CMRObservationCommentsSubject: t.Type<CMRObservationCommentsSubject> = t.recursion(
...
export const CMRObservationCommentsEncounter: t.Type<CMRObservationCommentsEncounter> = t.recursion(
...
export const CMRObservationCommentsPerformer: t.Type<CMRObservationCommentsPerformer> = t.recursion(
