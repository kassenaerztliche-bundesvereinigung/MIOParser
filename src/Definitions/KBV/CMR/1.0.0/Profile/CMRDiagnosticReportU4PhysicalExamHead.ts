...
export const CMRDiagnosticReportU4PhysicalExamHeadCodeCodingDisplayAnzeigenameCodeSnomedContent: t.Type<CMRDiagnosticReportU4PhysicalExamHeadCodeCodingDisplayAnzeigenameCodeSnomedContent> = t.recursion(
...
export const CMRDiagnosticReportU4PhysicalExamHeadCodeCodingDisplayAnzeigenameCodeSnomed: t.Type<CMRDiagnosticReportU4PhysicalExamHeadCodeCodingDisplayAnzeigenameCodeSnomed> = t.recursion(
...
export const CMRDiagnosticReportU4PhysicalExamHeadCodeCodingDisplay: t.Type<CMRDiagnosticReportU4PhysicalExamHeadCodeCodingDisplay> = t.recursion(
...
export const CMRDiagnosticReportU4PhysicalExamHeadCodeCoding: t.Type<CMRDiagnosticReportU4PhysicalExamHeadCodeCoding> = t.recursion(
...
export const CMRDiagnosticReportU4PhysicalExamHeadMeta: t.Type<CMRDiagnosticReportU4PhysicalExamHeadMeta> = t.recursion(
...
export const CMRDiagnosticReportU4PhysicalExamHeadCode: t.Type<CMRDiagnosticReportU4PhysicalExamHeadCode> = t.recursion(
...
export const CMRDiagnosticReportU4PhysicalExamHeadSubject: t.Type<CMRDiagnosticReportU4PhysicalExamHeadSubject> = t.recursion(
...
export const CMRDiagnosticReportU4PhysicalExamHeadEncounter: t.Type<CMRDiagnosticReportU4PhysicalExamHeadEncounter> = t.recursion(
...
export const CMRDiagnosticReportU4PhysicalExamHeadPerformer: t.Type<CMRDiagnosticReportU4PhysicalExamHeadPerformer> = t.recursion(
...
export const CMRDiagnosticReportU4PhysicalExamHeadResult: t.Type<CMRDiagnosticReportU4PhysicalExamHeadResult> = t.recursion(
    ...
    () =>
        Excess(
            t.intersection([
                t.type({
                    reference: CustomReference(SCALARString, [
                        "https://fhir.kbv.de/StructureDefinition/KBV_PR_MIO_CMR_Observation_U4_Physical_Exam_Head|1.0.0"
                    ])
                }),
                t.partial({
                    id: SCALARString
...
const CMRDiagnosticReportU4PhysicalExamHead: t.Type<CMRDiagnosticReportU4PhysicalExamHead> = t.recursion(
