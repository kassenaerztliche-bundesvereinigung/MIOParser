 ...
 */
export interface CMRPatientPidTypeMRType {
...
export const CMRPatientPidTypeMRType: t.Type<CMRPatientPidTypeMRType> = t.recursion(
 ...
 * A reference to a code defined by a terminology system.
 */
export interface CMRPatientVersichertenIdGKVTypeGKVType {
...
export const CMRPatientVersichertenIdGKVTypeGKVType: t.Type<CMRPatientVersichertenIdGKVTypeGKVType> = t.recursion(
 ...
 * A reference to a code defined by a terminology system.
 */
export interface CMRPatientVersichertennummerpkvTypePKVType {
    system: "http://fhir.de/CodeSystem/identifier-type-de-basis";
    code: "PKV";
    id?: string;
    version?: string;
...
export const CMRPatientVersichertennummerpkvTypePKVType: t.Type<CMRPatientVersichertennummerpkvTypePKVType> = t.recursion(
...
export const CMRPatientNameFamilyNamenszusatz: t.Type<CMRPatientNameFamilyNamenszusatz> = t.recursion(
...
export const CMRPatientNameFamilyNachname: t.Type<CMRPatientNameFamilyNachname> = t.recursion(
...
export const CMRPatientNameFamilyVorsatzwort: t.Type<CMRPatientNameFamilyVorsatzwort> = t.recursion(
...
export const CMRPatientGeburtsnameFamilyNamenszusatz: t.Type<CMRPatientGeburtsnameFamilyNamenszusatz> = t.recursion(
...
export const CMRPatientGeburtsnameFamilyNachname: t.Type<CMRPatientGeburtsnameFamilyNachname> = t.recursion(
...
export const CMRPatientGeburtsnameFamilyVorsatzwort: t.Type<CMRPatientGeburtsnameFamilyVorsatzwort> = t.recursion(
...
export const CMRPatientVersichertennummerpkvAssignerIdentifier: t.Type<CMRPatientVersichertennummerpkvAssignerIdentifier> = t.recursion(
...
export const CMRPatientVersichertennummerkvkTypeCoding: t.Type<CMRPatientVersichertennummerkvkTypeCoding> = t.recursion(
...
export interface CMRPatientPidType {
    coding: Array<CMRPatientPidTypeMRType>;
    id?: string;
    text?: string;
}
...
export const CMRPatientPidType: t.Type<CMRPatientPidType> = t.recursion(
    ...
    () =>
        Excess(
            t.intersection([
                t.type({
                    coding: MinArray(1, CMRPatientPidTypeMRType)
                }),
                t.partial({
                    id: SCALARString,
                    text: SCALARString
...
export interface CMRPatientVersichertenIdGKVType {
    coding: Array<CMRPatientVersichertenIdGKVTypeGKVType>;
    id?: string;
    text?: string;
}

export const CMRPatientVersichertenIdGKVType: t.Type<CMRPatientVersichertenIdGKVType> = t.recursion(
    "CMRPatientVersichertenIdGKVType",
    () =>
        Excess(
            t.intersection([
                t.type({
                    coding: MinArray(1, CMRPatientVersichertenIdGKVTypeGKVType)
                }),
                t.partial({
                    id: SCALARString,
                    text: SCALARString
...
export interface CMRPatientVersichertennummerpkvType {
    coding: Array<CMRPatientVersichertennummerpkvTypePKVType>;
    id?: string;
    text?: string;
}

export const CMRPatientVersichertennummerpkvType: t.Type<CMRPatientVersichertennummerpkvType> = t.recursion(
    "CMRPatientVersichertennummerpkvType",
    () =>
        Excess(
            t.intersection([
                t.type({
                    coding: MinArray(1, CMRPatientVersichertennummerpkvTypePKVType)
                }),
                t.partial({
                    id: SCALARString,
                    text: SCALARString
...
export const CMRPatientVersichertennummerpkvAssigner: t.Type<CMRPatientVersichertennummerpkvAssigner> = t.recursion(
...
export const CMRPatientVersichertennummerkvkType: t.Type<CMRPatientVersichertennummerkvkType> = t.recursion(
...
export const CMRPatientGeburtsnameFamily: t.Type<CMRPatientGeburtsnameFamily> = t.recursion(
...
export const CMRPatientBirthDateDataabsentreason: t.Type<CMRPatientBirthDateDataabsentreason> = t.recursion(
...
export const CMRPatientVersichertenIdGKV: t.Type<CMRPatientVersichertenIdGKV> = t.recursion(
...
export const CMRPatientVersichertennummerpkv: t.Type<CMRPatientVersichertennummerpkv> = t.recursion(
...
export const CMRPatientVersichertennummerkvk: t.Type<CMRPatientVersichertennummerkvk> = t.recursion(
