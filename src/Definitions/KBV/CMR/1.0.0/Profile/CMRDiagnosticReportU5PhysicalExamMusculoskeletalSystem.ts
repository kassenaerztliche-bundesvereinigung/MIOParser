...
export const CMRDiagnosticReportU5PhysicalExamMusculoskeletalSystemCodeCodingDisplayAnzeigenameCodeSnomedContent: t.Type<CMRDiagnosticReportU5PhysicalExamMusculoskeletalSystemCodeCodingDisplayAnzeigenameCodeSnomedContent> = t.recursion(
...
export const CMRDiagnosticReportU5PhysicalExamMusculoskeletalSystemCodeCodingDisplayAnzeigenameCodeSnomed: t.Type<CMRDiagnosticReportU5PhysicalExamMusculoskeletalSystemCodeCodingDisplayAnzeigenameCodeSnomed> = t.recursion(
...
export const CMRDiagnosticReportU5PhysicalExamMusculoskeletalSystemCodeCodingDisplay: t.Type<CMRDiagnosticReportU5PhysicalExamMusculoskeletalSystemCodeCodingDisplay> = t.recursion(
...
export const CMRDiagnosticReportU5PhysicalExamMusculoskeletalSystemCodeCoding: t.Type<CMRDiagnosticReportU5PhysicalExamMusculoskeletalSystemCodeCoding> = t.recursion(
...
export const CMRDiagnosticReportU5PhysicalExamMusculoskeletalSystemMeta: t.Type<CMRDiagnosticReportU5PhysicalExamMusculoskeletalSystemMeta> = t.recursion(
...
export const CMRDiagnosticReportU5PhysicalExamMusculoskeletalSystemCode: t.Type<CMRDiagnosticReportU5PhysicalExamMusculoskeletalSystemCode> = t.recursion(
...
export const CMRDiagnosticReportU5PhysicalExamMusculoskeletalSystemSubject: t.Type<CMRDiagnosticReportU5PhysicalExamMusculoskeletalSystemSubject> = t.recursion(
...
export const CMRDiagnosticReportU5PhysicalExamMusculoskeletalSystemEncounter: t.Type<CMRDiagnosticReportU5PhysicalExamMusculoskeletalSystemEncounter> = t.recursion(
...
export const CMRDiagnosticReportU5PhysicalExamMusculoskeletalSystemPerformer: t.Type<CMRDiagnosticReportU5PhysicalExamMusculoskeletalSystemPerformer> = t.recursion(
...
export const CMRDiagnosticReportU5PhysicalExamMusculoskeletalSystemResult: t.Type<CMRDiagnosticReportU5PhysicalExamMusculoskeletalSystemResult> = t.recursion(
    ...
    () =>
        Excess(
            t.intersection([
                t.type({
                    reference: CustomReference(SCALARString, [
                        "https://fhir.kbv.de/StructureDefinition/KBV_PR_MIO_CMR_Observation_U5_Physical_Exam_Musculoskeletal_System|1.0.0"
                    ])
                }),
                t.partial({
                    id: SCALARString
...
const CMRDiagnosticReportU5PhysicalExamMusculoskeletalSystem: t.Type<CMRDiagnosticReportU5PhysicalExamMusculoskeletalSystem> = t.recursion(
