...
export const CMRDiagnosticReportU6U7PhysicalExamChestLungRespiratoryTractCodeCodingDisplayAnzeigenameCodeSnomedContent: t.Type<CMRDiagnosticReportU6U7PhysicalExamChestLungRespiratoryTractCodeCodingDisplayAnzeigenameCodeSnomedContent> = t.recursion(
...
export const CMRDiagnosticReportU6U7PhysicalExamChestLungRespiratoryTractCodeCodingDisplayAnzeigenameCodeSnomed: t.Type<CMRDiagnosticReportU6U7PhysicalExamChestLungRespiratoryTractCodeCodingDisplayAnzeigenameCodeSnomed> = t.recursion(
...
export const CMRDiagnosticReportU6U7PhysicalExamChestLungRespiratoryTractCodeCodingDisplay: t.Type<CMRDiagnosticReportU6U7PhysicalExamChestLungRespiratoryTractCodeCodingDisplay> = t.recursion(
...
export const CMRDiagnosticReportU6U7PhysicalExamChestLungRespiratoryTractCodeCoding: t.Type<CMRDiagnosticReportU6U7PhysicalExamChestLungRespiratoryTractCodeCoding> = t.recursion(
...
export const CMRDiagnosticReportU6U7PhysicalExamChestLungRespiratoryTractMeta: t.Type<CMRDiagnosticReportU6U7PhysicalExamChestLungRespiratoryTractMeta> = t.recursion(
...
export const CMRDiagnosticReportU6U7PhysicalExamChestLungRespiratoryTractCode: t.Type<CMRDiagnosticReportU6U7PhysicalExamChestLungRespiratoryTractCode> = t.recursion(
...
export const CMRDiagnosticReportU6U7PhysicalExamChestLungRespiratoryTractSubject: t.Type<CMRDiagnosticReportU6U7PhysicalExamChestLungRespiratoryTractSubject> = t.recursion(
...
export const CMRDiagnosticReportU6U7PhysicalExamChestLungRespiratoryTractEncounter: t.Type<CMRDiagnosticReportU6U7PhysicalExamChestLungRespiratoryTractEncounter> = t.recursion(
...
export const CMRDiagnosticReportU6U7PhysicalExamChestLungRespiratoryTractPerformer: t.Type<CMRDiagnosticReportU6U7PhysicalExamChestLungRespiratoryTractPerformer> = t.recursion(
...
export const CMRDiagnosticReportU6U7PhysicalExamChestLungRespiratoryTractResult: t.Type<CMRDiagnosticReportU6U7PhysicalExamChestLungRespiratoryTractResult> = t.recursion(
    ...
    () =>
        Excess(
            t.intersection([
                t.type({
                    reference: CustomReference(SCALARString, [
                        "https://fhir.kbv.de/StructureDefinition/KBV_PR_MIO_CMR_Observation_U6_U7_Physical_Exam_Chest_Lung_Respiratory_Tract|1.0.0"
                    ])
                }),
                t.partial({
                    id: SCALARString
...
const CMRDiagnosticReportU6U7PhysicalExamChestLungRespiratoryTract: t.Type<CMRDiagnosticReportU6U7PhysicalExamChestLungRespiratoryTract> = t.recursion(
