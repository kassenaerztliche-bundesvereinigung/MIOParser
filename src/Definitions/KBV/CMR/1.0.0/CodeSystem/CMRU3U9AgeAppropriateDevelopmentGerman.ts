...
const CMRU3U9AgeAppropriateDevelopmentGerman: t.Type<CMRU3U9AgeAppropriateDevelopmentGerman> = t.union(
    [t.literal("altersgemaesseEntwicklung"), t.literal("nichtaltersgemaesseEntwicklung")]
);
