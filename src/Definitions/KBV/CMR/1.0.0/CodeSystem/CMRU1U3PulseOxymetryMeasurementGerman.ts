...
type CMRU1U3PulseOxymetryMeasurementGerman = "auffaellig" | "unauffaellig";

const CMRU1U3PulseOxymetryMeasurementGerman: t.Type<CMRU1U3PulseOxymetryMeasurementGerman> = t.union(
    [t.literal("auffaellig"), t.literal("unauffaellig")]
);
