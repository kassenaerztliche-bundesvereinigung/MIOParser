...
const CMRU4PhysicalExamAbdomenGenitalsGerman: t.Type<CMRU4PhysicalExamAbdomenGenitalsGerman> = t.union(
    [t.literal("Anomalien"), t.literal("LeberundMilzgroesse"), t.literal("Hernien")]
);
