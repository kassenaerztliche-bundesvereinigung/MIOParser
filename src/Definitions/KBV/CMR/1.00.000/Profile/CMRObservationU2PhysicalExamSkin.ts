...
import CMRU2PhysicalExamSkinVS from "../../../../../Definitions/KBV/CMR/1.00.000/ValueSet/CMRU2PhysicalExamSkin";
...
export const CMRObservationU2PhysicalExamSkinCodeCodingDisplayAnzeigenameCodeSnomedContent: t.Type<CMRObservationU2PhysicalExamSkinCodeCodingDisplayAnzeigenameCodeSnomedContent> = t.recursion(
...
export const CMRObservationU2PhysicalExamSkinCodeCodingDisplayAnzeigenameCodeSnomed: t.Type<CMRObservationU2PhysicalExamSkinCodeCodingDisplayAnzeigenameCodeSnomed> = t.recursion(
...
export const CMRObservationU2PhysicalExamSkinCodeCodingDisplay: t.Type<CMRObservationU2PhysicalExamSkinCodeCodingDisplay> = t.recursion(
...
export const CMRObservationU2PhysicalExamSkinCodeCoding: t.Type<CMRObservationU2PhysicalExamSkinCodeCoding> = t.recursion(
...
export const CMRObservationU2PhysicalExamSkinMeta: t.Type<CMRObservationU2PhysicalExamSkinMeta> = t.recursion(
...
export const CMRObservationU2PhysicalExamSkinCode: t.Type<CMRObservationU2PhysicalExamSkinCode> = t.recursion(
...
export const CMRObservationU2PhysicalExamSkinSubject: t.Type<CMRObservationU2PhysicalExamSkinSubject> = t.recursion(
...
export const CMRObservationU2PhysicalExamSkinEncounter: t.Type<CMRObservationU2PhysicalExamSkinEncounter> = t.recursion(
...
export const CMRObservationU2PhysicalExamSkinPerformer: t.Type<CMRObservationU2PhysicalExamSkinPerformer> = t.recursion(
...
const CMRObservationU2PhysicalExamSkin: t.Type<CMRObservationU2PhysicalExamSkin> = t.recursion(
