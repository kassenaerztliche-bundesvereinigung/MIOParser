...
export const CMRDiagnosticReportU2U3PhysicalExamEyesCodeCodingDisplayAnzeigenameCodeSnomedContent: t.Type<CMRDiagnosticReportU2U3PhysicalExamEyesCodeCodingDisplayAnzeigenameCodeSnomedContent> = t.recursion(
...
export const CMRDiagnosticReportU2U3PhysicalExamEyesCodeCodingDisplayAnzeigenameCodeSnomed: t.Type<CMRDiagnosticReportU2U3PhysicalExamEyesCodeCodingDisplayAnzeigenameCodeSnomed> = t.recursion(
...
export const CMRDiagnosticReportU2U3PhysicalExamEyesCodeCodingDisplay: t.Type<CMRDiagnosticReportU2U3PhysicalExamEyesCodeCodingDisplay> = t.recursion(
...
export const CMRDiagnosticReportU2U3PhysicalExamEyesCodeCoding: t.Type<CMRDiagnosticReportU2U3PhysicalExamEyesCodeCoding> = t.recursion(
...
export const CMRDiagnosticReportU2U3PhysicalExamEyesMeta: t.Type<CMRDiagnosticReportU2U3PhysicalExamEyesMeta> = t.recursion(
...
export const CMRDiagnosticReportU2U3PhysicalExamEyesCode: t.Type<CMRDiagnosticReportU2U3PhysicalExamEyesCode> = t.recursion(
 ...
 */
export interface CMRDiagnosticReportU2U3PhysicalExamEyesSubject {
    reference: string;
    id?: string;
}

export const CMRDiagnosticReportU2U3PhysicalExamEyesSubject: t.Type<CMRDiagnosticReportU2U3PhysicalExamEyesSubject> = t.recursion(
 ...
 */
export interface CMRDiagnosticReportU2U3PhysicalExamEyesEncounter {
    reference: string;
    id?: string;
}

export const CMRDiagnosticReportU2U3PhysicalExamEyesEncounter: t.Type<CMRDiagnosticReportU2U3PhysicalExamEyesEncounter> = t.recursion(
 ...
 */
export interface CMRDiagnosticReportU2U3PhysicalExamEyesPerformer {
    reference: string;
    id?: string;
}

export const CMRDiagnosticReportU2U3PhysicalExamEyesPerformer: t.Type<CMRDiagnosticReportU2U3PhysicalExamEyesPerformer> = t.recursion(
 ...
 */
export interface CMRDiagnosticReportU2U3PhysicalExamEyesResult {
    reference: string;
    id?: string;
}

export const CMRDiagnosticReportU2U3PhysicalExamEyesResult: t.Type<CMRDiagnosticReportU2U3PhysicalExamEyesResult> = t.recursion(
...
interface CMRDiagnosticReportU2U3PhysicalExamEyes {
    ...
    subject: CMRDiagnosticReportU2U3PhysicalExamEyesSubject;
    encounter: CMRDiagnosticReportU2U3PhysicalExamEyesEncounter;
    effectiveDateTime: string;
    id?: string;
    text?: Narrative;
    performer?: Array<CMRDiagnosticReportU2U3PhysicalExamEyesPerformer>;
    result?: CMRDiagnosticReportU2U3PhysicalExamEyesResult[];
}

const CMRDiagnosticReportU2U3PhysicalExamEyes: t.Type<CMRDiagnosticReportU2U3PhysicalExamEyes> = t.recursion(
        ...
        Excess(
            t.intersection([
                ...
                t.partial({
                    ...
                    result: t.array(CMRDiagnosticReportU2U3PhysicalExamEyesResult)
                })
            ])
        )
);
