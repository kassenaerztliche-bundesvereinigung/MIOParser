...
import CMRU4PhysicalExamHeadVS from "../../../../../Definitions/KBV/CMR/1.00.000/ValueSet/CMRU4PhysicalExamHead";
...
export const CMRObservationU4PhysicalExamHeadCodeCodingDisplayAnzeigenameCodeSnomedContent: t.Type<CMRObservationU4PhysicalExamHeadCodeCodingDisplayAnzeigenameCodeSnomedContent> = t.recursion(
...
export const CMRObservationU4PhysicalExamHeadCodeCodingDisplayAnzeigenameCodeSnomed: t.Type<CMRObservationU4PhysicalExamHeadCodeCodingDisplayAnzeigenameCodeSnomed> = t.recursion(
...
export const CMRObservationU4PhysicalExamHeadCodeCodingDisplay: t.Type<CMRObservationU4PhysicalExamHeadCodeCodingDisplay> = t.recursion(
...
export const CMRObservationU4PhysicalExamHeadCodeCoding: t.Type<CMRObservationU4PhysicalExamHeadCodeCoding> = t.recursion(
...
export const CMRObservationU4PhysicalExamHeadMeta: t.Type<CMRObservationU4PhysicalExamHeadMeta> = t.recursion(
...
export const CMRObservationU4PhysicalExamHeadCode: t.Type<CMRObservationU4PhysicalExamHeadCode> = t.recursion(
...
export const CMRObservationU4PhysicalExamHeadSubject: t.Type<CMRObservationU4PhysicalExamHeadSubject> = t.recursion(
...
export const CMRObservationU4PhysicalExamHeadEncounter: t.Type<CMRObservationU4PhysicalExamHeadEncounter> = t.recursion(
...
export const CMRObservationU4PhysicalExamHeadPerformer: t.Type<CMRObservationU4PhysicalExamHeadPerformer> = t.recursion(
...
const CMRObservationU4PhysicalExamHead: t.Type<CMRObservationU4PhysicalExamHead> = t.recursion(
