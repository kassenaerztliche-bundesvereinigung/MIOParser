...
export const CMRDiagnosticReportU2PhysicalExamSkinCodeCodingDisplayAnzeigenameCodeSnomedContent: t.Type<CMRDiagnosticReportU2PhysicalExamSkinCodeCodingDisplayAnzeigenameCodeSnomedContent> = t.recursion(
...
export const CMRDiagnosticReportU2PhysicalExamSkinCodeCodingDisplayAnzeigenameCodeSnomed: t.Type<CMRDiagnosticReportU2PhysicalExamSkinCodeCodingDisplayAnzeigenameCodeSnomed> = t.recursion(
...
export const CMRDiagnosticReportU2PhysicalExamSkinCodeCodingDisplay: t.Type<CMRDiagnosticReportU2PhysicalExamSkinCodeCodingDisplay> = t.recursion(
...
export const CMRDiagnosticReportU2PhysicalExamSkinCodeCoding: t.Type<CMRDiagnosticReportU2PhysicalExamSkinCodeCoding> = t.recursion(
...
export const CMRDiagnosticReportU2PhysicalExamSkinMeta: t.Type<CMRDiagnosticReportU2PhysicalExamSkinMeta> = t.recursion(
...
export const CMRDiagnosticReportU2PhysicalExamSkinCode: t.Type<CMRDiagnosticReportU2PhysicalExamSkinCode> = t.recursion(
...
export const CMRDiagnosticReportU2PhysicalExamSkinSubject: t.Type<CMRDiagnosticReportU2PhysicalExamSkinSubject> = t.recursion(
...
export const CMRDiagnosticReportU2PhysicalExamSkinEncounter: t.Type<CMRDiagnosticReportU2PhysicalExamSkinEncounter> = t.recursion(
...
export const CMRDiagnosticReportU2PhysicalExamSkinPerformer: t.Type<CMRDiagnosticReportU2PhysicalExamSkinPerformer> = t.recursion(
...
export const CMRDiagnosticReportU2PhysicalExamSkinResult: t.Type<CMRDiagnosticReportU2PhysicalExamSkinResult> = t.recursion(
    ...
    () =>
        Excess(
            t.intersection([
                t.type({
                    reference: CustomReference(SCALARString, [
                        "https://fhir.kbv.de/StructureDefinition/KBV_PR_MIO_CMR_Observation_U2_Physical_Exam_Skin|1.0.0"
                    ])
                }),
                t.partial({
                    id: SCALARString
...
const CMRDiagnosticReportU2PhysicalExamSkin: t.Type<CMRDiagnosticReportU2PhysicalExamSkin> = t.recursion(
