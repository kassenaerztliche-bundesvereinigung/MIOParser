...
import CMRU2PhysicalExamHeadVS from "../../../../../Definitions/KBV/CMR/1.00.000/ValueSet/CMRU2PhysicalExamHead";
...
export const CMRObservationU2PhysicalExamHeadCodeCodingDisplayAnzeigenameCodeSnomedContent: t.Type<CMRObservationU2PhysicalExamHeadCodeCodingDisplayAnzeigenameCodeSnomedContent> = t.recursion(
...
export const CMRObservationU2PhysicalExamHeadCodeCodingDisplayAnzeigenameCodeSnomed: t.Type<CMRObservationU2PhysicalExamHeadCodeCodingDisplayAnzeigenameCodeSnomed> = t.recursion(
...
export const CMRObservationU2PhysicalExamHeadCodeCodingDisplay: t.Type<CMRObservationU2PhysicalExamHeadCodeCodingDisplay> = t.recursion(
...
export const CMRObservationU2PhysicalExamHeadCodeCoding: t.Type<CMRObservationU2PhysicalExamHeadCodeCoding> = t.recursion(
...
export const CMRObservationU2PhysicalExamHeadMeta: t.Type<CMRObservationU2PhysicalExamHeadMeta> = t.recursion(
...
export const CMRObservationU2PhysicalExamHeadCode: t.Type<CMRObservationU2PhysicalExamHeadCode> = t.recursion(
...
export const CMRObservationU2PhysicalExamHeadSubject: t.Type<CMRObservationU2PhysicalExamHeadSubject> = t.recursion(
...
export const CMRObservationU2PhysicalExamHeadEncounter: t.Type<CMRObservationU2PhysicalExamHeadEncounter> = t.recursion(
...
export const CMRObservationU2PhysicalExamHeadPerformer: t.Type<CMRObservationU2PhysicalExamHeadPerformer> = t.recursion(
...
const CMRObservationU2PhysicalExamHead: t.Type<CMRObservationU2PhysicalExamHead> = t.recursion(
