...
import CMRU6ConsultationVS from "../../../../../Definitions/KBV/CMR/1.00.000/ValueSet/CMRU6Consultation";
...
export const CMRProcedureU6ConsultationCodeCodingDisplayAnzeigenameCodeSnomedContent: t.Type<CMRProcedureU6ConsultationCodeCodingDisplayAnzeigenameCodeSnomedContent> = t.recursion(
...
export const CMRProcedureU6ConsultationCodeCodingDisplayAnzeigenameCodeSnomed: t.Type<CMRProcedureU6ConsultationCodeCodingDisplayAnzeigenameCodeSnomed> = t.recursion(
...
export const CMRProcedureU6ConsultationCodeCodingDisplay: t.Type<CMRProcedureU6ConsultationCodeCodingDisplay> = t.recursion(
...
export const CMRProcedureU6ConsultationCodeCoding: t.Type<CMRProcedureU6ConsultationCodeCoding> = t.recursion(
...
export const CMRProcedureU6ConsultationMeta: t.Type<CMRProcedureU6ConsultationMeta> = t.recursion(
...
export const CMRProcedureU6ConsultationCode: t.Type<CMRProcedureU6ConsultationCode> = t.recursion(
...
export const CMRProcedureU6ConsultationSubject: t.Type<CMRProcedureU6ConsultationSubject> = t.recursion(
...
export const CMRProcedureU6ConsultationEncounter: t.Type<CMRProcedureU6ConsultationEncounter> = t.recursion(
...
export const CMRProcedureU6ConsultationAsserter: t.Type<CMRProcedureU6ConsultationAsserter> = t.recursion(
