...
import CMRU7ConsultationVS from "../../../../../Definitions/KBV/CMR/1.00.000/ValueSet/CMRU7Consultation";
...
export const CMRProcedureU7ConsultationCodeCodingDisplayAnzeigenameCodeSnomedContent: t.Type<CMRProcedureU7ConsultationCodeCodingDisplayAnzeigenameCodeSnomedContent> = t.recursion(
...
export const CMRProcedureU7ConsultationCodeCodingDisplayAnzeigenameCodeSnomed: t.Type<CMRProcedureU7ConsultationCodeCodingDisplayAnzeigenameCodeSnomed> = t.recursion(
...
export const CMRProcedureU7ConsultationCodeCodingDisplay: t.Type<CMRProcedureU7ConsultationCodeCodingDisplay> = t.recursion(
...
export const CMRProcedureU7ConsultationCodeCoding: t.Type<CMRProcedureU7ConsultationCodeCoding> = t.recursion(
...
export const CMRProcedureU7ConsultationMeta: t.Type<CMRProcedureU7ConsultationMeta> = t.recursion(
...
export const CMRProcedureU7ConsultationCode: t.Type<CMRProcedureU7ConsultationCode> = t.recursion(
 ...
 */
export interface CMRProcedureU7ConsultationSubject {
    reference: string;
    id?: string;
}

export const CMRProcedureU7ConsultationSubject: t.Type<CMRProcedureU7ConsultationSubject> = t.recursion(
 ...
 */
export interface CMRProcedureU7ConsultationEncounter {
    reference: string;
    id?: string;
}

export const CMRProcedureU7ConsultationEncounter: t.Type<CMRProcedureU7ConsultationEncounter> = t.recursion(
 ...
 */
export interface CMRProcedureU7ConsultationAsserter {
    reference: string;
    id?: string;
}

export const CMRProcedureU7ConsultationAsserter: t.Type<CMRProcedureU7ConsultationAsserter> = t.recursion(
...
interface CMRProcedureU7Consultation {
    ...
    subject: CMRProcedureU7ConsultationSubject;
    encounter: CMRProcedureU7ConsultationEncounter;
    performedDateTime: string;
    id?: string;
    text?: Narrative;
    asserter?: CMRProcedureU7ConsultationAsserter;
}
