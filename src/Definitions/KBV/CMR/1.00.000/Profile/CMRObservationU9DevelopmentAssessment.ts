...
import CMRU9DevelopmentAssessmentVS from "../../../../../Definitions/KBV/CMR/1.00.000/ValueSet/CMRU9DevelopmentAssessment";
...
export const CMRObservationU9DevelopmentAssessmentCodeCodingDisplayAnzeigenameCodeSnomedContent: t.Type<CMRObservationU9DevelopmentAssessmentCodeCodingDisplayAnzeigenameCodeSnomedContent> = t.recursion(
...
export const CMRObservationU9DevelopmentAssessmentCodeCodingDisplayAnzeigenameCodeSnomed: t.Type<CMRObservationU9DevelopmentAssessmentCodeCodingDisplayAnzeigenameCodeSnomed> = t.recursion(
...
export const CMRObservationU9DevelopmentAssessmentCodeCodingDisplay: t.Type<CMRObservationU9DevelopmentAssessmentCodeCodingDisplay> = t.recursion(
...
export const CMRObservationU9DevelopmentAssessmentCodeCoding: t.Type<CMRObservationU9DevelopmentAssessmentCodeCoding> = t.recursion(
...
export const CMRObservationU9DevelopmentAssessmentMeta: t.Type<CMRObservationU9DevelopmentAssessmentMeta> = t.recursion(
...
export const CMRObservationU9DevelopmentAssessmentCode: t.Type<CMRObservationU9DevelopmentAssessmentCode> = t.recursion(
...
export const CMRObservationU9DevelopmentAssessmentSubject: t.Type<CMRObservationU9DevelopmentAssessmentSubject> = t.recursion(
...
export const CMRObservationU9DevelopmentAssessmentEncounter: t.Type<CMRObservationU9DevelopmentAssessmentEncounter> = t.recursion(
...
export const CMRObservationU9DevelopmentAssessmentPerformer: t.Type<CMRObservationU9DevelopmentAssessmentPerformer> = t.recursion(
...
const CMRObservationU9DevelopmentAssessment: t.Type<CMRObservationU9DevelopmentAssessment> = t.recursion(
