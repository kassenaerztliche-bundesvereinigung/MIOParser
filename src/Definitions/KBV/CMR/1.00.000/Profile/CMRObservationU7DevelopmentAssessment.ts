...
import CMRU7DevelopmentAssessmentVS from "../../../../../Definitions/KBV/CMR/1.00.000/ValueSet/CMRU7DevelopmentAssessment";
...
export const CMRObservationU7DevelopmentAssessmentCodeCodingDisplayAnzeigenameCodeSnomedContent: t.Type<CMRObservationU7DevelopmentAssessmentCodeCodingDisplayAnzeigenameCodeSnomedContent> = t.recursion(
...
export const CMRObservationU7DevelopmentAssessmentCodeCodingDisplayAnzeigenameCodeSnomed: t.Type<CMRObservationU7DevelopmentAssessmentCodeCodingDisplayAnzeigenameCodeSnomed> = t.recursion(
...
export const CMRObservationU7DevelopmentAssessmentCodeCodingDisplay: t.Type<CMRObservationU7DevelopmentAssessmentCodeCodingDisplay> = t.recursion(
...
export const CMRObservationU7DevelopmentAssessmentCodeCoding: t.Type<CMRObservationU7DevelopmentAssessmentCodeCoding> = t.recursion(
...
export const CMRObservationU7DevelopmentAssessmentMeta: t.Type<CMRObservationU7DevelopmentAssessmentMeta> = t.recursion(
...
export const CMRObservationU7DevelopmentAssessmentCode: t.Type<CMRObservationU7DevelopmentAssessmentCode> = t.recursion(
...
export const CMRObservationU7DevelopmentAssessmentSubject: t.Type<CMRObservationU7DevelopmentAssessmentSubject> = t.recursion(
...
export const CMRObservationU7DevelopmentAssessmentEncounter: t.Type<CMRObservationU7DevelopmentAssessmentEncounter> = t.recursion(
...
export const CMRObservationU7DevelopmentAssessmentPerformer: t.Type<CMRObservationU7DevelopmentAssessmentPerformer> = t.recursion(
...
const CMRObservationU7DevelopmentAssessment: t.Type<CMRObservationU7DevelopmentAssessment> = t.recursion(
