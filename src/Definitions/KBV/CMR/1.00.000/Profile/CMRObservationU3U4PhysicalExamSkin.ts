...
import CMRU3U4PhysicalExamSkinVS from "../../../../../Definitions/KBV/CMR/1.00.000/ValueSet/CMRU3U4PhysicalExamSkin";
...
export const CMRObservationU3U4PhysicalExamSkinCodeCodingDisplayAnzeigenameCodeSnomedContent: t.Type<CMRObservationU3U4PhysicalExamSkinCodeCodingDisplayAnzeigenameCodeSnomedContent> = t.recursion(
...
export const CMRObservationU3U4PhysicalExamSkinCodeCodingDisplayAnzeigenameCodeSnomed: t.Type<CMRObservationU3U4PhysicalExamSkinCodeCodingDisplayAnzeigenameCodeSnomed> = t.recursion(
...
export const CMRObservationU3U4PhysicalExamSkinCodeCodingDisplay: t.Type<CMRObservationU3U4PhysicalExamSkinCodeCodingDisplay> = t.recursion(
...
export const CMRObservationU3U4PhysicalExamSkinCodeCoding: t.Type<CMRObservationU3U4PhysicalExamSkinCodeCoding> = t.recursion(
...
export const CMRObservationU3U4PhysicalExamSkinMeta: t.Type<CMRObservationU3U4PhysicalExamSkinMeta> = t.recursion(
...
export const CMRObservationU3U4PhysicalExamSkinCode: t.Type<CMRObservationU3U4PhysicalExamSkinCode> = t.recursion(
...
export const CMRObservationU3U4PhysicalExamSkinSubject: t.Type<CMRObservationU3U4PhysicalExamSkinSubject> = t.recursion(
...
export const CMRObservationU3U4PhysicalExamSkinEncounter: t.Type<CMRObservationU3U4PhysicalExamSkinEncounter> = t.recursion(
...
export const CMRObservationU3U4PhysicalExamSkinPerformer: t.Type<CMRObservationU3U4PhysicalExamSkinPerformer> = t.recursion(
...
const CMRObservationU3U4PhysicalExamSkin: t.Type<CMRObservationU3U4PhysicalExamSkin> = t.recursion(
