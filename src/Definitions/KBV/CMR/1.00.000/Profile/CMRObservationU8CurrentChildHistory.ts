...
import CMRU8CurrentChildHistoryVS from "../../../../../Definitions/KBV/CMR/1.00.000/ValueSet/CMRU8CurrentChildHistory";
...
export const CMRObservationU8CurrentChildHistoryCodeCodingDisplayAnzeigenameCodeSnomedContent: t.Type<CMRObservationU8CurrentChildHistoryCodeCodingDisplayAnzeigenameCodeSnomedContent> = t.recursion(
...
export const CMRObservationU8CurrentChildHistoryCodeCodingDisplayAnzeigenameCodeSnomed: t.Type<CMRObservationU8CurrentChildHistoryCodeCodingDisplayAnzeigenameCodeSnomed> = t.recursion(
...
export const CMRObservationU8CurrentChildHistoryCodeCodingDisplay: t.Type<CMRObservationU8CurrentChildHistoryCodeCodingDisplay> = t.recursion(
...
export const CMRObservationU8CurrentChildHistoryCodeCoding: t.Type<CMRObservationU8CurrentChildHistoryCodeCoding> = t.recursion(
...
export const CMRObservationU8CurrentChildHistoryMeta: t.Type<CMRObservationU8CurrentChildHistoryMeta> = t.recursion(
...
export const CMRObservationU8CurrentChildHistoryCode: t.Type<CMRObservationU8CurrentChildHistoryCode> = t.recursion(
...
export const CMRObservationU8CurrentChildHistorySubject: t.Type<CMRObservationU8CurrentChildHistorySubject> = t.recursion(
...
export const CMRObservationU8CurrentChildHistoryEncounter: t.Type<CMRObservationU8CurrentChildHistoryEncounter> = t.recursion(
...
export const CMRObservationU8CurrentChildHistoryPerformer: t.Type<CMRObservationU8CurrentChildHistoryPerformer> = t.recursion(
...
const CMRObservationU8CurrentChildHistory: t.Type<CMRObservationU8CurrentChildHistory> = t.recursion(
