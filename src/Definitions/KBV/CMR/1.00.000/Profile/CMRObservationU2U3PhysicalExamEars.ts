...
import CMRU2U3PhysicalExamEarsVS from "../../../../../Definitions/KBV/CMR/1.00.000/ValueSet/CMRU2U3PhysicalExamEars";
...
export const CMRObservationU2U3PhysicalExamEarsCodeCodingDisplayAnzeigenameCodeSnomedContent: t.Type<CMRObservationU2U3PhysicalExamEarsCodeCodingDisplayAnzeigenameCodeSnomedContent> = t.recursion(
...
export const CMRObservationU2U3PhysicalExamEarsCodeCodingDisplayAnzeigenameCodeSnomed: t.Type<CMRObservationU2U3PhysicalExamEarsCodeCodingDisplayAnzeigenameCodeSnomed> = t.recursion(
...
export const CMRObservationU2U3PhysicalExamEarsCodeCodingDisplay: t.Type<CMRObservationU2U3PhysicalExamEarsCodeCodingDisplay> = t.recursion(
...
export const CMRObservationU2U3PhysicalExamEarsCodeCoding: t.Type<CMRObservationU2U3PhysicalExamEarsCodeCoding> = t.recursion(
...
export const CMRObservationU2U3PhysicalExamEarsMeta: t.Type<CMRObservationU2U3PhysicalExamEarsMeta> = t.recursion(
...
export const CMRObservationU2U3PhysicalExamEarsCode: t.Type<CMRObservationU2U3PhysicalExamEarsCode> = t.recursion(
...
export const CMRObservationU2U3PhysicalExamEarsSubject: t.Type<CMRObservationU2U3PhysicalExamEarsSubject> = t.recursion(
...
export const CMRObservationU2U3PhysicalExamEarsEncounter: t.Type<CMRObservationU2U3PhysicalExamEarsEncounter> = t.recursion(
...
export const CMRObservationU2U3PhysicalExamEarsPerformer: t.Type<CMRObservationU2U3PhysicalExamEarsPerformer> = t.recursion(
...
const CMRObservationU2U3PhysicalExamEars: t.Type<CMRObservationU2U3PhysicalExamEars> = t.recursion(
