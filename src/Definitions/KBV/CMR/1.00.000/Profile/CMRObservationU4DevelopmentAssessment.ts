...
import CMRU4DevelopmentAssessmentVS from "../../../../../Definitions/KBV/CMR/1.00.000/ValueSet/CMRU4DevelopmentAssessment";
...
export const CMRObservationU4DevelopmentAssessmentCodeCodingDisplayAnzeigenameCodeSnomedContent: t.Type<CMRObservationU4DevelopmentAssessmentCodeCodingDisplayAnzeigenameCodeSnomedContent> = t.recursion(
...
export const CMRObservationU4DevelopmentAssessmentCodeCodingDisplayAnzeigenameCodeSnomed: t.Type<CMRObservationU4DevelopmentAssessmentCodeCodingDisplayAnzeigenameCodeSnomed> = t.recursion(
...
export const CMRObservationU4DevelopmentAssessmentCodeCodingDisplay: t.Type<CMRObservationU4DevelopmentAssessmentCodeCodingDisplay> = t.recursion(
...
export const CMRObservationU4DevelopmentAssessmentCodeCoding: t.Type<CMRObservationU4DevelopmentAssessmentCodeCoding> = t.recursion(
...
export const CMRObservationU4DevelopmentAssessmentMeta: t.Type<CMRObservationU4DevelopmentAssessmentMeta> = t.recursion(
...
export const CMRObservationU4DevelopmentAssessmentCode: t.Type<CMRObservationU4DevelopmentAssessmentCode> = t.recursion(
 ...
 */
export interface CMRObservationU4DevelopmentAssessmentSubject {
    reference: string;
    id?: string;
}

export const CMRObservationU4DevelopmentAssessmentSubject: t.Type<CMRObservationU4DevelopmentAssessmentSubject> = t.recursion(
 ...
 */
export interface CMRObservationU4DevelopmentAssessmentEncounter {
    reference: string;
    id?: string;
}

export const CMRObservationU4DevelopmentAssessmentEncounter: t.Type<CMRObservationU4DevelopmentAssessmentEncounter> = t.recursion(
 ...
 */
export interface CMRObservationU4DevelopmentAssessmentPerformer {
    reference: string;
    id?: string;
}

export const CMRObservationU4DevelopmentAssessmentPerformer: t.Type<CMRObservationU4DevelopmentAssessmentPerformer> = t.recursion(
...
interface CMRObservationU4DevelopmentAssessment {
    ...
    subject: CMRObservationU4DevelopmentAssessmentSubject;
    encounter: CMRObservationU4DevelopmentAssessmentEncounter;
    effectiveDateTime: string;
    valueBoolean: true;
    id?: string;
    text?: Narrative;
    performer?: Array<CMRObservationU4DevelopmentAssessmentPerformer>;
}

const CMRObservationU4DevelopmentAssessment: t.Type<CMRObservationU4DevelopmentAssessment> = t.recursion(
        ...
        Excess(
            t.intersection([
                ...
                t.partial({
                    id: SCALARString,
                    text: Narrative,
                    performer: MaxArray(1, CMRObservationU4DevelopmentAssessmentPerformer)
                })
            ])
        )
);
