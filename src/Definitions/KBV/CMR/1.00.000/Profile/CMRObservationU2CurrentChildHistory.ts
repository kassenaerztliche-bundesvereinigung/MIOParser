...
import CMRU2CurrentChildHistoryVS from "../../../../../Definitions/KBV/CMR/1.00.000/ValueSet/CMRU2CurrentChildHistory";
...
export const CMRObservationU2CurrentChildHistoryCodeCodingDisplayAnzeigenameCodeSnomedContent: t.Type<CMRObservationU2CurrentChildHistoryCodeCodingDisplayAnzeigenameCodeSnomedContent> = t.recursion(
...
export const CMRObservationU2CurrentChildHistoryCodeCodingDisplayAnzeigenameCodeSnomed: t.Type<CMRObservationU2CurrentChildHistoryCodeCodingDisplayAnzeigenameCodeSnomed> = t.recursion(
...
export const CMRObservationU2CurrentChildHistoryCodeCodingDisplay: t.Type<CMRObservationU2CurrentChildHistoryCodeCodingDisplay> = t.recursion(
...
export const CMRObservationU2CurrentChildHistoryCodeCoding: t.Type<CMRObservationU2CurrentChildHistoryCodeCoding> = t.recursion(
...
export const CMRObservationU2CurrentChildHistoryMeta: t.Type<CMRObservationU2CurrentChildHistoryMeta> = t.recursion(
...
export const CMRObservationU2CurrentChildHistoryCode: t.Type<CMRObservationU2CurrentChildHistoryCode> = t.recursion(
...
export const CMRObservationU2CurrentChildHistorySubject: t.Type<CMRObservationU2CurrentChildHistorySubject> = t.recursion(
...
export const CMRObservationU2CurrentChildHistoryEncounter: t.Type<CMRObservationU2CurrentChildHistoryEncounter> = t.recursion(
...
export const CMRObservationU2CurrentChildHistoryPerformer: t.Type<CMRObservationU2CurrentChildHistoryPerformer> = t.recursion(
...
const CMRObservationU2CurrentChildHistory: t.Type<CMRObservationU2CurrentChildHistory> = t.recursion(
