...
export const CMRDiagnosticReportU6PhysicalExamEyesCodeCodingDisplayAnzeigenameCodeSnomedContent: t.Type<CMRDiagnosticReportU6PhysicalExamEyesCodeCodingDisplayAnzeigenameCodeSnomedContent> = t.recursion(
...
export const CMRDiagnosticReportU6PhysicalExamEyesCodeCodingDisplayAnzeigenameCodeSnomed: t.Type<CMRDiagnosticReportU6PhysicalExamEyesCodeCodingDisplayAnzeigenameCodeSnomed> = t.recursion(
...
export const CMRDiagnosticReportU6PhysicalExamEyesCodeCodingDisplay: t.Type<CMRDiagnosticReportU6PhysicalExamEyesCodeCodingDisplay> = t.recursion(
...
export const CMRDiagnosticReportU6PhysicalExamEyesCodeCoding: t.Type<CMRDiagnosticReportU6PhysicalExamEyesCodeCoding> = t.recursion(
...
export const CMRDiagnosticReportU6PhysicalExamEyesMeta: t.Type<CMRDiagnosticReportU6PhysicalExamEyesMeta> = t.recursion(
...
export const CMRDiagnosticReportU6PhysicalExamEyesCode: t.Type<CMRDiagnosticReportU6PhysicalExamEyesCode> = t.recursion(
...
export const CMRDiagnosticReportU6PhysicalExamEyesSubject: t.Type<CMRDiagnosticReportU6PhysicalExamEyesSubject> = t.recursion(
...
export const CMRDiagnosticReportU6PhysicalExamEyesEncounter: t.Type<CMRDiagnosticReportU6PhysicalExamEyesEncounter> = t.recursion(
...
export const CMRDiagnosticReportU6PhysicalExamEyesPerformer: t.Type<CMRDiagnosticReportU6PhysicalExamEyesPerformer> = t.recursion(
...
export const CMRDiagnosticReportU6PhysicalExamEyesResult: t.Type<CMRDiagnosticReportU6PhysicalExamEyesResult> = t.recursion(
    ...
    () =>
        Excess(
            t.intersection([
                t.type({
                    reference: CustomReference(SCALARString, [
                        "https://fhir.kbv.de/StructureDefinition/KBV_PR_MIO_CMR_Observation_U6_Physical_Exam_Eyes|1.0.0"
                    ])
                }),
                t.partial({
                    id: SCALARString
...
const CMRDiagnosticReportU6PhysicalExamEyes: t.Type<CMRDiagnosticReportU6PhysicalExamEyes> = t.recursion(
