...
import CMRPregnancyHistoryVS from "../../../../../Definitions/KBV/CMR/1.00.000/ValueSet/CMRPregnancyHistory";
...
export const CMRObservationU1U3PregnancyHistoryCodeCodingDisplayAnzeigenameCodeSnomedContent: t.Type<CMRObservationU1U3PregnancyHistoryCodeCodingDisplayAnzeigenameCodeSnomedContent> = t.recursion(
...
export const CMRObservationU1U3PregnancyHistoryCodeCodingDisplayAnzeigenameCodeSnomed: t.Type<CMRObservationU1U3PregnancyHistoryCodeCodingDisplayAnzeigenameCodeSnomed> = t.recursion(
...
export const CMRObservationU1U3PregnancyHistoryCodeCodingDisplay: t.Type<CMRObservationU1U3PregnancyHistoryCodeCodingDisplay> = t.recursion(
...
export const CMRObservationU1U3PregnancyHistoryCodeCoding: t.Type<CMRObservationU1U3PregnancyHistoryCodeCoding> = t.recursion(
...
export const CMRObservationU1U3PregnancyHistoryMeta: t.Type<CMRObservationU1U3PregnancyHistoryMeta> = t.recursion(
...
export const CMRObservationU1U3PregnancyHistoryCode: t.Type<CMRObservationU1U3PregnancyHistoryCode> = t.recursion(
 ...
 */
export interface CMRObservationU1U3PregnancyHistorySubject {
    reference: string;
    id?: string;
}

export const CMRObservationU1U3PregnancyHistorySubject: t.Type<CMRObservationU1U3PregnancyHistorySubject> = t.recursion(
 ...
 */
export interface CMRObservationU1U3PregnancyHistoryEncounter {
    reference: string;
    id?: string;
}

export const CMRObservationU1U3PregnancyHistoryEncounter: t.Type<CMRObservationU1U3PregnancyHistoryEncounter> = t.recursion(
 ...
 */
export interface CMRObservationU1U3PregnancyHistoryPerformer {
    reference: string;
    id?: string;
}

export const CMRObservationU1U3PregnancyHistoryPerformer: t.Type<CMRObservationU1U3PregnancyHistoryPerformer> = t.recursion(
...
interface CMRObservationU1U3PregnancyHistory {
    ...
    subject: CMRObservationU1U3PregnancyHistorySubject;
    encounter: CMRObservationU1U3PregnancyHistoryEncounter;
    effectiveDateTime: string;
    valueBoolean: true;
    id?: string;
    text?: Narrative;
    performer?: Array<CMRObservationU1U3PregnancyHistoryPerformer>;
}

const CMRObservationU1U3PregnancyHistory: t.Type<CMRObservationU1U3PregnancyHistory> = t.recursion(
        ...
        Excess(
            t.intersection([
                ...
                t.partial({
                    id: SCALARString,
                    text: Narrative,
                    performer: MaxArray(1, CMRObservationU1U3PregnancyHistoryPerformer)
                })
            ])
        )
);
