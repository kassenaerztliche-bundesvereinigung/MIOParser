...
import CMRU8DevelopmentAssessmentVS from "../../../../../Definitions/KBV/CMR/1.00.000/ValueSet/CMRU8DevelopmentAssessment";
...
export const CMRObservationU8DevelopmentAssessmentCodeCodingDisplayAnzeigenameCodeSnomedContent: t.Type<CMRObservationU8DevelopmentAssessmentCodeCodingDisplayAnzeigenameCodeSnomedContent> = t.recursion(
...
export const CMRObservationU8DevelopmentAssessmentCodeCodingDisplayAnzeigenameCodeSnomed: t.Type<CMRObservationU8DevelopmentAssessmentCodeCodingDisplayAnzeigenameCodeSnomed> = t.recursion(
...
export const CMRObservationU8DevelopmentAssessmentCodeCodingDisplay: t.Type<CMRObservationU8DevelopmentAssessmentCodeCodingDisplay> = t.recursion(
...
export const CMRObservationU8DevelopmentAssessmentCodeCoding: t.Type<CMRObservationU8DevelopmentAssessmentCodeCoding> = t.recursion(
...
export const CMRObservationU8DevelopmentAssessmentMeta: t.Type<CMRObservationU8DevelopmentAssessmentMeta> = t.recursion(
...
export const CMRObservationU8DevelopmentAssessmentCode: t.Type<CMRObservationU8DevelopmentAssessmentCode> = t.recursion(
...
export const CMRObservationU8DevelopmentAssessmentSubject: t.Type<CMRObservationU8DevelopmentAssessmentSubject> = t.recursion(
...
export const CMRObservationU8DevelopmentAssessmentEncounter: t.Type<CMRObservationU8DevelopmentAssessmentEncounter> = t.recursion(
...
export const CMRObservationU8DevelopmentAssessmentPerformer: t.Type<CMRObservationU8DevelopmentAssessmentPerformer> = t.recursion(
...
const CMRObservationU8DevelopmentAssessment: t.Type<CMRObservationU8DevelopmentAssessment> = t.recursion(
