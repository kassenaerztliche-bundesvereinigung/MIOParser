...
import CMRU8PhysicalExamEarsVS from "../../../../../Definitions/KBV/CMR/1.00.000/ValueSet/CMRU8PhysicalExamEars";
...
export const CMRObservationU8PhysicalExamEarsCodeCodingDisplayAnzeigenameCodeSnomedContent: t.Type<CMRObservationU8PhysicalExamEarsCodeCodingDisplayAnzeigenameCodeSnomedContent> = t.recursion(
...
export const CMRObservationU8PhysicalExamEarsCodeCodingDisplayAnzeigenameCodeSnomed: t.Type<CMRObservationU8PhysicalExamEarsCodeCodingDisplayAnzeigenameCodeSnomed> = t.recursion(
...
export const CMRObservationU8PhysicalExamEarsCodeCodingDisplay: t.Type<CMRObservationU8PhysicalExamEarsCodeCodingDisplay> = t.recursion(
...
export const CMRObservationU8PhysicalExamEarsCodeCoding: t.Type<CMRObservationU8PhysicalExamEarsCodeCoding> = t.recursion(
...
export const CMRObservationU8PhysicalExamEarsMeta: t.Type<CMRObservationU8PhysicalExamEarsMeta> = t.recursion(
...
export const CMRObservationU8PhysicalExamEarsCode: t.Type<CMRObservationU8PhysicalExamEarsCode> = t.recursion(
...
export const CMRObservationU8PhysicalExamEarsSubject: t.Type<CMRObservationU8PhysicalExamEarsSubject> = t.recursion(
...
export const CMRObservationU8PhysicalExamEarsEncounter: t.Type<CMRObservationU8PhysicalExamEarsEncounter> = t.recursion(
...
export const CMRObservationU8PhysicalExamEarsPerformer: t.Type<CMRObservationU8PhysicalExamEarsPerformer> = t.recursion(
...
const CMRObservationU8PhysicalExamEars: t.Type<CMRObservationU8PhysicalExamEars> = t.recursion(
