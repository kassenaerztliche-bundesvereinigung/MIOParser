...
export const CMRDiagnosticReportU7aandU9PhysicalExamChestLungRespiratoryTractCodeCodingDisplayAnzeigenameCodeSnomedContent: t.Type<CMRDiagnosticReportU7aandU9PhysicalExamChestLungRespiratoryTractCodeCodingDisplayAnzeigenameCodeSnomedContent> = t.recursion(
...
export const CMRDiagnosticReportU7aandU9PhysicalExamChestLungRespiratoryTractCodeCodingDisplayAnzeigenameCodeSnomed: t.Type<CMRDiagnosticReportU7aandU9PhysicalExamChestLungRespiratoryTractCodeCodingDisplayAnzeigenameCodeSnomed> = t.recursion(
...
export const CMRDiagnosticReportU7aandU9PhysicalExamChestLungRespiratoryTractCodeCodingDisplay: t.Type<CMRDiagnosticReportU7aandU9PhysicalExamChestLungRespiratoryTractCodeCodingDisplay> = t.recursion(
...
export const CMRDiagnosticReportU7aandU9PhysicalExamChestLungRespiratoryTractCodeCoding: t.Type<CMRDiagnosticReportU7aandU9PhysicalExamChestLungRespiratoryTractCodeCoding> = t.recursion(
...
export const CMRDiagnosticReportU7aandU9PhysicalExamChestLungRespiratoryTractMeta: t.Type<CMRDiagnosticReportU7aandU9PhysicalExamChestLungRespiratoryTractMeta> = t.recursion(
...
export const CMRDiagnosticReportU7aandU9PhysicalExamChestLungRespiratoryTractCode: t.Type<CMRDiagnosticReportU7aandU9PhysicalExamChestLungRespiratoryTractCode> = t.recursion(
...
export const CMRDiagnosticReportU7aandU9PhysicalExamChestLungRespiratoryTractSubject: t.Type<CMRDiagnosticReportU7aandU9PhysicalExamChestLungRespiratoryTractSubject> = t.recursion(
...
export const CMRDiagnosticReportU7aandU9PhysicalExamChestLungRespiratoryTractEncounter: t.Type<CMRDiagnosticReportU7aandU9PhysicalExamChestLungRespiratoryTractEncounter> = t.recursion(
...
export const CMRDiagnosticReportU7aandU9PhysicalExamChestLungRespiratoryTractPerformer: t.Type<CMRDiagnosticReportU7aandU9PhysicalExamChestLungRespiratoryTractPerformer> = t.recursion(
...
export const CMRDiagnosticReportU7aandU9PhysicalExamChestLungRespiratoryTractResult: t.Type<CMRDiagnosticReportU7aandU9PhysicalExamChestLungRespiratoryTractResult> = t.recursion(
    ...
    () =>
        Excess(
            t.intersection([
                t.type({
                    reference: CustomReference(SCALARString, [
                        "https://fhir.kbv.de/StructureDefinition/KBV_PR_MIO_CMR_Observation_U7a_and_U9_Physical_Exam_Chest_Lung_Respiratory_Tract|1.0.0"
                    ])
                }),
                t.partial({
                    id: SCALARString
...
const CMRDiagnosticReportU7aandU9PhysicalExamChestLungRespiratoryTract: t.Type<CMRDiagnosticReportU7aandU9PhysicalExamChestLungRespiratoryTract> = t.recursion(
