...
export const PCEncounterTypeCodingDisplayAnzeigenameTypeSnomedContent: t.Type<PCEncounterTypeCodingDisplayAnzeigenameTypeSnomedContent> = t.recursion(
...
export const PCEncounterTypeCodingDisplayAnzeigenameTypeSnomed: t.Type<PCEncounterTypeCodingDisplayAnzeigenameTypeSnomed> = t.recursion(
...
export const PCEncounterTypeCodingDisplay: t.Type<PCEncounterTypeCodingDisplay> = t.recursion(
...
export const PCEncounterParticipantTypeCoding: t.Type<PCEncounterParticipantTypeCoding> = t.recursion(
...
export const PCEncounterParticipantIndividual: t.Type<PCEncounterParticipantIndividual> = t.recursion(
            ...
            t.intersection([
                t.type({
                    reference: CustomReference(SCALARString, [
                        "https://fhir.kbv.de/StructureDefinition/KBV_PR_MIO_CMR_Practitioner"
                    ])
                }),
                t.partial({
                    id: SCALARString
