...
export const CMRDiagnosticReportU1BirthTraumaOfFetusCodeCodingDisplayAnzeigenameCodeSnomedContent: t.Type<CMRDiagnosticReportU1BirthTraumaOfFetusCodeCodingDisplayAnzeigenameCodeSnomedContent> = t.recursion(
...
export const CMRDiagnosticReportU1BirthTraumaOfFetusCodeCodingDisplayAnzeigenameCodeSnomed: t.Type<CMRDiagnosticReportU1BirthTraumaOfFetusCodeCodingDisplayAnzeigenameCodeSnomed> = t.recursion(
...
export const CMRDiagnosticReportU1BirthTraumaOfFetusCodeCodingDisplay: t.Type<CMRDiagnosticReportU1BirthTraumaOfFetusCodeCodingDisplay> = t.recursion(
...
export const CMRDiagnosticReportU1BirthTraumaOfFetusCodeCoding: t.Type<CMRDiagnosticReportU1BirthTraumaOfFetusCodeCoding> = t.recursion(
...
export const CMRDiagnosticReportU1BirthTraumaOfFetusMeta: t.Type<CMRDiagnosticReportU1BirthTraumaOfFetusMeta> = t.recursion(
...
export const CMRDiagnosticReportU1BirthTraumaOfFetusCode: t.Type<CMRDiagnosticReportU1BirthTraumaOfFetusCode> = t.recursion(
...
export const CMRDiagnosticReportU1BirthTraumaOfFetusSubject: t.Type<CMRDiagnosticReportU1BirthTraumaOfFetusSubject> = t.recursion(
...
export const CMRDiagnosticReportU1BirthTraumaOfFetusEncounter: t.Type<CMRDiagnosticReportU1BirthTraumaOfFetusEncounter> = t.recursion(
...
export const CMRDiagnosticReportU1BirthTraumaOfFetusPerformer: t.Type<CMRDiagnosticReportU1BirthTraumaOfFetusPerformer> = t.recursion(
...
export const CMRDiagnosticReportU1BirthTraumaOfFetusResult: t.Type<CMRDiagnosticReportU1BirthTraumaOfFetusResult> = t.recursion(
    ...
    () =>
        Excess(
            t.intersection([
                t.type({
                    reference: CustomReference(SCALARString, [
                        "https://fhir.kbv.de/StructureDefinition/KBV_PR_MIO_CMR_Observation_U1_Birth_Trauma_Of_Fetus|1.0.0"
                    ])
                }),
                t.partial({
                    id: SCALARString
...
const CMRDiagnosticReportU1BirthTraumaOfFetus: t.Type<CMRDiagnosticReportU1BirthTraumaOfFetus> = t.recursion(
