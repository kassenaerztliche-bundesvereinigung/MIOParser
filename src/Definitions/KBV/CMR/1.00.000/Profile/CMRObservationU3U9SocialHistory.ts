...
import CMRU3U9SocialHistoryVS from "../../../../../Definitions/KBV/CMR/1.00.000/ValueSet/CMRU3U9SocialHistory";
...
export const CMRObservationU3U9SocialHistoryCodeCodingDisplayAnzeigenameCodeSnomedContent: t.Type<CMRObservationU3U9SocialHistoryCodeCodingDisplayAnzeigenameCodeSnomedContent> = t.recursion(
...
export const CMRObservationU3U9SocialHistoryCodeCodingDisplayAnzeigenameCodeSnomed: t.Type<CMRObservationU3U9SocialHistoryCodeCodingDisplayAnzeigenameCodeSnomed> = t.recursion(
...
export const CMRObservationU3U9SocialHistoryCodeCodingDisplay: t.Type<CMRObservationU3U9SocialHistoryCodeCodingDisplay> = t.recursion(
...
export const CMRObservationU3U9SocialHistoryCodeCoding: t.Type<CMRObservationU3U9SocialHistoryCodeCoding> = t.recursion(
...
export const CMRObservationU3U9SocialHistoryMeta: t.Type<CMRObservationU3U9SocialHistoryMeta> = t.recursion(
...
export const CMRObservationU3U9SocialHistoryCode: t.Type<CMRObservationU3U9SocialHistoryCode> = t.recursion(
...
export const CMRObservationU3U9SocialHistorySubject: t.Type<CMRObservationU3U9SocialHistorySubject> = t.recursion(
...
export const CMRObservationU3U9SocialHistoryEncounter: t.Type<CMRObservationU3U9SocialHistoryEncounter> = t.recursion(
...
export const CMRObservationU3U9SocialHistoryPerformer: t.Type<CMRObservationU3U9SocialHistoryPerformer> = t.recursion(
...
const CMRObservationU3U9SocialHistory: t.Type<CMRObservationU3U9SocialHistory> = t.recursion(
