...
import CMRPercentileBodyMeasureLoincVS from "../../../../../Definitions/KBV/CMR/1.00.000/ValueSet/CMRPercentileBodyMeasureLoinc";
import CMRPercentileBodyMeasureSnomedVS from "../../../../../Definitions/KBV/CMR/1.00.000/ValueSet/CMRPercentileBodyMeasureSnomed";
...
export const CMRObservationPercentileValuesCodeCodeSnomedDisplayAnzeigenameCodeSnomedContent: t.Type<CMRObservationPercentileValuesCodeCodeSnomedDisplayAnzeigenameCodeSnomedContent> = t.recursion(
...
export const CMRObservationPercentileValuesCodeCodeLoincDisplayAnzeigenameCodeLoincContent: t.Type<CMRObservationPercentileValuesCodeCodeLoincDisplayAnzeigenameCodeLoincContent> = t.recursion(
...
export const CMRObservationPercentileValuesCodeCodeSnomedDisplayAnzeigenameCodeSnomed: t.Type<CMRObservationPercentileValuesCodeCodeSnomedDisplayAnzeigenameCodeSnomed> = t.recursion(
...
export const CMRObservationPercentileValuesCodeCodeLoincDisplayAnzeigenameCodeLoinc: t.Type<CMRObservationPercentileValuesCodeCodeLoincDisplayAnzeigenameCodeLoinc> = t.recursion(
...
export const CMRObservationPercentileValuesCodeCodeSnomedDisplay: t.Type<CMRObservationPercentileValuesCodeCodeSnomedDisplay> = t.recursion(
...
export const CMRObservationPercentileValuesCodeCodeLoincDisplay: t.Type<CMRObservationPercentileValuesCodeCodeLoincDisplay> = t.recursion(
...
export const CMRObservationPercentileValuesCodeCodeSnomed: t.Type<CMRObservationPercentileValuesCodeCodeSnomed> = t.recursion(
...
export const CMRObservationPercentileValuesCodeCodeLoinc: t.Type<CMRObservationPercentileValuesCodeCodeLoinc> = t.recursion(
...
export const CMRObservationPercentileValuesValueQuantity: t.Type<CMRObservationPercentileValuesValueQuantity> = t.recursion(
...
export const CMRObservationPercentileValuesMeta: t.Type<CMRObservationPercentileValuesMeta> = t.recursion(
...
export const CMRObservationPercentileValuesCode: t.Type<CMRObservationPercentileValuesCode> = t.recursion(
...
export const CMRObservationPercentileValuesSubject: t.Type<CMRObservationPercentileValuesSubject> = t.recursion(
...
export const CMRObservationPercentileValuesEncounter: t.Type<CMRObservationPercentileValuesEncounter> = t.recursion(
...
export const CMRObservationPercentileValuesPerformer: t.Type<CMRObservationPercentileValuesPerformer> = t.recursion(
...
export const CMRObservationPercentileValuesDerivedFrom: t.Type<CMRObservationPercentileValuesDerivedFrom> = t.recursion(
    ...
    () =>
        Excess(
            t.intersection([
                t.type({
                    reference: CustomReference(SCALARString, [
                        "https://fhir.kbv.de/StructureDefinition/KBV_PR_MIO_CMR_Observation_U1_Birth_Weight|1.0.0",
                        ...
                        "https://fhir.kbv.de/StructureDefinition/KBV_PR_MIO_CMR_Observation_Head_Circumference|1.0.0",
                        "https://fhir.kbv.de/StructureDefinition/KBV_PR_MIO_CMR_Observation_U1_Birth_Length|1.0.0",
                        "https://fhir.kbv.de/StructureDefinition/KBV_PR_MIO_CMR_Observation_U2_U9_Body_Height_Measure|1.0.0",
                        "https://fhir.kbv.de/StructureDefinition/KBV_PR_MIO_CMR_Observation_U7_U9_BMI|1.0.0"
                    ])
                }),
                t.partial({
                    id: SCALARString
...
const CMRObservationPercentileValues: t.Type<CMRObservationPercentileValues> = t.recursion(
