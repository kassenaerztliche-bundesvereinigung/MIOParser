...
import CMRU5CurrentChildHistoryVS from "../../../../../Definitions/KBV/CMR/1.00.000/ValueSet/CMRU5CurrentChildHistory";
...
export const CMRObservationU5CurrentChildHistoryCodeCodingDisplayAnzeigenameCodeSnomedContent: t.Type<CMRObservationU5CurrentChildHistoryCodeCodingDisplayAnzeigenameCodeSnomedContent> = t.recursion(
...
export const CMRObservationU5CurrentChildHistoryCodeCodingDisplayAnzeigenameCodeSnomed: t.Type<CMRObservationU5CurrentChildHistoryCodeCodingDisplayAnzeigenameCodeSnomed> = t.recursion(
...
export const CMRObservationU5CurrentChildHistoryCodeCodingDisplay: t.Type<CMRObservationU5CurrentChildHistoryCodeCodingDisplay> = t.recursion(
...
export const CMRObservationU5CurrentChildHistoryCodeCoding: t.Type<CMRObservationU5CurrentChildHistoryCodeCoding> = t.recursion(
...
export const CMRObservationU5CurrentChildHistoryMeta: t.Type<CMRObservationU5CurrentChildHistoryMeta> = t.recursion(
...
export const CMRObservationU5CurrentChildHistoryCode: t.Type<CMRObservationU5CurrentChildHistoryCode> = t.recursion(
...
export const CMRObservationU5CurrentChildHistorySubject: t.Type<CMRObservationU5CurrentChildHistorySubject> = t.recursion(
...
export const CMRObservationU5CurrentChildHistoryEncounter: t.Type<CMRObservationU5CurrentChildHistoryEncounter> = t.recursion(
...
export const CMRObservationU5CurrentChildHistoryPerformer: t.Type<CMRObservationU5CurrentChildHistoryPerformer> = t.recursion(
...
const CMRObservationU5CurrentChildHistory: t.Type<CMRObservationU5CurrentChildHistory> = t.recursion(
