...
import CMRHipHistoryVS from "../../../../../Definitions/KBV/CMR/1.00.000/ValueSet/CMRHipHistory";
...
export const CMRObservationU3U4HipScreeningHistoryCodeCodingDisplayAnzeigenameCodeSnomedContent: t.Type<CMRObservationU3U4HipScreeningHistoryCodeCodingDisplayAnzeigenameCodeSnomedContent> = t.recursion(
...
export const CMRObservationU3U4HipScreeningHistoryCodeCodingDisplayAnzeigenameCodeSnomed: t.Type<CMRObservationU3U4HipScreeningHistoryCodeCodingDisplayAnzeigenameCodeSnomed> = t.recursion(
...
export const CMRObservationU3U4HipScreeningHistoryCodeCodingDisplay: t.Type<CMRObservationU3U4HipScreeningHistoryCodeCodingDisplay> = t.recursion(
...
export const CMRObservationU3U4HipScreeningHistoryCodeCoding: t.Type<CMRObservationU3U4HipScreeningHistoryCodeCoding> = t.recursion(
...
export const CMRObservationU3U4HipScreeningHistoryMeta: t.Type<CMRObservationU3U4HipScreeningHistoryMeta> = t.recursion(
...
export const CMRObservationU3U4HipScreeningHistoryCode: t.Type<CMRObservationU3U4HipScreeningHistoryCode> = t.recursion(
 ...
 */
export interface CMRObservationU3U4HipScreeningHistorySubject {
    reference: string;
    id?: string;
}

export const CMRObservationU3U4HipScreeningHistorySubject: t.Type<CMRObservationU3U4HipScreeningHistorySubject> = t.recursion(
 ...
 */
export interface CMRObservationU3U4HipScreeningHistoryEncounter {
    reference: string;
    id?: string;
}

export const CMRObservationU3U4HipScreeningHistoryEncounter: t.Type<CMRObservationU3U4HipScreeningHistoryEncounter> = t.recursion(
 ...
 */
export interface CMRObservationU3U4HipScreeningHistoryPerformer {
    reference: string;
    id?: string;
}

export const CMRObservationU3U4HipScreeningHistoryPerformer: t.Type<CMRObservationU3U4HipScreeningHistoryPerformer> = t.recursion(
...
interface CMRObservationU3U4HipScreeningHistory {
    ...
    subject: CMRObservationU3U4HipScreeningHistorySubject;
    encounter: CMRObservationU3U4HipScreeningHistoryEncounter;
    effectiveDateTime: string;
    valueBoolean: true;
    id?: string;
    text?: Narrative;
    performer?: Array<CMRObservationU3U4HipScreeningHistoryPerformer>;
}

const CMRObservationU3U4HipScreeningHistory: t.Type<CMRObservationU3U4HipScreeningHistory> = t.recursion(
        ...
        Excess(
            t.intersection([
                ...
                t.partial({
                    id: SCALARString,
                    text: Narrative,
                    performer: MaxArray(1, CMRObservationU3U4HipScreeningHistoryPerformer)
                })
            ])
        )
);
