...
import CMRU9CurrentChildHistoryVS from "../../../../../Definitions/KBV/CMR/1.00.000/ValueSet/CMRU9CurrentChildHistory";
...
export const CMRObservationU9CurrentChildHistoryCodeCodingDisplayAnzeigenameCodeSnomedContent: t.Type<CMRObservationU9CurrentChildHistoryCodeCodingDisplayAnzeigenameCodeSnomedContent> = t.recursion(
...
export const CMRObservationU9CurrentChildHistoryCodeCodingDisplayAnzeigenameCodeSnomed: t.Type<CMRObservationU9CurrentChildHistoryCodeCodingDisplayAnzeigenameCodeSnomed> = t.recursion(
...
export const CMRObservationU9CurrentChildHistoryCodeCodingDisplay: t.Type<CMRObservationU9CurrentChildHistoryCodeCodingDisplay> = t.recursion(
...
export const CMRObservationU9CurrentChildHistoryCodeCoding: t.Type<CMRObservationU9CurrentChildHistoryCodeCoding> = t.recursion(
...
export const CMRObservationU9CurrentChildHistoryMeta: t.Type<CMRObservationU9CurrentChildHistoryMeta> = t.recursion(
...
export const CMRObservationU9CurrentChildHistoryCode: t.Type<CMRObservationU9CurrentChildHistoryCode> = t.recursion(
...
export const CMRObservationU9CurrentChildHistorySubject: t.Type<CMRObservationU9CurrentChildHistorySubject> = t.recursion(
...
export const CMRObservationU9CurrentChildHistoryEncounter: t.Type<CMRObservationU9CurrentChildHistoryEncounter> = t.recursion(
...
export const CMRObservationU9CurrentChildHistoryPerformer: t.Type<CMRObservationU9CurrentChildHistoryPerformer> = t.recursion(
...
const CMRObservationU9CurrentChildHistory: t.Type<CMRObservationU9CurrentChildHistory> = t.recursion(
