...
import ApgarScoreValueVS from "../../../../../Definitions/KBVBase/1.01.000/ValueSet/ApgarScoreValue";
...
export const CMRObservationU1ApgarScoreCodeCodeSnomedDisplayAnzeigenameCodeSnomedContent: t.Type<CMRObservationU1ApgarScoreCodeCodeSnomedDisplayAnzeigenameCodeSnomedContent> = t.recursion(
...
export const CMRObservationU1ApgarScoreCodeCodeLoincDisplayAnzeigenameCodeLoincContent: t.Type<CMRObservationU1ApgarScoreCodeCodeLoincDisplayAnzeigenameCodeLoincContent> = t.recursion(
...
export const CMRObservationU1ApgarScoreValueCodeableConceptCodingDisplayAnzeigenameValueSnomedContent: t.Type<CMRObservationU1ApgarScoreValueCodeableConceptCodingDisplayAnzeigenameValueSnomedContent> = t.recursion(
...
export const CMRObservationU1ApgarScoreCodeCodeSnomedDisplayAnzeigenameCodeSnomed: t.Type<CMRObservationU1ApgarScoreCodeCodeSnomedDisplayAnzeigenameCodeSnomed> = t.recursion(
...
export const CMRObservationU1ApgarScoreCodeCodeLoincDisplayAnzeigenameCodeLoinc: t.Type<CMRObservationU1ApgarScoreCodeCodeLoincDisplayAnzeigenameCodeLoinc> = t.recursion(
...
export const CMRObservationU1ApgarScoreValueCodeableConceptCodingDisplayAnzeigenameValueSnomed: t.Type<CMRObservationU1ApgarScoreValueCodeableConceptCodingDisplayAnzeigenameValueSnomed> = t.recursion(
...
export const CMRObservationU1ApgarScoreCodeCodeSnomedDisplay: t.Type<CMRObservationU1ApgarScoreCodeCodeSnomedDisplay> = t.recursion(
...
export const CMRObservationU1ApgarScoreCodeCodeLoincDisplay: t.Type<CMRObservationU1ApgarScoreCodeCodeLoincDisplay> = t.recursion(
...
export const CMRObservationU1ApgarScoreValueCodeableConceptCodingDisplay: t.Type<CMRObservationU1ApgarScoreValueCodeableConceptCodingDisplay> = t.recursion(
...
export const CMRObservationU1ApgarScoreCodeCodeSnomed: t.Type<CMRObservationU1ApgarScoreCodeCodeSnomed> = t.recursion(
...
export const CMRObservationU1ApgarScoreCodeCodeLoinc: t.Type<CMRObservationU1ApgarScoreCodeCodeLoinc> = t.recursion(
...
export const CMRObservationU1ApgarScoreValueCodeableConceptCoding: t.Type<CMRObservationU1ApgarScoreValueCodeableConceptCoding> = t.recursion(
...
export const CMRObservationU1ApgarScoreValueCodeableConcept: t.Type<CMRObservationU1ApgarScoreValueCodeableConcept> = t.recursion(
...
export interface CMRObservationU1ApgarScoreMeta {
    profile: Array<
        "https://fhir.kbv.de/StructureDefinition/KBV_PR_MIO_CMR_Observation_U1_Apgar_Score|1.0.0"
    >;
    id?: string;
}

export const CMRObservationU1ApgarScoreMeta: t.Type<CMRObservationU1ApgarScoreMeta> = t.recursion(
...
export const CMRObservationU1ApgarScoreCode: t.Type<CMRObservationU1ApgarScoreCode> = t.recursion(
...
export const CMRObservationU1ApgarScoreSubject: t.Type<CMRObservationU1ApgarScoreSubject> = t.recursion(
...
export const CMRObservationU1ApgarScoreEncounter: t.Type<CMRObservationU1ApgarScoreEncounter> = t.recursion(
...
export const CMRObservationU1ApgarScorePerformer: t.Type<CMRObservationU1ApgarScorePerformer> = t.recursion(
