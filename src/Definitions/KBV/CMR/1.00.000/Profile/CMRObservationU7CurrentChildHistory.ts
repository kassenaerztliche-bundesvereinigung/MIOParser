...
import CMRU7CurrentChildHistoryVS from "../../../../../Definitions/KBV/CMR/1.00.000/ValueSet/CMRU7CurrentChildHistory";
...
export const CMRObservationU7CurrentChildHistoryCodeCodingDisplayAnzeigenameCodeSnomedContent: t.Type<CMRObservationU7CurrentChildHistoryCodeCodingDisplayAnzeigenameCodeSnomedContent> = t.recursion(
...
export const CMRObservationU7CurrentChildHistoryCodeCodingDisplayAnzeigenameCodeSnomed: t.Type<CMRObservationU7CurrentChildHistoryCodeCodingDisplayAnzeigenameCodeSnomed> = t.recursion(
...
export const CMRObservationU7CurrentChildHistoryCodeCodingDisplay: t.Type<CMRObservationU7CurrentChildHistoryCodeCodingDisplay> = t.recursion(
...
export const CMRObservationU7CurrentChildHistoryCodeCoding: t.Type<CMRObservationU7CurrentChildHistoryCodeCoding> = t.recursion(
...
export const CMRObservationU7CurrentChildHistoryMeta: t.Type<CMRObservationU7CurrentChildHistoryMeta> = t.recursion(
...
export const CMRObservationU7CurrentChildHistoryCode: t.Type<CMRObservationU7CurrentChildHistoryCode> = t.recursion(
 ...
 */
export interface CMRObservationU7CurrentChildHistorySubject {
    reference: string;
    id?: string;
}

export const CMRObservationU7CurrentChildHistorySubject: t.Type<CMRObservationU7CurrentChildHistorySubject> = t.recursion(
 ...
 */
export interface CMRObservationU7CurrentChildHistoryEncounter {
    reference: string;
    id?: string;
}

export const CMRObservationU7CurrentChildHistoryEncounter: t.Type<CMRObservationU7CurrentChildHistoryEncounter> = t.recursion(
 ...
 */
export interface CMRObservationU7CurrentChildHistoryPerformer {
    reference: string;
    id?: string;
}

export const CMRObservationU7CurrentChildHistoryPerformer: t.Type<CMRObservationU7CurrentChildHistoryPerformer> = t.recursion(
...
interface CMRObservationU7CurrentChildHistory {
    ...
    subject: CMRObservationU7CurrentChildHistorySubject;
    encounter: CMRObservationU7CurrentChildHistoryEncounter;
    effectiveDateTime: string;
    valueBoolean: true;
    id?: string;
    text?: Narrative;
    performer?: Array<CMRObservationU7CurrentChildHistoryPerformer>;
}

const CMRObservationU7CurrentChildHistory: t.Type<CMRObservationU7CurrentChildHistory> = t.recursion(
        ...
        Excess(
            t.intersection([
                ...
                t.partial({
                    id: SCALARString,
                    text: Narrative,
                    performer: MaxArray(1, CMRObservationU7CurrentChildHistoryPerformer)
                })
            ])
        )
);
