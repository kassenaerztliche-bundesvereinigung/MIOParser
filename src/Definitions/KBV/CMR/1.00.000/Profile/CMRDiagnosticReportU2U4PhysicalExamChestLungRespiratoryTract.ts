...
export const CMRDiagnosticReportU2U4PhysicalExamChestLungRespiratoryTractCodeCodingDisplayAnzeigenameCodeSnomedContent: t.Type<CMRDiagnosticReportU2U4PhysicalExamChestLungRespiratoryTractCodeCodingDisplayAnzeigenameCodeSnomedContent> = t.recursion(
...
export const CMRDiagnosticReportU2U4PhysicalExamChestLungRespiratoryTractCodeCodingDisplayAnzeigenameCodeSnomed: t.Type<CMRDiagnosticReportU2U4PhysicalExamChestLungRespiratoryTractCodeCodingDisplayAnzeigenameCodeSnomed> = t.recursion(
...
export const CMRDiagnosticReportU2U4PhysicalExamChestLungRespiratoryTractCodeCodingDisplay: t.Type<CMRDiagnosticReportU2U4PhysicalExamChestLungRespiratoryTractCodeCodingDisplay> = t.recursion(
...
export const CMRDiagnosticReportU2U4PhysicalExamChestLungRespiratoryTractCodeCoding: t.Type<CMRDiagnosticReportU2U4PhysicalExamChestLungRespiratoryTractCodeCoding> = t.recursion(
...
export const CMRDiagnosticReportU2U4PhysicalExamChestLungRespiratoryTractMeta: t.Type<CMRDiagnosticReportU2U4PhysicalExamChestLungRespiratoryTractMeta> = t.recursion(
...
export const CMRDiagnosticReportU2U4PhysicalExamChestLungRespiratoryTractCode: t.Type<CMRDiagnosticReportU2U4PhysicalExamChestLungRespiratoryTractCode> = t.recursion(
...
export const CMRDiagnosticReportU2U4PhysicalExamChestLungRespiratoryTractSubject: t.Type<CMRDiagnosticReportU2U4PhysicalExamChestLungRespiratoryTractSubject> = t.recursion(
...
export const CMRDiagnosticReportU2U4PhysicalExamChestLungRespiratoryTractEncounter: t.Type<CMRDiagnosticReportU2U4PhysicalExamChestLungRespiratoryTractEncounter> = t.recursion(
...
export const CMRDiagnosticReportU2U4PhysicalExamChestLungRespiratoryTractPerformer: t.Type<CMRDiagnosticReportU2U4PhysicalExamChestLungRespiratoryTractPerformer> = t.recursion(
...
export const CMRDiagnosticReportU2U4PhysicalExamChestLungRespiratoryTractResult: t.Type<CMRDiagnosticReportU2U4PhysicalExamChestLungRespiratoryTractResult> = t.recursion(
    ...
    () =>
        Excess(
            t.intersection([
                t.type({
                    reference: CustomReference(SCALARString, [
                        "https://fhir.kbv.de/StructureDefinition/KBV_PR_MIO_CMR_Observation_U2_U4_Physical_Exam_Chest_Lung_Respiratory_Tract|1.0.0"
                    ])
                }),
                t.partial({
                    id: SCALARString
...
const CMRDiagnosticReportU2U4PhysicalExamChestLungRespiratoryTract: t.Type<CMRDiagnosticReportU2U4PhysicalExamChestLungRespiratoryTract> = t.recursion(
