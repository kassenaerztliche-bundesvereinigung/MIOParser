...
import CMRFoetalPositionVS from "../../../../../Definitions/KBV/CMR/1.00.000/ValueSet/CMRFoetalPosition";
...
export const CMRObservationU1U3FoetalPositionCodeCodingDisplayAnzeigenameCodeSnomedContent: t.Type<CMRObservationU1U3FoetalPositionCodeCodingDisplayAnzeigenameCodeSnomedContent> = t.recursion(
...
export const CMRObservationU1U3FoetalPositionCodeCodingDisplayAnzeigenameCodeSnomed: t.Type<CMRObservationU1U3FoetalPositionCodeCodingDisplayAnzeigenameCodeSnomed> = t.recursion(
...
export const CMRObservationU1U3FoetalPositionCodeCodingDisplay: t.Type<CMRObservationU1U3FoetalPositionCodeCodingDisplay> = t.recursion(
...
export const CMRObservationU1U3FoetalPositionCodeCoding: t.Type<CMRObservationU1U3FoetalPositionCodeCoding> = t.recursion(
...
export const CMRObservationU1U3FoetalPositionMeta: t.Type<CMRObservationU1U3FoetalPositionMeta> = t.recursion(
...
export const CMRObservationU1U3FoetalPositionCode: t.Type<CMRObservationU1U3FoetalPositionCode> = t.recursion(
...
export const CMRObservationU1U3FoetalPositionSubject: t.Type<CMRObservationU1U3FoetalPositionSubject> = t.recursion(
...
export const CMRObservationU1U3FoetalPositionEncounter: t.Type<CMRObservationU1U3FoetalPositionEncounter> = t.recursion(
...
export const CMRObservationU1U3FoetalPositionPerformer: t.Type<CMRObservationU1U3FoetalPositionPerformer> = t.recursion(
...
const CMRObservationU1U3FoetalPosition: t.Type<CMRObservationU1U3FoetalPosition> = t.recursion(
