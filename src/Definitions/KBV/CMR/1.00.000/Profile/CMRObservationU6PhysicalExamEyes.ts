...
import CMRU6PhysicalExamEyesVS from "../../../../../Definitions/KBV/CMR/1.00.000/ValueSet/CMRU6PhysicalExamEyes";
...
export const CMRObservationU6PhysicalExamEyesCodeCodingDisplayAnzeigenameCodeSnomedContent: t.Type<CMRObservationU6PhysicalExamEyesCodeCodingDisplayAnzeigenameCodeSnomedContent> = t.recursion(
...
export const CMRObservationU6PhysicalExamEyesCodeCodingDisplayAnzeigenameCodeSnomed: t.Type<CMRObservationU6PhysicalExamEyesCodeCodingDisplayAnzeigenameCodeSnomed> = t.recursion(
...
export const CMRObservationU6PhysicalExamEyesCodeCodingDisplay: t.Type<CMRObservationU6PhysicalExamEyesCodeCodingDisplay> = t.recursion(
...
export const CMRObservationU6PhysicalExamEyesCodeCoding: t.Type<CMRObservationU6PhysicalExamEyesCodeCoding> = t.recursion(
...
export const CMRObservationU6PhysicalExamEyesMeta: t.Type<CMRObservationU6PhysicalExamEyesMeta> = t.recursion(
...
export const CMRObservationU6PhysicalExamEyesCode: t.Type<CMRObservationU6PhysicalExamEyesCode> = t.recursion(
...
export const CMRObservationU6PhysicalExamEyesSubject: t.Type<CMRObservationU6PhysicalExamEyesSubject> = t.recursion(
...
export const CMRObservationU6PhysicalExamEyesEncounter: t.Type<CMRObservationU6PhysicalExamEyesEncounter> = t.recursion(
...
export const CMRObservationU6PhysicalExamEyesPerformer: t.Type<CMRObservationU6PhysicalExamEyesPerformer> = t.recursion(
...
const CMRObservationU6PhysicalExamEyes: t.Type<CMRObservationU6PhysicalExamEyes> = t.recursion(
