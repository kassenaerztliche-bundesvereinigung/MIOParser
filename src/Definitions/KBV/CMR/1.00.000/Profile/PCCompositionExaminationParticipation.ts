...
export const PCCompositionExaminationParticipationEinleitungsText: t.Type<PCCompositionExaminationParticipationEinleitungsText> = t.recursion(
...
export const PCCompositionExaminationParticipationHinweisText: t.Type<PCCompositionExaminationParticipationHinweisText> = t.recursion(
...
export const PCCompositionExaminationParticipationTypeCoding: t.Type<PCCompositionExaminationParticipationTypeCoding> = t.recursion(
...
export const PCCompositionExaminationParticipationMeta: t.Type<PCCompositionExaminationParticipationMeta> = t.recursion(
...
export const PCCompositionExaminationParticipationType: t.Type<PCCompositionExaminationParticipationType> = t.recursion(
...
export const PCCompositionExaminationParticipationSubject: t.Type<PCCompositionExaminationParticipationSubject> = t.recursion(
...
export const PCCompositionExaminationParticipationEncounter: t.Type<PCCompositionExaminationParticipationEncounter> = t.recursion(
    ...
    () =>
        Excess(
            t.intersection([
                t.type({
                    reference: CustomReference(SCALARString, [
                        "https://fhir.kbv.de/StructureDefinition/KBV_PR_MIO_PC_Encounter|1.0.0"
                    ])
                }),
                t.partial({
                    id: SCALARString
...
export const PCCompositionExaminationParticipationAuthor: t.Type<PCCompositionExaminationParticipationAuthor> = t.recursion(
...
const PCCompositionExaminationParticipation: t.Type<PCCompositionExaminationParticipation> = t.recursion(
