...
import CMRU2FamilyHistoryVS from "../../../../../Definitions/KBV/CMR/1.00.000/ValueSet/CMRU2FamilyHistory";
...
export const CMRObservationU2FamilyHistoryCodeCodingDisplayAnzeigenameCodeSnomedContent: t.Type<CMRObservationU2FamilyHistoryCodeCodingDisplayAnzeigenameCodeSnomedContent> = t.recursion(
...
export const CMRObservationU2FamilyHistoryCodeCodingDisplayAnzeigenameCodeSnomed: t.Type<CMRObservationU2FamilyHistoryCodeCodingDisplayAnzeigenameCodeSnomed> = t.recursion(
...
export const CMRObservationU2FamilyHistoryCodeCodingDisplay: t.Type<CMRObservationU2FamilyHistoryCodeCodingDisplay> = t.recursion(
...
export const CMRObservationU2FamilyHistoryCodeCoding: t.Type<CMRObservationU2FamilyHistoryCodeCoding> = t.recursion(
...
export const CMRObservationU2FamilyHistoryMeta: t.Type<CMRObservationU2FamilyHistoryMeta> = t.recursion(
...
export const CMRObservationU2FamilyHistoryCode: t.Type<CMRObservationU2FamilyHistoryCode> = t.recursion(
...
export const CMRObservationU2FamilyHistorySubject: t.Type<CMRObservationU2FamilyHistorySubject> = t.recursion(
...
export const CMRObservationU2FamilyHistoryEncounter: t.Type<CMRObservationU2FamilyHistoryEncounter> = t.recursion(
...
export const CMRObservationU2FamilyHistoryPerformer: t.Type<CMRObservationU2FamilyHistoryPerformer> = t.recursion(
