...
import CMRU7aCurrentChildHistoryVS from "../../../../../Definitions/KBV/CMR/1.00.000/ValueSet/CMRU7aCurrentChildHistory";
...
export const CMRObservationU7aCurrentChildHistoryCodeCodingDisplayAnzeigenameCodeSnomedContent: t.Type<CMRObservationU7aCurrentChildHistoryCodeCodingDisplayAnzeigenameCodeSnomedContent> = t.recursion(
...
export const CMRObservationU7aCurrentChildHistoryCodeCodingDisplayAnzeigenameCodeSnomed: t.Type<CMRObservationU7aCurrentChildHistoryCodeCodingDisplayAnzeigenameCodeSnomed> = t.recursion(
...
export const CMRObservationU7aCurrentChildHistoryCodeCodingDisplay: t.Type<CMRObservationU7aCurrentChildHistoryCodeCodingDisplay> = t.recursion(
...
export const CMRObservationU7aCurrentChildHistoryCodeCoding: t.Type<CMRObservationU7aCurrentChildHistoryCodeCoding> = t.recursion(
...
export const CMRObservationU7aCurrentChildHistoryMeta: t.Type<CMRObservationU7aCurrentChildHistoryMeta> = t.recursion(
...
export const CMRObservationU7aCurrentChildHistoryCode: t.Type<CMRObservationU7aCurrentChildHistoryCode> = t.recursion(
...
export const CMRObservationU7aCurrentChildHistorySubject: t.Type<CMRObservationU7aCurrentChildHistorySubject> = t.recursion(
...
export const CMRObservationU7aCurrentChildHistoryEncounter: t.Type<CMRObservationU7aCurrentChildHistoryEncounter> = t.recursion(
...
export const CMRObservationU7aCurrentChildHistoryPerformer: t.Type<CMRObservationU7aCurrentChildHistoryPerformer> = t.recursion(
...
const CMRObservationU7aCurrentChildHistory: t.Type<CMRObservationU7aCurrentChildHistory> = t.recursion(
