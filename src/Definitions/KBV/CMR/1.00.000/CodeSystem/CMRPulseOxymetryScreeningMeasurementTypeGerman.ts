...
const CMRPulseOxymetryScreeningMeasurementTypeGerman: t.Type<CMRPulseOxymetryScreeningMeasurementTypeGerman> = t.union(
    [t.literal("Erstmessung"), t.literal("Kontrollmessung")]
);
