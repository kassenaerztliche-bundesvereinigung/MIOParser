...
export type CMRResource =
    ...
    | CMR.V1_0_1.Profile.CMRDiagnosticReportPercentileBodyMeasures
    | CMR.V1_0_1.Profile.CMRDiagnosticReportPercentileValues
    | CMR.V1_0_1.Profile.CMRDiagnosticReportU1ApgarScore
    | CMR.V1_0_1.Profile.CMRDiagnosticReportU1BirthLength
    | CMR.V1_0_1.Profile.CMRDiagnosticReportU1BirthTraumaOfFetus
    | CMR.V1_0_1.Profile.CMRDiagnosticReportU1BirthWeight
    | CMR.V1_0_1.Profile.CMRDiagnosticReportU1CongenitalMalformation
    | CMR.V1_0_1.Profile.CMRDiagnosticReportU1EdemaOfNewborn
    | CMR.V1_0_1.Profile.CMRDiagnosticReportU1NeonatalJaundice
    | CMR.V1_0_1.Profile.CMRDiagnosticReportU1TermInfant
    ...
    | CMR.V1_0_1.Profile.CMRObservationU2CurrentChildHistory
    | CMR.V1_0_1.Profile.CMRObservationU2FamilyHistory
    ...
    | CMR.V1_0_1.Profile.CMRObservationU3DevelopmentAssessment
    ...
    | CMR.V1_0_1.Profile.CMRObservationU3U6IndicationforAbnormality
    | CMR.V1_0_1.Profile.CMRObservationU3U9AgeAppropriateDevelopment
    | CMR.V1_0_1.Profile.CMRObservationU3U9SocialHistory
    | CMR.V1_0_1.Profile.CMRObservationU4CurrentChildHistory
    | CMR.V1_0_1.Profile.CMRObservationU4DevelopmentAssessment
    ...
    | CMR.V1_0_1.Profile.CMRObservationU5CurrentChildHistory
    | CMR.V1_0_1.Profile.CMRObservationU5DevelopmentAssessment
    ...
    | CMR.V1_0_1.Profile.CMRObservationU6CurrentChildHistory
    | CMR.V1_0_1.Profile.CMRObservationU6DevelopmentAssessment
    ...
    | CMR.V1_0_1.Profile.CMRObservationU7aCurrentChildHistory
    | CMR.V1_0_1.Profile.CMRObservationU7aDevelopmentAssessment
    | CMR.V1_0_1.Profile.CMRObservationU7aPhysicalExamMouthNose
    | CMR.V1_0_1.Profile.CMRObservationU7aU9PhysicalExamEyes
    | CMR.V1_0_1.Profile.CMRObservationU7CurrentChildHistory
    | CMR.V1_0_1.Profile.CMRObservationU7DevelopmentAssessment
    ...
    | CMR.V1_0_1.Profile.CMRObservationU8CurrentChildHistory
    | CMR.V1_0_1.Profile.CMRObservationU8DevelopmentAssessment
    ...
    | CMR.V1_0_1.Profile.CMRObservationU9CurrentChildHistory
    | CMR.V1_0_1.Profile.CMRObservationU9DevelopmentAssessment
